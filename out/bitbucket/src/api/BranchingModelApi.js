...
export default class BranchingModelApi {
    ...
    */
     ...
     */
    repositoriesWorkspaceRepoSlugBranchingModelGet(workspace, repoSlug, callback) {
      let postBody = null;
     ...
     */
    repositoriesWorkspaceRepoSlugBranchingModelSettingsGet(workspace, repoSlug, callback) {
      let postBody = null;
      // verify the required parameter 'workspace' is set
      if (workspace === undefined || workspace === null) {
     ...
     * data is of type: {@link module:model/BranchingModelSettings}
     */
    repositoriesWorkspaceRepoSlugBranchingModelSettingsPut(workspace, repoSlug, callback) {
      let postBody = null;
      // verify the required parameter 'workspace' is set
      if (workspace === undefined || workspace === null) {
