...
import DeployKeyAllOf from './DeployKeyAllOf';
...
class DeployKey {
     ...
     */
    constructor(type) { 
        ModelObject.initialize(this, type);DeployKeyAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ModelObject.constructFromObject(data, obj);
            DeployKeyAllOf.constructFromObject(data, obj);
...
// Implement DeployKeyAllOf interface:
/**
 * The deploy key value.
 * @member {String} key
 */
