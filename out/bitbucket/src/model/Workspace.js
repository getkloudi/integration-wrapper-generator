...
import WorkspaceAllOf from './WorkspaceAllOf';
...
class Workspace {
     ...
     */
    constructor(type) { 
        ModelObject.initialize(this, type);WorkspaceAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ModelObject.constructFromObject(data, obj);
            WorkspaceAllOf.constructFromObject(data, obj);
...
// Implement WorkspaceAllOf interface:
/**
 * @member {module:model/WorkspaceAllOfLinks} links
 */
