...
class DeploymentRelease {
     ...
     */
    constructor(type) { 
        ModelObject.initialize(this, type);DeploymentReleaseAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ModelObject.constructFromObject(data, obj);
            DeploymentReleaseAllOf.constructFromObject(data, obj);
...
// Implement DeploymentReleaseAllOf interface:
/**
 * The UUID identifying the release.
 * @member {String} uuid
 */
