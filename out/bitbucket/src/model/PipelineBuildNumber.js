...
class PipelineBuildNumber {
     ...
     */
    constructor(type) { 
        ModelObject.initialize(this, type);PipelineBuildNumberAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ModelObject.constructFromObject(data, obj);
            PipelineBuildNumberAllOf.constructFromObject(data, obj);
...
// Implement PipelineBuildNumberAllOf interface:
/**
 * The next number that will be used as build number.
 * @member {Number} next
 */
