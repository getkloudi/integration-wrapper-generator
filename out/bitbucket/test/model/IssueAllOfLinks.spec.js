...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.IssueAllOfLinks();
  });
  ...
  describe('IssueAllOfLinks', function() {
    it('should create an instance of IssueAllOfLinks', function() {
      // uncomment below and update the code to test IssueAllOfLinks
