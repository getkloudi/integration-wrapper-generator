...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.TagLinks();
  });
  ...
  describe('TagLinks', function() {
    it('should create an instance of TagLinks', function() {
      // uncomment below and update the code to test TagLinks
      //var instane = new Bitbucket.TagLinks();
      //expect(instance).to.be.a(Bitbucket.TagLinks);
    });
