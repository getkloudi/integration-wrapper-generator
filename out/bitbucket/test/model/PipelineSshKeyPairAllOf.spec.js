...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.PipelineSshKeyPairAllOf();
  });
  ...
  describe('PipelineSshKeyPairAllOf', function() {
    it('should create an instance of PipelineSshKeyPairAllOf', function() {
      // uncomment below and update the code to test PipelineSshKeyPairAllOf
      //var instane = new Bitbucket.PipelineSshKeyPairAllOf();
      //expect(instance).to.be.a(Bitbucket.PipelineSshKeyPairAllOf);
    });
