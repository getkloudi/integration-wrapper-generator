...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.PipelineKnownHostAllOf();
  });
  ...
  describe('PipelineKnownHostAllOf', function() {
    it('should create an instance of PipelineKnownHostAllOf', function() {
      // uncomment below and update the code to test PipelineKnownHostAllOf
