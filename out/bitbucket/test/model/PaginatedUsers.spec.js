...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.PaginatedUsers();
  });
  ...
  describe('PaginatedUsers', function() {
    it('should create an instance of PaginatedUsers', function() {
      // uncomment below and update the code to test PaginatedUsers
      //var instane = new Bitbucket.PaginatedUsers();
      //expect(instance).to.be.a(Bitbucket.PaginatedUsers);
    });
