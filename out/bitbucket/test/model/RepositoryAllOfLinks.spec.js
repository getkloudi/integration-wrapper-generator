...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.RepositoryAllOfLinks();
  });
  ...
  describe('RepositoryAllOfLinks', function() {
    it('should create an instance of RepositoryAllOfLinks', function() {
      // uncomment below and update the code to test RepositoryAllOfLinks
