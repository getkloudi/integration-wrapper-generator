...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.PaginatedDeployKeys();
  });
  ...
  describe('PaginatedDeployKeys', function() {
    it('should create an instance of PaginatedDeployKeys', function() {
      // uncomment below and update the code to test PaginatedDeployKeys
      //var instane = new Bitbucket.PaginatedDeployKeys();
      //expect(instance).to.be.a(Bitbucket.PaginatedDeployKeys);
    });
