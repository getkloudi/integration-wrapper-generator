...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.WorkspaceAllOfLinks();
  });
  ...
  describe('WorkspaceAllOfLinks', function() {
    it('should create an instance of WorkspaceAllOfLinks', function() {
      // uncomment below and update the code to test WorkspaceAllOfLinks
      //var instane = new Bitbucket.WorkspaceAllOfLinks();
      //expect(instance).to.be.a(Bitbucket.WorkspaceAllOfLinks);
    });
