...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.PullrequestAllOfRenderedTitle();
  });
  ...
  describe('PullrequestAllOfRenderedTitle', function() {
    it('should create an instance of PullrequestAllOfRenderedTitle', function() {
      // uncomment below and update the code to test PullrequestAllOfRenderedTitle
      //var instane = new Bitbucket.PullrequestAllOfRenderedTitle();
      //expect(instance).to.be.a(Bitbucket.PullrequestAllOfRenderedTitle);
    });
