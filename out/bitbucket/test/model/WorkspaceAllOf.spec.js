...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.WorkspaceAllOf();
  });
  ...
  describe('WorkspaceAllOf', function() {
    it('should create an instance of WorkspaceAllOf', function() {
      // uncomment below and update the code to test WorkspaceAllOf
      //var instane = new Bitbucket.WorkspaceAllOf();
      //expect(instance).to.be.a(Bitbucket.WorkspaceAllOf);
    });
