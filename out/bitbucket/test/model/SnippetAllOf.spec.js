...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.SnippetAllOf();
  });
  ...
  describe('SnippetAllOf', function() {
    it('should create an instance of SnippetAllOf', function() {
      // uncomment below and update the code to test SnippetAllOf
