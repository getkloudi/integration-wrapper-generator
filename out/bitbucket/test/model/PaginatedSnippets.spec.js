...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.PaginatedSnippets();
  });
  ...
  describe('PaginatedSnippets', function() {
    it('should create an instance of PaginatedSnippets', function() {
      // uncomment below and update the code to test PaginatedSnippets
      //var instane = new Bitbucket.PaginatedSnippets();
      //expect(instance).to.be.a(Bitbucket.PaginatedSnippets);
    });
