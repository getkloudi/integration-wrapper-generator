...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.CommitstatusAllOfLinks();
  });
  ...
  describe('CommitstatusAllOfLinks', function() {
    it('should create an instance of CommitstatusAllOfLinks', function() {
      // uncomment below and update the code to test CommitstatusAllOfLinks
