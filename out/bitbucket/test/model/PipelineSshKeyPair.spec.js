...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.PipelineSshKeyPair();
  });
  ...
  describe('PipelineSshKeyPair', function() {
    it('should create an instance of PipelineSshKeyPair', function() {
      // uncomment below and update the code to test PipelineSshKeyPair
      //var instane = new Bitbucket.PipelineSshKeyPair();
      //expect(instance).to.be.a(Bitbucket.PipelineSshKeyPair);
    });
