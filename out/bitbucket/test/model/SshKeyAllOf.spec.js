...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.SshKeyAllOf();
  });
  ...
  describe('SshKeyAllOf', function() {
    it('should create an instance of SshKeyAllOf', function() {
      // uncomment below and update the code to test SshKeyAllOf
      //var instane = new Bitbucket.SshKeyAllOf();
      //expect(instance).to.be.a(Bitbucket.SshKeyAllOf);
    });
