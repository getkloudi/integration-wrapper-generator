...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.CommentAllOf();
  });
  ...
  describe('CommentAllOf', function() {
    it('should create an instance of CommentAllOf', function() {
      // uncomment below and update the code to test CommentAllOf
      //var instane = new Bitbucket.CommentAllOf();
      //expect(instance).to.be.a(Bitbucket.CommentAllOf);
    });
