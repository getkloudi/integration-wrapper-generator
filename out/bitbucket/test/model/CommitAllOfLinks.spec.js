...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.CommitAllOfLinks();
  });
  ...
  describe('CommitAllOfLinks', function() {
    it('should create an instance of CommitAllOfLinks', function() {
      // uncomment below and update the code to test CommitAllOfLinks
      //var instane = new Bitbucket.CommitAllOfLinks();
      //expect(instance).to.be.a(Bitbucket.CommitAllOfLinks);
    });
