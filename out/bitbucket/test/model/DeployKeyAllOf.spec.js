...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.DeployKeyAllOf();
  });
  ...
  describe('DeployKeyAllOf', function() {
    it('should create an instance of DeployKeyAllOf', function() {
      // uncomment below and update the code to test DeployKeyAllOf
      //var instane = new Bitbucket.DeployKeyAllOf();
      //expect(instance).to.be.a(Bitbucket.DeployKeyAllOf);
    });
