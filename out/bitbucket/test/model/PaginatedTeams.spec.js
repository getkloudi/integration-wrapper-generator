...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.PaginatedTeams();
  });
  ...
  describe('PaginatedTeams', function() {
    it('should create an instance of PaginatedTeams', function() {
      // uncomment below and update the code to test PaginatedTeams
