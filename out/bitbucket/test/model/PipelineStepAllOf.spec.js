...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bitbucket.PipelineStepAllOf();
  });
  ...
  describe('PipelineStepAllOf', function() {
    it('should create an instance of PipelineStepAllOf', function() {
      // uncomment below and update the code to test PipelineStepAllOf
      //var instane = new Bitbucket.PipelineStepAllOf();
      //expect(instance).to.be.a(Bitbucket.PipelineStepAllOf);
    });
