...
> PaginatedUsers usersUsernameFollowersGet(username)
...
apiInstance.usersUsernameFollowersGet(username, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PaginatedUsers usersUsernameFollowingGet(username)
...
apiInstance.usersUsernameFollowingGet(username, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
