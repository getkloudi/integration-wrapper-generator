...
var _IssueAttachment = _interopRequireDefault(require("./IssueAttachment"));
 ...
 * @version 1.2.0
 */
var PaginatedIssueAttachments = /*#__PURE__*/function () {
  /**
  ...
  function PaginatedIssueAttachments() {
    _classCallCheck(this, PaginatedIssueAttachments);
  ...
  _createClass(PaginatedIssueAttachments, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('values')) {
          obj['values'] = _ApiClient["default"].convertToType(data['values'], [_IssueAttachment["default"]]);
        }
      }
...
var _default = PaginatedIssueAttachments;
