...
function () {
   ...
   */
  function GroupAllOfLinks() {
    _classCallCheck(this, GroupAllOfLinks);

    GroupAllOfLinks.initialize(this);
  }
  /**
  ...
  _createClass(GroupAllOfLinks, null, [{
    key: "initialize",
    value: function initialize(obj) {}
    /**
     * Constructs a <code>GroupAllOfLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GroupAllOfLinks} obj Optional instance to populate.
     * @return {module:model/GroupAllOfLinks} The populated <code>GroupAllOfLinks</code> instance.
     */
