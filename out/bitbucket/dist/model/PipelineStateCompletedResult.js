 ...
 * @version 1.2.0
 */
var PipelineStateCompletedResult = /*#__PURE__*/function () {
  /**
   ...
   * @param type {String} 
   */
  function PipelineStateCompletedResult(type) {
    _classCallCheck(this, PipelineStateCompletedResult);
  ...
  _createClass(PipelineStateCompletedResult, null, [{
    key: "initialize",
  ...
  return PipelineStateCompletedResult;
...
var _default = PipelineStateCompletedResult;
