 ...
 * @version 1.2.0
 */
var PaginatedWebhookSubscriptions = /*#__PURE__*/function () {
  /**
  ...
  function PaginatedWebhookSubscriptions() {
    _classCallCheck(this, PaginatedWebhookSubscriptions);
  ...
  _createClass(PaginatedWebhookSubscriptions, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('values')) {
          obj['values'] = _ApiClient["default"].convertToType(data['values'], [_WebhookSubscription["default"]]);
        }
      }
...
var _default = PaginatedWebhookSubscriptions;
