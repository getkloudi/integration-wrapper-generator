 ...
 * @version 1.2.0
 */
var PaginatedPipelines = /*#__PURE__*/function () {
  /**
  ...
  function PaginatedPipelines() {
    _classCallCheck(this, PaginatedPipelines);
  ...
  _createClass(PaginatedPipelines, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('values')) {
          obj['values'] = _ApiClient["default"].convertToType(data['values'], [_Pipeline["default"]]);
        }
...
var _default = PaginatedPipelines;
