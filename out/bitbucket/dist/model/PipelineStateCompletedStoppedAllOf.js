...
function () {
   ...
   */
  function PipelineStateCompletedStoppedAllOf() {
    _classCallCheck(this, PipelineStateCompletedStoppedAllOf);
  ...
  _createClass(PipelineStateCompletedStoppedAllOf, null, [{
    key: "initialize",
  ...
  return PipelineStateCompletedStoppedAllOf;
}();
/**
...
var _default = PipelineStateCompletedStoppedAllOf;
