 ...
 * @version 1.2.0
 */
var JiraProject = /*#__PURE__*/function () {
  /**
   ...
   * @param type {String} 
   */
  function JiraProject(type) {
    _classCallCheck(this, JiraProject);

    _ModelObject["default"].initialize(this, type);

    JiraProject.initialize(this, type);
  }
  /**
