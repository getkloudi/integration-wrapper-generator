 ...
 * @version 1.2.0
 */
var MilestoneAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>MilestoneAllOf</code>.
   * A milestone as defined in a repository&#39;s issue tracker.
   * @alias module:model/MilestoneAllOf
   */
  function MilestoneAllOf() {
    _classCallCheck(this, MilestoneAllOf);

    MilestoneAllOf.initialize(this);
  }
  /**
  ...
  _createClass(MilestoneAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}
    /**
     * Constructs a <code>MilestoneAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MilestoneAllOf} obj Optional instance to populate.
     * @return {module:model/MilestoneAllOf} The populated <code>MilestoneAllOf</code> instance.
     */
