 ...
 * @version 1.2.0
 */
var IssueChangeLinks = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>IssueChangeLinks</code>.
   * @alias module:model/IssueChangeLinks
   */
  function IssueChangeLinks() {
    _classCallCheck(this, IssueChangeLinks);
  ...
  _createClass(IssueChangeLinks, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('issue')) {
          obj['issue'] = _SubjectTypesRepositoryEvents["default"].constructFromObject(data['issue']);
        }
      }
