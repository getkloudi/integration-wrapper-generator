...
var DeploymentStateCompletedStatus = /*#__PURE__*/function () {
   ...
   * @param type {String} 
   */
  function DeploymentStateCompletedStatus(type) {
    _classCallCheck(this, DeploymentStateCompletedStatus);
  ...
  _createClass(DeploymentStateCompletedStatus, null, [{
    key: "initialize",
  ...
  return DeploymentStateCompletedStatus;
...
var _default = DeploymentStateCompletedStatus;
