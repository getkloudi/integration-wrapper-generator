...
function () {
  ...
  */
   ...
   * @callback module:api/SourceApi~repositoriesWorkspaceRepoSlugFilehistoryNodePathGetCallback
   ...
   * @param {module:api/SourceApi~repositoriesWorkspaceRepoSlugFilehistoryNodePathGetCallback} callback The callback function, accepting three arguments: error, data, response
  ...
  _createClass(SourceApi, [{
     ...
     * @callback module:api/SourceApi~repositoriesWorkspaceRepoSlugSrcNodePathGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PaginatedTreeentries} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SourceApi~repositoriesWorkspaceRepoSlugSrcNodePathGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PaginatedTreeentries}
     */
