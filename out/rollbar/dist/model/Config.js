    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('teams')) {
          obj['teams'] = _ApiClient["default"].convertToType(data['teams'], Object);
        }

        if (data.hasOwnProperty('users')) {
          obj['users'] = _ApiClient["default"].convertToType(data['users'], Object);
        }
      }
...
Config.prototype['teams'] = undefined;
/**
 * List of usernames or email addresses to send emails to
 * @member {Object} users
 */

Config.prototype['users'] = undefined;
var _default = Config;
