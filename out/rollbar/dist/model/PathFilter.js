...
var _Operation = _interopRequireDefault(require("./Operation33"));
 ...
 * @version 1.1.0
 */
var PathFilter = /*#__PURE__*/function () {
  /**
   ...
   */
  function PathFilter(path, type, value, operation) {
    _classCallCheck(this, PathFilter);
  ...
  _createClass(PathFilter, null, [{
    key: "initialize",
    value: function initialize(obj, path, type, value, operation) {
      obj['path'] = path;
      obj['type'] = type;
      obj['value'] = value;
