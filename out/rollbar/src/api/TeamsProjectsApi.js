...
* @version 1.0.0
*/
export default class TeamsProjectsApi {
    ...
    */
     ...
     */
    teamTeamIdProjectProjectIdDelete(callback) {
      let postBody = null;
     ...
     */
    teamTeamIdProjectProjectIdGet(callback) {
      let postBody = null;
     ...
     */
    teamTeamIdProjectProjectIdPut(callback) {
      let postBody = null;
     ...
     */
    teamTeamIdProjectsGet(callback) {
      let postBody = null;
