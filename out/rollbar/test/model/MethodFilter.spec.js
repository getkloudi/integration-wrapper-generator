...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.MethodFilter();
  });
  ...
  describe('MethodFilter', function() {
    it('should create an instance of MethodFilter', function() {
      // uncomment below and update the code to test MethodFilter
      //var instane = new Rollbar.MethodFilter();
      //expect(instance).to.be.a(Rollbar.MethodFilter);
    });
