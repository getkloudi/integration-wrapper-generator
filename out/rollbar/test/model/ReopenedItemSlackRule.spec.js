...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.ReopenedItemSlackRule();
  });
  ...
  describe('ReopenedItemSlackRule', function() {
    it('should create an instance of ReopenedItemSlackRule', function() {
      // uncomment below and update the code to test ReopenedItemSlackRule
      //var instane = new Rollbar.ReopenedItemSlackRule();
      //expect(instance).to.be.a(Rollbar.ReopenedItemSlackRule);
    });
