...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.NewVersionRule();
  });
  ...
  describe('NewVersionRule', function() {
    it('should create an instance of NewVersionRule', function() {
      // uncomment below and update the code to test NewVersionRule
      //var instane = new Rollbar.NewVersionRule();
      //expect(instance).to.be.a(Rollbar.NewVersionRule);
    });
