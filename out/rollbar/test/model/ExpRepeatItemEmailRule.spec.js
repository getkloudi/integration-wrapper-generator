...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.ExpRepeatItemEmailRule();
  });
  ...
  describe('ExpRepeatItemEmailRule', function() {
    it('should create an instance of ExpRepeatItemEmailRule', function() {
      // uncomment below and update the code to test ExpRepeatItemEmailRule
      //var instane = new Rollbar.ExpRepeatItemEmailRule();
      //expect(instance).to.be.a(Rollbar.ExpRepeatItemEmailRule);
    });
