...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.DeploySlackRule();
  });
  ...
  describe('DeploySlackRule', function() {
    it('should create an instance of DeploySlackRule', function() {
      // uncomment below and update the code to test DeploySlackRule
      //var instane = new Rollbar.DeploySlackRule();
      //expect(instance).to.be.a(Rollbar.DeploySlackRule);
    });
