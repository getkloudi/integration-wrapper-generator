...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.OccurrenceSlackRule();
  });
  ...
  describe('OccurrenceSlackRule', function() {
    it('should create an instance of OccurrenceSlackRule', function() {
      // uncomment below and update the code to test OccurrenceSlackRule
      //var instane = new Rollbar.OccurrenceSlackRule();
      //expect(instance).to.be.a(Rollbar.OccurrenceSlackRule);
    });
