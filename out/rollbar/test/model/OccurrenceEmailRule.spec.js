...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.OccurrenceEmailRule();
  });
  ...
  describe('OccurrenceEmailRule', function() {
    it('should create an instance of OccurrenceEmailRule', function() {
      // uncomment below and update the code to test OccurrenceEmailRule
      //var instane = new Rollbar.OccurrenceEmailRule();
      //expect(instance).to.be.a(Rollbar.OccurrenceEmailRule);
    });
