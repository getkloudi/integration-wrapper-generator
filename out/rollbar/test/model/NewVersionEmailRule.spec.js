...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.NewVersionEmailRule();
  });
  ...
  describe('NewVersionEmailRule', function() {
    it('should create an instance of NewVersionEmailRule', function() {
      // uncomment below and update the code to test NewVersionEmailRule
      //var instane = new Rollbar.NewVersionEmailRule();
      //expect(instance).to.be.a(Rollbar.NewVersionEmailRule);
    });
