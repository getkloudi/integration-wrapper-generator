...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.NewItemPagerDutyRule();
  });
  ...
  describe('NewItemPagerDutyRule', function() {
    it('should create an instance of NewItemPagerDutyRule', function() {
      // uncomment below and update the code to test NewItemPagerDutyRule
      //var instane = new Rollbar.NewItemPagerDutyRule();
      //expect(instance).to.be.a(Rollbar.NewItemPagerDutyRule);
    });
