...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.NewVersionSlackRule();
  });
  ...
  describe('NewVersionSlackRule', function() {
    it('should create an instance of NewVersionSlackRule', function() {
      // uncomment below and update the code to test NewVersionSlackRule
      //var instane = new Rollbar.NewVersionSlackRule();
      //expect(instance).to.be.a(Rollbar.NewVersionSlackRule);
    });
