...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.NewItemEmailRule();
  });
  ...
  describe('NewItemEmailRule', function() {
    it('should create an instance of NewItemEmailRule', function() {
      // uncomment below and update the code to test NewItemEmailRule
      //var instane = new Rollbar.NewItemEmailRule();
      //expect(instance).to.be.a(Rollbar.NewItemEmailRule);
    });
