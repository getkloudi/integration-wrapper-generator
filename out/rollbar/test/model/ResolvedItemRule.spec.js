...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.ResolvedItemRule();
  });
  ...
  describe('ResolvedItemRule', function() {
    it('should create an instance of ResolvedItemRule', function() {
      // uncomment below and update the code to test ResolvedItemRule
      //var instane = new Rollbar.ResolvedItemRule();
      //expect(instance).to.be.a(Rollbar.ResolvedItemRule);
    });
