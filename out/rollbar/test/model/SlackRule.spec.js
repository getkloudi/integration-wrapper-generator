...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.SlackRule();
  });
  ...
  describe('SlackRule', function() {
    it('should create an instance of SlackRule', function() {
      // uncomment below and update the code to test SlackRule
      //var instane = new Rollbar.SlackRule();
      //expect(instance).to.be.a(Rollbar.SlackRule);
    });
