...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.ReopenedItemRule();
  });
  ...
  describe('ReopenedItemRule', function() {
    it('should create an instance of ReopenedItemRule', function() {
      // uncomment below and update the code to test ReopenedItemRule
      //var instane = new Rollbar.ReopenedItemRule();
      //expect(instance).to.be.a(Rollbar.ReopenedItemRule);
    });
