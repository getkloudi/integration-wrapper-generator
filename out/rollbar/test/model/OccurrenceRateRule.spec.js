...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.OccurrenceRateRule();
  });
  ...
  describe('OccurrenceRateRule', function() {
    it('should create an instance of OccurrenceRateRule', function() {
      // uncomment below and update the code to test OccurrenceRateRule
      //var instane = new Rollbar.OccurrenceRateRule();
      //expect(instance).to.be.a(Rollbar.OccurrenceRateRule);
    });
