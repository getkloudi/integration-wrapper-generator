...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.OccurrenceRule();
  });
  ...
  describe('OccurrenceRule', function() {
    it('should create an instance of OccurrenceRule', function() {
      // uncomment below and update the code to test OccurrenceRule
      //var instane = new Rollbar.OccurrenceRule();
      //expect(instance).to.be.a(Rollbar.OccurrenceRule);
    });
