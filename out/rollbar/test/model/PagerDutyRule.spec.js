...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.PagerDutyRule();
  });
  ...
  describe('PagerDutyRule', function() {
    it('should create an instance of PagerDutyRule', function() {
      // uncomment below and update the code to test PagerDutyRule
      //var instane = new Rollbar.PagerDutyRule();
      //expect(instance).to.be.a(Rollbar.PagerDutyRule);
    });
