...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.DeployRule();
  });
  ...
  describe('DeployRule', function() {
    it('should create an instance of DeployRule', function() {
      // uncomment below and update the code to test DeployRule
      //var instane = new Rollbar.DeployRule();
      //expect(instance).to.be.a(Rollbar.DeployRule);
    });
