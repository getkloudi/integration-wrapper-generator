...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.EmailRule();
  });
  ...
  describe('EmailRule', function() {
    it('should create an instance of EmailRule', function() {
      // uncomment below and update the code to test EmailRule
      //var instane = new Rollbar.EmailRule();
      //expect(instance).to.be.a(Rollbar.EmailRule);
    });
