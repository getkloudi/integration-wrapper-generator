...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.ResolvedItemSlackRule();
  });
  ...
  describe('ResolvedItemSlackRule', function() {
    it('should create an instance of ResolvedItemSlackRule', function() {
      // uncomment below and update the code to test ResolvedItemSlackRule
      //var instane = new Rollbar.ResolvedItemSlackRule();
      //expect(instance).to.be.a(Rollbar.ResolvedItemSlackRule);
    });
