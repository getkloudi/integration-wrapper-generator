...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.ExpRepeatItemRule();
  });
  ...
  describe('ExpRepeatItemRule', function() {
    it('should create an instance of ExpRepeatItemRule', function() {
      // uncomment below and update the code to test ExpRepeatItemRule
      //var instane = new Rollbar.ExpRepeatItemRule();
      //expect(instance).to.be.a(Rollbar.ExpRepeatItemRule);
    });
