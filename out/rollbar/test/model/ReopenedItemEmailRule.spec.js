...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.ReopenedItemEmailRule();
  });
  ...
  describe('ReopenedItemEmailRule', function() {
    it('should create an instance of ReopenedItemEmailRule', function() {
      // uncomment below and update the code to test ReopenedItemEmailRule
      //var instane = new Rollbar.ReopenedItemEmailRule();
      //expect(instance).to.be.a(Rollbar.ReopenedItemEmailRule);
    });
