...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.ResolvedItemEmailRule();
  });
  ...
  describe('ResolvedItemEmailRule', function() {
    it('should create an instance of ResolvedItemEmailRule', function() {
      // uncomment below and update the code to test ResolvedItemEmailRule
      //var instane = new Rollbar.ResolvedItemEmailRule();
      //expect(instance).to.be.a(Rollbar.ResolvedItemEmailRule);
    });
