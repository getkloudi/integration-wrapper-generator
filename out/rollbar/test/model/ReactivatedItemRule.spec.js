...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.ReactivatedItemRule();
  });
  ...
  describe('ReactivatedItemRule', function() {
    it('should create an instance of ReactivatedItemRule', function() {
      // uncomment below and update the code to test ReactivatedItemRule
      //var instane = new Rollbar.ReactivatedItemRule();
      //expect(instance).to.be.a(Rollbar.ReactivatedItemRule);
    });
