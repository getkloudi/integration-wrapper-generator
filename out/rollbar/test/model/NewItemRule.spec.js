...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.NewItemRule();
  });
  ...
  describe('NewItemRule', function() {
    it('should create an instance of NewItemRule', function() {
      // uncomment below and update the code to test NewItemRule
      //var instane = new Rollbar.NewItemRule();
      //expect(instance).to.be.a(Rollbar.NewItemRule);
    });
