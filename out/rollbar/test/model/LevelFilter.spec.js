...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.LevelFilter();
  });
  ...
  describe('LevelFilter', function() {
    it('should create an instance of LevelFilter', function() {
      // uncomment below and update the code to test LevelFilter
      //var instane = new Rollbar.LevelFilter();
      //expect(instance).to.be.a(Rollbar.LevelFilter);
    });
