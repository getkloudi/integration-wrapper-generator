...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.DeployEmailRule();
  });
  ...
  describe('DeployEmailRule', function() {
    it('should create an instance of DeployEmailRule', function() {
      // uncomment below and update the code to test DeployEmailRule
      //var instane = new Rollbar.DeployEmailRule();
      //expect(instance).to.be.a(Rollbar.DeployEmailRule);
    });
