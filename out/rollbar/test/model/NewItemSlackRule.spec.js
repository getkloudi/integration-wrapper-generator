...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Rollbar.NewItemSlackRule();
  });
  ...
  describe('NewItemSlackRule', function() {
    it('should create an instance of NewItemSlackRule', function() {
      // uncomment below and update the code to test NewItemSlackRule
      //var instane = new Rollbar.NewItemSlackRule();
      //expect(instance).to.be.a(Rollbar.NewItemSlackRule);
    });
