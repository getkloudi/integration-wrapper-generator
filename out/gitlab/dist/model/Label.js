    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('closed_issues_count')) {
          obj['closed_issues_count'] = _ApiClient["default"].convertToType(data['closed_issues_count'], 'String');
        }
        ...
        if (data.hasOwnProperty('open_merge_requests_count')) {
          obj['open_merge_requests_count'] = _ApiClient["default"].convertToType(data['open_merge_requests_count'], 'String');
        }
