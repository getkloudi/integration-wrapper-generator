...
> Email postV3UserEmails(UNKNOWN_BASE_TYPE)
...
apiInstance.postV3UserEmails(UNKNOWN_BASE_TYPE, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> SSHKey postV3UserKeys(UNKNOWN_BASE_TYPE)
...
let apiInstance = new Gitlab.UserApi();
let UNKNOWN_BASE_TYPE = new Gitlab.UNKNOWN_BASE_TYPE(); // UNKNOWN_BASE_TYPE | 
apiInstance.postV3UserKeys(UNKNOWN_BASE_TYPE, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
