...
export default class UserSearchApi {
    ...
    */
     ...
     */
    userAssignableMultiProjectSearchGet(cloudid, projectKeys, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * data is of type: {@link Array.<module:model/User>}
     */
    userPermissionSearchGet(cloudid, permissions, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'cloudid' is set
      if (cloudid === undefined || cloudid === null) {
     ...
     */
    userPickerGet(cloudid, query, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'cloudid' is set
      if (cloudid === undefined || cloudid === null) {
     ...
     */
    userSearchQueryGet(cloudid, query, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'cloudid' is set
      if (cloudid === undefined || cloudid === null) {
     ...
     */
    userSearchQueryKeyGet(cloudid, query, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'cloudid' is set
      if (cloudid === undefined || cloudid === null) {
