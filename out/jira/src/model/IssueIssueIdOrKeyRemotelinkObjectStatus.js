...
import IssueIssueIdOrKeyRemotelinkObjectStatusIcon from './IssueIssueIdOrKeyRemotelinkObjectStatusIcon';
 ...
 * @version 1.3.1
 */
class IssueIssueIdOrKeyRemotelinkObjectStatus {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('icon')) {
                obj['icon'] = IssueIssueIdOrKeyRemotelinkObjectStatusIcon.constructFromObject(data['icon']);
            }
...
export default IssueIssueIdOrKeyRemotelinkObjectStatus;
