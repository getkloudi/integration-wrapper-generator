...
var _IssuePickerSuggestionsIssueType = _interopRequireDefault(require("./IssuePickerSuggestionsIssueType"));
 ...
 * @version 1.4.0
 */
var IssuePickerSuggestions = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>IssuePickerSuggestions</code>.
   * A list of issues suggested for use in auto-completion.
   * @alias module:model/IssuePickerSuggestions
   */
  function IssuePickerSuggestions() {
    _classCallCheck(this, IssuePickerSuggestions);
  ...
  _createClass(IssuePickerSuggestions, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('sections')) {
          obj['sections'] = _ApiClient["default"].convertToType(data['sections'], [_IssuePickerSuggestionsIssueType["default"]]);
        }
      }
...
var _default = IssuePickerSuggestions;
