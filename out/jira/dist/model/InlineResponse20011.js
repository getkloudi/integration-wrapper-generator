...
var _InlineResponse20011Value = _interopRequireDefault(require("./InlineResponse20011Value"));
...
var InlineResponse20011 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse20011(key, value) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('value')) {
          obj['value'] = _InlineResponse20011Value["default"].constructFromObject(data['value']);
        }
      }
