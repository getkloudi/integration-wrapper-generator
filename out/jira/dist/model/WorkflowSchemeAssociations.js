...
var _WorkflowScheme = _interopRequireDefault(require("./WorkflowScheme"));
 ...
 * @version 1.4.0
 */
var WorkflowSchemeAssociations = /*#__PURE__*/function () {
  /**
   ...
   */
  function WorkflowSchemeAssociations(projectIds) {
    _classCallCheck(this, WorkflowSchemeAssociations);
  ...
  _createClass(WorkflowSchemeAssociations, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('workflowScheme')) {
          obj['workflowScheme'] = _ApiClient["default"].convertToType(data['workflowScheme'], _WorkflowScheme["default"]);
        }
      }
...
var _default = WorkflowSchemeAssociations;
