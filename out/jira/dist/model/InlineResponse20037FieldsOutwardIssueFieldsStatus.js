 ...
 * @version 1.2.0
 */
var InlineResponse20037FieldsOutwardIssueFieldsStatus = /*#__PURE__*/function () {
  /**
   ...
   * @param name {String} 
   */
  function InlineResponse20037FieldsOutwardIssueFieldsStatus(iconUrl, name) {
    _classCallCheck(this, InlineResponse20037FieldsOutwardIssueFieldsStatus);
  ...
  _createClass(InlineResponse20037FieldsOutwardIssueFieldsStatus, null, [{
    key: "initialize",
    value: function initialize(obj, iconUrl, name) {
      obj['iconUrl'] = iconUrl;
      obj['name'] = name;
    }
    /**
  ...
  return InlineResponse20037FieldsOutwardIssueFieldsStatus;
}();
/**
...
var _default = InlineResponse20037FieldsOutwardIssueFieldsStatus;
