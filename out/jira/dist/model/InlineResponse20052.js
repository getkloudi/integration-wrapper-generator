...
var _InlineResponse20052IssueSecuritySchemes = _interopRequireDefault(require("./InlineResponse20052IssueSecuritySchemes"));
...
var InlineResponse20052 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse20052(issueSecuritySchemes) {
  ...
  _createClass(InlineResponse20052, null, [{
    key: "initialize",
    value: function initialize(obj, issueSecuritySchemes) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('issueSecuritySchemes')) {
          obj['issueSecuritySchemes'] = _ApiClient["default"].convertToType(data['issueSecuritySchemes'], [_InlineResponse20052IssueSecuritySchemes["default"]]);
        }
      }
