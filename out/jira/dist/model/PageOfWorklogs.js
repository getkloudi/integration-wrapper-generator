...
var _Worklog = _interopRequireDefault(require("./Worklog"));
 ...
 * @version 1.4.0
 */
var PageOfWorklogs = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PageOfWorklogs</code>.
   * Paginated list of worklog details
   * @alias module:model/PageOfWorklogs
   */
  function PageOfWorklogs() {
    _classCallCheck(this, PageOfWorklogs);
  ...
  _createClass(PageOfWorklogs, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('worklogs')) {
          obj['worklogs'] = _ApiClient["default"].convertToType(data['worklogs'], [_Worklog["default"]]);
        }
      }
