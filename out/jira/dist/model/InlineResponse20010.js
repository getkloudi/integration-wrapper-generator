...
var _InlineResponse20010Keys = _interopRequireDefault(require("./InlineResponse20010Keys"));
...
var InlineResponse20010 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse20010(keys) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('keys')) {
          obj['keys'] = _ApiClient["default"].convertToType(data['keys'], [_InlineResponse20010Keys["default"]]);
        }
      }
