...
var NestedResponse = /*#__PURE__*/function () {
  ...
  _createClass(NestedResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('errorCollection')) {
          obj['errorCollection'] = _ErrorCollection["default"].constructFromObject(data['errorCollection']);
        }
