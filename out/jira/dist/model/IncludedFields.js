...
var IncludedFields = /*#__PURE__*/function () {
  ...
  _createClass(IncludedFields, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('actuallyIncluded')) {
          obj['actuallyIncluded'] = _ApiClient["default"].convertToType(data['actuallyIncluded'], ['String']);
        }

        if (data.hasOwnProperty('excluded')) {
          obj['excluded'] = _ApiClient["default"].convertToType(data['excluded'], ['String']);
        }

        if (data.hasOwnProperty('included')) {
          obj['included'] = _ApiClient["default"].convertToType(data['included'], ['String']);
        }
      }
