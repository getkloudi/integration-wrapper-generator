...
var InlineResponse20014 = /*#__PURE__*/function () {
   ...
   * @param url {String} 
   */
  function InlineResponse20014(key, name, url) {
    _classCallCheck(this, InlineResponse20014);

    InlineResponse20014.initialize(this, key, name, url);
  }
  /**
  ...
  _createClass(InlineResponse20014, null, [{
    key: "initialize",
    value: function initialize(obj, key, name, url) {
      obj['key'] = key;
      obj['name'] = name;
      obj['url'] = url;
    }
...
InlineResponse20014.prototype['key'] = undefined;
/**
 * @member {String} name
 */
...
InlineResponse20014.prototype['url'] = undefined;
