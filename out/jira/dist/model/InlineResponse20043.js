...
var InlineResponse20043 = /*#__PURE__*/function () {
   ...
   * @param self {String} 
   */
  function InlineResponse20043(id, self) {
    _classCallCheck(this, InlineResponse20043);

    InlineResponse20043.initialize(this, id, self);
  }
  /**
  ...
  _createClass(InlineResponse20043, null, [{
    key: "initialize",
    value: function initialize(obj, id, self) {
      obj['id'] = id;
      obj['self'] = self;
    }
    /**
...
InlineResponse20043.prototype['self'] = undefined;
