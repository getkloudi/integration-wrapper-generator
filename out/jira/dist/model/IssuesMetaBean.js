...
var _IssuesJqlMetaDataBean = _interopRequireDefault(require("./IssuesJqlMetaDataBean"));
 ...
 * @version 1.4.0
 */
var IssuesMetaBean = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>IssuesMetaBean</code>.
   * Meta data describing the &#x60;issues&#x60; context variable.
   * @alias module:model/IssuesMetaBean
   */
  function IssuesMetaBean() {
    _classCallCheck(this, IssuesMetaBean);
  ...
  _createClass(IssuesMetaBean, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('jql')) {
          obj['jql'] = _IssuesJqlMetaDataBean["default"].constructFromObject(data['jql']);
        }
      }
