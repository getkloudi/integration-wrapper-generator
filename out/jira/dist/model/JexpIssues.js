...
var _JexpJqlIssues = _interopRequireDefault(require("./JexpJqlIssues"));
 ...
 * @version 1.4.0
 */
var JexpIssues = /*#__PURE__*/function () {
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('jql')) {
          obj['jql'] = _ApiClient["default"].convertToType(data['jql'], _JexpJqlIssues["default"]);
        }
      }
