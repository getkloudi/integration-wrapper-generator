 ...
 * @version 1.0.0
 */
var InlineResponse20087Issues = /*#__PURE__*/function () {
  /**
   ...
   * @param self {String} 
   */
  function InlineResponse20087Issues(expand, id, key, self) {
    _classCallCheck(this, InlineResponse20087Issues);
  ...
  _createClass(InlineResponse20087Issues, null, [{
    key: "initialize",
    value: function initialize(obj, expand, id, key, self) {
      obj['expand'] = expand;
      obj['id'] = id;
      obj['key'] = key;
      obj['self'] = self;
  ...
  return InlineResponse20087Issues;
}();
/**
...
var _default = InlineResponse20087Issues;
