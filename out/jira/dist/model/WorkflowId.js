 ...
 * @version 1.4.0
 */
var WorkflowId = /*#__PURE__*/function () {
  /**
   ...
   */
  function WorkflowId(draft, name) {
    _classCallCheck(this, WorkflowId);
  ...
  _createClass(WorkflowId, null, [{
    key: "initialize",
    value: function initialize(obj, draft, name) {
      obj['draft'] = draft;
      obj['name'] = name;
    }
    /**
