...
var InlineResponse2007AssociatedItems = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse2007AssociatedItems(id, name, parentId, parentName, typeName) {
    _classCallCheck(this, InlineResponse2007AssociatedItems);
  ...
  _createClass(InlineResponse2007AssociatedItems, null, [{
    key: "initialize",
    value: function initialize(obj, id, name, parentId, parentName, typeName) {
      obj['id'] = id;
      obj['name'] = name;
  ...
  return InlineResponse2007AssociatedItems;
}();
/**
 * @member {String} id
 */
...
var _default = InlineResponse2007AssociatedItems;
