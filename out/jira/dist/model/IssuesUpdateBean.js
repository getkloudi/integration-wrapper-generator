...
var _IssueUpdateDetails = _interopRequireDefault(require("./IssueUpdateDetails"));
 ...
 * @version 1.4.0
 */
var IssuesUpdateBean = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>IssuesUpdateBean</code>.
   * @alias module:model/IssuesUpdateBean
   */
  function IssuesUpdateBean() {
    _classCallCheck(this, IssuesUpdateBean);
  ...
  _createClass(IssuesUpdateBean, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('issueUpdates')) {
          obj['issueUpdates'] = _ApiClient["default"].convertToType(data['issueUpdates'], [_IssueUpdateDetails["default"]]);
        }
      }
