...
var InlineResponse20040 = /*#__PURE__*/function () {
   ...
   * @param total {Number} 
   */
  function InlineResponse20040(comments, maxResults, startAt, total) {
  ...
  _createClass(InlineResponse20040, null, [{
    key: "initialize",
    value: function initialize(obj, comments, maxResults, startAt, total) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('comments')) {
          obj['comments'] = _ApiClient["default"].convertToType(data['comments'], [_InlineResponse2009Values["default"]]);
        }
