...
var _ProjectIssueCreateMetadata = _interopRequireDefault(require("./ProjectIssueCreateMetadata"));
 ...
 * @version 1.4.0
 */
var IssueCreateMetadata = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>IssueCreateMetadata</code>.
   * The wrapper for the issue creation metadata for a list of projects.
   * @alias module:model/IssueCreateMetadata
   */
  function IssueCreateMetadata() {
    _classCallCheck(this, IssueCreateMetadata);
  ...
  _createClass(IssueCreateMetadata, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('projects')) {
          obj['projects'] = _ApiClient["default"].convertToType(data['projects'], [_ProjectIssueCreateMetadata["default"]]);
        }
      }
...
var _default = IssueCreateMetadata;
