...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PermissionsApi();
  });
  ...
  describe('PermissionsApi', function() {
    ...
    describe('permissionsCheckPost', function() {
      it('should call permissionsCheckPost successfully', function(done) {
        //uncomment below and update the code to test permissionsCheckPost
        //instance.permissionsCheckPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
