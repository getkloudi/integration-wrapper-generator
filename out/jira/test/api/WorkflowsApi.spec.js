...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.WorkflowsApi();
  });
  ...
  describe('WorkflowsApi', function() {
    ...
    describe('workflowSearchGet', function() {
      it('should call workflowSearchGet successfully', function(done) {
        //uncomment below and update the code to test workflowSearchGet
        //instance.workflowSearchGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
