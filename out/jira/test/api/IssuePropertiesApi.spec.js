...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.IssuePropertiesApi();
  });
  ...
  describe('IssuePropertiesApi', function() {
    ...
    describe('issuePropertiesPost', function() {
      it('should call issuePropertiesPost successfully', function(done) {
        //uncomment below and update the code to test issuePropertiesPost
        //instance.issuePropertiesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
