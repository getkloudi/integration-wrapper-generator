...
(function(root, factory) {
  ...
  describe('JQLApi', function() {
    ...
    describe('jqlParsePost', function() {
      it('should call jqlParsePost successfully', function(done) {
        //uncomment below and update the code to test jqlParsePost
        //instance.jqlParsePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
