...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanFieldConfiguration();
  });
  ...
  describe('PageBeanFieldConfiguration', function() {
    it('should create an instance of PageBeanFieldConfiguration', function() {
      // uncomment below and update the code to test PageBeanFieldConfiguration
      //var instane = new Jira.PageBeanFieldConfiguration();
      //expect(instance).to.be.a(Jira.PageBeanFieldConfiguration);
    });
