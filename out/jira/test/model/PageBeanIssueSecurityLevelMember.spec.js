...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanIssueSecurityLevelMember();
  });
  ...
  describe('PageBeanIssueSecurityLevelMember', function() {
    it('should create an instance of PageBeanIssueSecurityLevelMember', function() {
      // uncomment below and update the code to test PageBeanIssueSecurityLevelMember
      //var instane = new Jira.PageBeanIssueSecurityLevelMember();
      //expect(instance).to.be.a(Jira.PageBeanIssueSecurityLevelMember);
    });
