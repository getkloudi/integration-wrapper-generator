...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanString();
  });
  ...
  describe('PageBeanString', function() {
    it('should create an instance of PageBeanString', function() {
      // uncomment below and update the code to test PageBeanString
      //var instane = new Jira.PageBeanString();
      //expect(instance).to.be.a(Jira.PageBeanString);
    });
