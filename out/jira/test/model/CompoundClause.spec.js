...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.CompoundClause();
  });
  ...
  describe('CompoundClause', function() {
    it('should create an instance of CompoundClause', function() {
      // uncomment below and update the code to test CompoundClause
      //var instane = new Jira.CompoundClause();
      //expect(instance).to.be.a(Jira.CompoundClause);
    });
