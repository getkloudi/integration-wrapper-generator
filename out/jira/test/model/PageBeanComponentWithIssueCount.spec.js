...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanComponentWithIssueCount();
  });
  ...
  describe('PageBeanComponentWithIssueCount', function() {
    it('should create an instance of PageBeanComponentWithIssueCount', function() {
      // uncomment below and update the code to test PageBeanComponentWithIssueCount
      //var instane = new Jira.PageBeanComponentWithIssueCount();
      //expect(instance).to.be.a(Jira.PageBeanComponentWithIssueCount);
    });
