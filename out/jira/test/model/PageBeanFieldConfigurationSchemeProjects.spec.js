...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanFieldConfigurationSchemeProjects();
  });
  ...
  describe('PageBeanFieldConfigurationSchemeProjects', function() {
    it('should create an instance of PageBeanFieldConfigurationSchemeProjects', function() {
      ...
      //var instane = new Jira.PageBeanFieldConfigurationSchemeProjects();
      //expect(instance).to.be.a(Jira.PageBeanFieldConfigurationSchemeProjects);
    });
