...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanIssueTypeScreenScheme();
  });
  ...
  describe('PageBeanIssueTypeScreenScheme', function() {
    it('should create an instance of PageBeanIssueTypeScreenScheme', function() {
      ...
      //var instane = new Jira.PageBeanIssueTypeScreenScheme();
      //expect(instance).to.be.a(Jira.PageBeanIssueTypeScreenScheme);
    });
