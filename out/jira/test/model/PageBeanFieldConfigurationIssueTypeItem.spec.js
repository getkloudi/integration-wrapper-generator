...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanFieldConfigurationIssueTypeItem();
  });
  ...
  describe('PageBeanFieldConfigurationIssueTypeItem', function() {
    it('should create an instance of PageBeanFieldConfigurationIssueTypeItem', function() {
      ...
      //var instane = new Jira.PageBeanFieldConfigurationIssueTypeItem();
      //expect(instance).to.be.a(Jira.PageBeanFieldConfigurationIssueTypeItem);
    });
