...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.FilterIdPermissionProject();
  });
  ...
  describe('FilterIdPermissionProject', function() {
    it('should create an instance of FilterIdPermissionProject', function() {
      // uncomment below and update the code to test FilterIdPermissionProject
      //var instane = new Jira.FilterIdPermissionProject();
      //expect(instance).to.be.a(Jira.FilterIdPermissionProject);
    });
