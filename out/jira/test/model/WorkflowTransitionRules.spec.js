...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.WorkflowTransitionRules();
  });
  ...
  describe('WorkflowTransitionRules', function() {
    it('should create an instance of WorkflowTransitionRules', function() {
      // uncomment below and update the code to test WorkflowTransitionRules
      //var instane = new Jira.WorkflowTransitionRules();
      //expect(instance).to.be.a(Jira.WorkflowTransitionRules);
    });
