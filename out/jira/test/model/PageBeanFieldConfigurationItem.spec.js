...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanFieldConfigurationItem();
  });
  ...
  describe('PageBeanFieldConfigurationItem', function() {
    it('should create an instance of PageBeanFieldConfigurationItem', function() {
      // uncomment below and update the code to test PageBeanFieldConfigurationItem
      //var instane = new Jira.PageBeanFieldConfigurationItem();
      //expect(instance).to.be.a(Jira.PageBeanFieldConfigurationItem);
    });
