...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.JiraExpressionAnalysis();
  });
  ...
  describe('JiraExpressionAnalysis', function() {
    it('should create an instance of JiraExpressionAnalysis', function() {
      // uncomment below and update the code to test JiraExpressionAnalysis
      //var instane = new Jira.JiraExpressionAnalysis();
      //expect(instance).to.be.a(Jira.JiraExpressionAnalysis);
    });
