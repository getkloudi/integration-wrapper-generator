...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.AttachmentArchiveMetadataReadable();
  });
  ...
  describe('AttachmentArchiveMetadataReadable', function() {
    it('should create an instance of AttachmentArchiveMetadataReadable', function() {
      ...
      //var instane = new Jira.AttachmentArchiveMetadataReadable();
      //expect(instance).to.be.a(Jira.AttachmentArchiveMetadataReadable);
    });
