...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanIssueTypeScreenSchemeItem();
  });
  ...
  describe('PageBeanIssueTypeScreenSchemeItem', function() {
    it('should create an instance of PageBeanIssueTypeScreenSchemeItem', function() {
      // uncomment below and update the code to test PageBeanIssueTypeScreenSchemeItem
      //var instane = new Jira.PageBeanIssueTypeScreenSchemeItem();
      //expect(instance).to.be.a(Jira.PageBeanIssueTypeScreenSchemeItem);
    });
