...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanCustomFieldOptionDetails();
  });
  ...
  describe('PageBeanCustomFieldOptionDetails', function() {
    it('should create an instance of PageBeanCustomFieldOptionDetails', function() {
      // uncomment below and update the code to test PageBeanCustomFieldOptionDetails
      //var instane = new Jira.PageBeanCustomFieldOptionDetails();
      //expect(instance).to.be.a(Jira.PageBeanCustomFieldOptionDetails);
    });
