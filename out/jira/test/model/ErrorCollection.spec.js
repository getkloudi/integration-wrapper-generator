...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.ErrorCollection();
  });
  ...
  describe('ErrorCollection', function() {
    it('should create an instance of ErrorCollection', function() {
      // uncomment below and update the code to test ErrorCollection
      //var instane = new Jira.ErrorCollection();
      //expect(instance).to.be.a(Jira.ErrorCollection);
    });
