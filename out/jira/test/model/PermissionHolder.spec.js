...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PermissionHolder();
  });
  ...
  describe('PermissionHolder', function() {
    it('should create an instance of PermissionHolder', function() {
      // uncomment below and update the code to test PermissionHolder
      //var instane = new Jira.PermissionHolder();
      //expect(instance).to.be.a(Jira.PermissionHolder);
    });
