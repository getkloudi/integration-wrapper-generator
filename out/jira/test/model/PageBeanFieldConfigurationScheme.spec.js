...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanFieldConfigurationScheme();
  });
  ...
  describe('PageBeanFieldConfigurationScheme', function() {
    it('should create an instance of PageBeanFieldConfigurationScheme', function() {
      // uncomment below and update the code to test PageBeanFieldConfigurationScheme
      //var instane = new Jira.PageBeanFieldConfigurationScheme();
      //expect(instance).to.be.a(Jira.PageBeanFieldConfigurationScheme);
    });
