...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanIssueTypeSchemeMapping();
  });
  ...
  describe('PageBeanIssueTypeSchemeMapping', function() {
    it('should create an instance of PageBeanIssueTypeSchemeMapping', function() {
      ...
      //var instane = new Jira.PageBeanIssueTypeSchemeMapping();
      //expect(instance).to.be.a(Jira.PageBeanIssueTypeSchemeMapping);
    });
