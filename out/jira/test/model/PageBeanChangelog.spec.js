...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanChangelog();
  });
  ...
  describe('PageBeanChangelog', function() {
    it('should create an instance of PageBeanChangelog', function() {
      // uncomment below and update the code to test PageBeanChangelog
      //var instane = new Jira.PageBeanChangelog();
      //expect(instance).to.be.a(Jira.PageBeanChangelog);
    });
