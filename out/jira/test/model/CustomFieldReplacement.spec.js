...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.CustomFieldReplacement();
  });
  ...
  describe('CustomFieldReplacement', function() {
    it('should create an instance of CustomFieldReplacement', function() {
      // uncomment below and update the code to test CustomFieldReplacement
      //var instane = new Jira.CustomFieldReplacement();
      //expect(instance).to.be.a(Jira.CustomFieldReplacement);
    });
