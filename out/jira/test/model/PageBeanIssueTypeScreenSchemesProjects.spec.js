...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanIssueTypeScreenSchemesProjects();
  });
  ...
  describe('PageBeanIssueTypeScreenSchemesProjects', function() {
    it('should create an instance of PageBeanIssueTypeScreenSchemesProjects', function() {
      // uncomment below and update the code to test PageBeanIssueTypeScreenSchemesProjects
      //var instane = new Jira.PageBeanIssueTypeScreenSchemesProjects();
      //expect(instance).to.be.a(Jira.PageBeanIssueTypeScreenSchemesProjects);
    });
