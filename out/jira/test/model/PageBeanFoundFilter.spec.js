...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jira.PageBeanFoundFilter();
  });
  ...
  describe('PageBeanFoundFilter', function() {
    it('should create an instance of PageBeanFoundFilter', function() {
      // uncomment below and update the code to test PageBeanFoundFilter
      //var instane = new Jira.PageBeanFoundFilter();
      //expect(instance).to.be.a(Jira.PageBeanFoundFilter);
    });
