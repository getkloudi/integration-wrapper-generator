...
function () {
   ...
   */
  function OrganizationAsTeamMemberErrors() {
    _classCallCheck(this, OrganizationAsTeamMemberErrors);
  ...
  _createClass(OrganizationAsTeamMemberErrors, null, [{
    key: "initialize",
  ...
  return OrganizationAsTeamMemberErrors;
}();
/**
 * @member {String} code
 */
...
var _default = OrganizationAsTeamMemberErrors;
