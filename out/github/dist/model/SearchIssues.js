...
var _SearchIssuesItems = _interopRequireDefault(require("./SearchIssuesItems"));
...
var SearchIssues = /*#__PURE__*/function () {
  ...
  _createClass(SearchIssues, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) {
          obj['items'] = _ApiClient["default"].convertToType(data['items'], [_SearchIssuesItems["default"]]);
        }
