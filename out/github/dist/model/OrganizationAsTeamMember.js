...
var _OrganizationAsTeamMemberErrors = _interopRequireDefault(require("./OrganizationAsTeamMemberErrors"));
 ...
 * @version 1.4.4
 */
var OrganizationAsTeamMember = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OrganizationAsTeamMember</code>.
   * @alias module:model/OrganizationAsTeamMember
   */
  function OrganizationAsTeamMember() {
    _classCallCheck(this, OrganizationAsTeamMember);
  ...
  _createClass(OrganizationAsTeamMember, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('errors')) {
          obj['errors'] = _ApiClient["default"].convertToType(data['errors'], [_OrganizationAsTeamMemberErrors["default"]]);
        }
...
var _default = OrganizationAsTeamMember;
