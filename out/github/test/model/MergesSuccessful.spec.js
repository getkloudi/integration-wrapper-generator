...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHub.MergesSuccessful();
  });
  ...
  describe('MergesSuccessful', function() {
    it('should create an instance of MergesSuccessful', function() {
      // uncomment below and update the code to test MergesSuccessful
      //var instane = new GitHub.MergesSuccessful();
      //expect(instance).to.be.a(GitHub.MergesSuccessful);
    });
