...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHub.ContentsPath();
  });
  ...
  describe('ContentsPath', function() {
    it('should create an instance of ContentsPath', function() {
      // uncomment below and update the code to test ContentsPath
      //var instane = new GitHub.ContentsPath();
      //expect(instance).to.be.a(GitHub.ContentsPath);
    });
