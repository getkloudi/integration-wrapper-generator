...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.RequestSpotInstancesRequest();
  });
  ...
  describe('RequestSpotInstancesRequest', function() {
    it('should create an instance of RequestSpotInstancesRequest', function() {
      // uncomment below and update the code to test RequestSpotInstancesRequest
      //var instane = new AmazonEc2.RequestSpotInstancesRequest();
      //expect(instance).to.be.a(AmazonEc2.RequestSpotInstancesRequest);
    });
