...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.FpgaDeviceInfo();
  });
  ...
  describe('FpgaDeviceInfo', function() {
    it('should create an instance of FpgaDeviceInfo', function() {
      // uncomment below and update the code to test FpgaDeviceInfo
      //var instane = new AmazonEc2.FpgaDeviceInfo();
      //expect(instance).to.be.a(AmazonEc2.FpgaDeviceInfo);
    });
