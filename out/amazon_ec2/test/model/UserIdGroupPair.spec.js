...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.UserIdGroupPair();
  });
  ...
  describe('UserIdGroupPair', function() {
    it('should create an instance of UserIdGroupPair', function() {
      // uncomment below and update the code to test UserIdGroupPair
      //var instane = new AmazonEc2.UserIdGroupPair();
      //expect(instance).to.be.a(AmazonEc2.UserIdGroupPair);
    });
    ...
    it('should have the property peeringStatus (base name: "PeeringStatus")', function() {
      // uncomment below and update the code to test the property peeringStatus
      //var instane = new AmazonEc2.UserIdGroupPair();
      //expect(instance).to.be();
    });
