...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ConfirmProductInstanceRequest();
  });
  ...
  describe('ConfirmProductInstanceRequest', function() {
    it('should create an instance of ConfirmProductInstanceRequest', function() {
      // uncomment below and update the code to test ConfirmProductInstanceRequest
      //var instane = new AmazonEc2.ConfirmProductInstanceRequest();
      //expect(instance).to.be.a(AmazonEc2.ConfirmProductInstanceRequest);
    });
