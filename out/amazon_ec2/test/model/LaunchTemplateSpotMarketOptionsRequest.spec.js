...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.LaunchTemplateSpotMarketOptionsRequest();
  });
  ...
  describe('LaunchTemplateSpotMarketOptionsRequest', function() {
    it('should create an instance of LaunchTemplateSpotMarketOptionsRequest', function() {
      // uncomment below and update the code to test LaunchTemplateSpotMarketOptionsRequest
      //var instane = new AmazonEc2.LaunchTemplateSpotMarketOptionsRequest();
      //expect(instance).to.be.a(AmazonEc2.LaunchTemplateSpotMarketOptionsRequest);
    });
    ...
    it('should have the property spotInstanceType (base name: "SpotInstanceType")', function() {
      // uncomment below and update the code to test the property spotInstanceType
      //var instane = new AmazonEc2.LaunchTemplateSpotMarketOptionsRequest();
      //expect(instance).to.be();
    });
