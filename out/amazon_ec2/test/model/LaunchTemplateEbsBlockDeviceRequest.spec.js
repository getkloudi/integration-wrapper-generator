...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.LaunchTemplateEbsBlockDeviceRequest();
  });
  ...
  describe('LaunchTemplateEbsBlockDeviceRequest', function() {
    it('should create an instance of LaunchTemplateEbsBlockDeviceRequest', function() {
      // uncomment below and update the code to test LaunchTemplateEbsBlockDeviceRequest
      //var instane = new AmazonEc2.LaunchTemplateEbsBlockDeviceRequest();
      //expect(instance).to.be.a(AmazonEc2.LaunchTemplateEbsBlockDeviceRequest);
    });
