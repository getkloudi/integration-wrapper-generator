...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ImportImageResult();
  });
  ...
  describe('ImportImageResult', function() {
    it('should create an instance of ImportImageResult', function() {
      // uncomment below and update the code to test ImportImageResult
      //var instane = new AmazonEc2.ImportImageResult();
      //expect(instance).to.be.a(AmazonEc2.ImportImageResult);
    });
