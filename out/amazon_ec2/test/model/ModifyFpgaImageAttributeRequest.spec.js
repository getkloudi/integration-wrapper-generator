...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifyFpgaImageAttributeRequest();
  });
  ...
  describe('ModifyFpgaImageAttributeRequest', function() {
    it('should create an instance of ModifyFpgaImageAttributeRequest', function() {
      // uncomment below and update the code to test ModifyFpgaImageAttributeRequest
      //var instane = new AmazonEc2.ModifyFpgaImageAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifyFpgaImageAttributeRequest);
    });
    ...
    it('should have the property loadPermission (base name: "LoadPermission")', function() {
      // uncomment below and update the code to test the property loadPermission
      //var instane = new AmazonEc2.ModifyFpgaImageAttributeRequest();
      //expect(instance).to.be();
    });
