...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ReservedInstancesConfiguration();
  });
  ...
  describe('ReservedInstancesConfiguration', function() {
    it('should create an instance of ReservedInstancesConfiguration', function() {
      // uncomment below and update the code to test ReservedInstancesConfiguration
      //var instane = new AmazonEc2.ReservedInstancesConfiguration();
      //expect(instance).to.be.a(AmazonEc2.ReservedInstancesConfiguration);
    });
