...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeClientVpnEndpointsRequest();
  });
  ...
  describe('DescribeClientVpnEndpointsRequest', function() {
    it('should create an instance of DescribeClientVpnEndpointsRequest', function() {
      // uncomment below and update the code to test DescribeClientVpnEndpointsRequest
      //var instane = new AmazonEc2.DescribeClientVpnEndpointsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeClientVpnEndpointsRequest);
    });

    it('should have the property clientVpnEndpointIds (base name: "ClientVpnEndpointIds")', function() {
      // uncomment below and update the code to test the property clientVpnEndpointIds
      //var instane = new AmazonEc2.DescribeClientVpnEndpointsRequest();
