...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeSpotInstanceRequestsRequest();
  });
  ...
  describe('DescribeSpotInstanceRequestsRequest', function() {
    it('should create an instance of DescribeSpotInstanceRequestsRequest', function() {
      // uncomment below and update the code to test DescribeSpotInstanceRequestsRequest
      //var instane = new AmazonEc2.DescribeSpotInstanceRequestsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeSpotInstanceRequestsRequest);
    });
    ...
    it('should have the property spotInstanceRequestIds (base name: "SpotInstanceRequestIds")', function() {
      // uncomment below and update the code to test the property spotInstanceRequestIds
      //var instane = new AmazonEc2.DescribeSpotInstanceRequestsRequest();
      //expect(instance).to.be();
    });
