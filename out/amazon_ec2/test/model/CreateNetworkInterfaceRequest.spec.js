...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateNetworkInterfaceRequest();
  });
  ...
  describe('CreateNetworkInterfaceRequest', function() {
    it('should create an instance of CreateNetworkInterfaceRequest', function() {
      // uncomment below and update the code to test CreateNetworkInterfaceRequest
      //var instane = new AmazonEc2.CreateNetworkInterfaceRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateNetworkInterfaceRequest);
    });
