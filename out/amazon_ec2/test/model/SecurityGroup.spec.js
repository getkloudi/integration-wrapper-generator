...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SecurityGroup();
  });
  ...
  describe('SecurityGroup', function() {
    it('should create an instance of SecurityGroup', function() {
      ...
      //var instane = new AmazonEc2.SecurityGroup();
      //expect(instance).to.be.a(AmazonEc2.SecurityGroup);
    });
    ...
    it('should have the property ipPermissionsEgress (base name: "IpPermissionsEgress")', function() {
      // uncomment below and update the code to test the property ipPermissionsEgress
      //var instane = new AmazonEc2.SecurityGroup();
      //expect(instance).to.be();
    });
