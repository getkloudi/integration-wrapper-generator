...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CapacityReservation();
  });
  ...
  describe('CapacityReservation', function() {
    it('should create an instance of CapacityReservation', function() {
      // uncomment below and update the code to test CapacityReservation
      //var instane = new AmazonEc2.CapacityReservation();
      //expect(instance).to.be.a(AmazonEc2.CapacityReservation);
    });
    ...
    it('should have the property capacityReservationArn (base name: "CapacityReservationArn")', function() {
      // uncomment below and update the code to test the property capacityReservationArn
      //var instane = new AmazonEc2.CapacityReservation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property endDateType (base name: "EndDateType")', function() {
      // uncomment below and update the code to test the property endDateType
      //var instane = new AmazonEc2.CapacityReservation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property instanceMatchCriteria (base name: "InstanceMatchCriteria")', function() {
      // uncomment below and update the code to test the property instanceMatchCriteria
      //var instane = new AmazonEc2.CapacityReservation();
      //expect(instance).to.be();
    });

    it('should have the property instancePlatform (base name: "InstancePlatform")', function() {
      // uncomment below and update the code to test the property instancePlatform
      //var instane = new AmazonEc2.CapacityReservation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property totalInstanceCount (base name: "TotalInstanceCount")', function() {
      // uncomment below and update the code to test the property totalInstanceCount
      //var instane = new AmazonEc2.CapacityReservation();
      //expect(instance).to.be();
    });
