...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AllocateHostsRequest();
  });
  ...
  describe('AllocateHostsRequest', function() {
    it('should create an instance of AllocateHostsRequest', function() {
      // uncomment below and update the code to test AllocateHostsRequest
      //var instane = new AmazonEc2.AllocateHostsRequest();
      //expect(instance).to.be.a(AmazonEc2.AllocateHostsRequest);
    });
