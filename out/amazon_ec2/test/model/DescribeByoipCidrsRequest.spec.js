...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeByoipCidrsRequest();
  });
  ...
  describe('DescribeByoipCidrsRequest', function() {
    it('should create an instance of DescribeByoipCidrsRequest', function() {
      // uncomment below and update the code to test DescribeByoipCidrsRequest
      //var instane = new AmazonEc2.DescribeByoipCidrsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeByoipCidrsRequest);
    });
