...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.LaunchSpecification();
  });
  ...
  describe('LaunchSpecification', function() {
    it('should create an instance of LaunchSpecification', function() {
      // uncomment below and update the code to test LaunchSpecification
      //var instane = new AmazonEc2.LaunchSpecification();
      //expect(instance).to.be.a(AmazonEc2.LaunchSpecification);
    });
