...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SpotOptionsRequest();
  });
  ...
  describe('SpotOptionsRequest', function() {
    it('should create an instance of SpotOptionsRequest', function() {
      // uncomment below and update the code to test SpotOptionsRequest
      //var instane = new AmazonEc2.SpotOptionsRequest();
      //expect(instance).to.be.a(AmazonEc2.SpotOptionsRequest);
    });
