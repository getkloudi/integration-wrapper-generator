...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.VolumeStatusEvent();
  });
  ...
  describe('VolumeStatusEvent', function() {
    it('should create an instance of VolumeStatusEvent', function() {
      // uncomment below and update the code to test VolumeStatusEvent
      //var instane = new AmazonEc2.VolumeStatusEvent();
      //expect(instance).to.be.a(AmazonEc2.VolumeStatusEvent);
    });
