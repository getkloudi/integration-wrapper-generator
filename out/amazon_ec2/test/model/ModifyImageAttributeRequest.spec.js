...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifyImageAttributeRequest();
  });
  ...
  describe('ModifyImageAttributeRequest', function() {
    it('should create an instance of ModifyImageAttributeRequest', function() {
      // uncomment below and update the code to test ModifyImageAttributeRequest
      //var instane = new AmazonEc2.ModifyImageAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifyImageAttributeRequest);
    });
    ...
    it('should have the property launchPermission (base name: "LaunchPermission")', function() {
      // uncomment below and update the code to test the property launchPermission
      //var instane = new AmazonEc2.ModifyImageAttributeRequest();
      //expect(instance).to.be();
    });
