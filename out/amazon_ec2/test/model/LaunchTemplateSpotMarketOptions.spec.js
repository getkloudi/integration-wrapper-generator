...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.LaunchTemplateSpotMarketOptions();
  });
  ...
  describe('LaunchTemplateSpotMarketOptions', function() {
    it('should create an instance of LaunchTemplateSpotMarketOptions', function() {
      // uncomment below and update the code to test LaunchTemplateSpotMarketOptions
      //var instane = new AmazonEc2.LaunchTemplateSpotMarketOptions();
      //expect(instance).to.be.a(AmazonEc2.LaunchTemplateSpotMarketOptions);
    });
