...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifyHostsRequest();
  });
  ...
  describe('ModifyHostsRequest', function() {
    it('should create an instance of ModifyHostsRequest', function() {
      // uncomment below and update the code to test ModifyHostsRequest
      //var instane = new AmazonEc2.ModifyHostsRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifyHostsRequest);
    });
