...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVpcAttributeRequest();
  });
  ...
  describe('DescribeVpcAttributeRequest', function() {
    it('should create an instance of DescribeVpcAttributeRequest', function() {
      // uncomment below and update the code to test DescribeVpcAttributeRequest
      //var instane = new AmazonEc2.DescribeVpcAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVpcAttributeRequest);
    });
