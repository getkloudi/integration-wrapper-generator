...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeSubnetsRequest();
  });
  ...
  describe('DescribeSubnetsRequest', function() {
    it('should create an instance of DescribeSubnetsRequest', function() {
      // uncomment below and update the code to test DescribeSubnetsRequest
      //var instane = new AmazonEc2.DescribeSubnetsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeSubnetsRequest);
    });
