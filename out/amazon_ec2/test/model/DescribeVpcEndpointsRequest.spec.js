...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVpcEndpointsRequest();
  });
  ...
  describe('DescribeVpcEndpointsRequest', function() {
    it('should create an instance of DescribeVpcEndpointsRequest', function() {
      ...
      //var instane = new AmazonEc2.DescribeVpcEndpointsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVpcEndpointsRequest);
    });
