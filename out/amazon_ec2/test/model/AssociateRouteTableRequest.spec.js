...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AssociateRouteTableRequest();
  });
  ...
  describe('AssociateRouteTableRequest', function() {
    it('should create an instance of AssociateRouteTableRequest', function() {
      // uncomment below and update the code to test AssociateRouteTableRequest
      //var instane = new AmazonEc2.AssociateRouteTableRequest();
      //expect(instance).to.be.a(AmazonEc2.AssociateRouteTableRequest);
    });
