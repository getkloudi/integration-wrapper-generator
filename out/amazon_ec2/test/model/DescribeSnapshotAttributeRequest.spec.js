...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeSnapshotAttributeRequest();
  });
  ...
  describe('DescribeSnapshotAttributeRequest', function() {
    it('should create an instance of DescribeSnapshotAttributeRequest', function() {
      // uncomment below and update the code to test DescribeSnapshotAttributeRequest
      //var instane = new AmazonEc2.DescribeSnapshotAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeSnapshotAttributeRequest);
    });
