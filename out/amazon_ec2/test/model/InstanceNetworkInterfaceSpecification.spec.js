...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.InstanceNetworkInterfaceSpecification();
  });
  ...
  describe('InstanceNetworkInterfaceSpecification', function() {
    it('should create an instance of InstanceNetworkInterfaceSpecification', function() {
      // uncomment below and update the code to test InstanceNetworkInterfaceSpecification
      //var instane = new AmazonEc2.InstanceNetworkInterfaceSpecification();
      //expect(instance).to.be.a(AmazonEc2.InstanceNetworkInterfaceSpecification);
    });
