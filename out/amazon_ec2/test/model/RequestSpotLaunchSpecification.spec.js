...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.RequestSpotLaunchSpecification();
  });
  ...
  describe('RequestSpotLaunchSpecification', function() {
    it('should create an instance of RequestSpotLaunchSpecification', function() {
      // uncomment below and update the code to test RequestSpotLaunchSpecification
      //var instane = new AmazonEc2.RequestSpotLaunchSpecification();
      //expect(instance).to.be.a(AmazonEc2.RequestSpotLaunchSpecification);
    });

    it('should have the property addressingType (base name: "AddressingType")', function() {
      // uncomment below and update the code to test the property addressingType
      //var instane = new AmazonEc2.RequestSpotLaunchSpecification();
