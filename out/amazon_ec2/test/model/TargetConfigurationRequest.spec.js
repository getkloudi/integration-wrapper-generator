...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.TargetConfigurationRequest();
  });
  ...
  describe('TargetConfigurationRequest', function() {
    it('should create an instance of TargetConfigurationRequest', function() {
      // uncomment below and update the code to test TargetConfigurationRequest
      //var instane = new AmazonEc2.TargetConfigurationRequest();
      //expect(instance).to.be.a(AmazonEc2.TargetConfigurationRequest);
    });
