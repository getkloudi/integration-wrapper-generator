...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVpcEndpointConnectionsRequest();
  });
  ...
  describe('DescribeVpcEndpointConnectionsRequest', function() {
    it('should create an instance of DescribeVpcEndpointConnectionsRequest', function() {
      // uncomment below and update the code to test DescribeVpcEndpointConnectionsRequest
      //var instane = new AmazonEc2.DescribeVpcEndpointConnectionsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVpcEndpointConnectionsRequest);
    });
