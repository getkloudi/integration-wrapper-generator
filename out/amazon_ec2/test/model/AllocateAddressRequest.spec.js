...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AllocateAddressRequest();
  });
  ...
  describe('AllocateAddressRequest', function() {
    it('should create an instance of AllocateAddressRequest', function() {
      // uncomment below and update the code to test AllocateAddressRequest
      //var instane = new AmazonEc2.AllocateAddressRequest();
      //expect(instance).to.be.a(AmazonEc2.AllocateAddressRequest);
    });
