...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateSecurityGroupRequest();
  });
  ...
  describe('CreateSecurityGroupRequest', function() {
    it('should create an instance of CreateSecurityGroupRequest', function() {
      // uncomment below and update the code to test CreateSecurityGroupRequest
      //var instane = new AmazonEc2.CreateSecurityGroupRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateSecurityGroupRequest);
    });
