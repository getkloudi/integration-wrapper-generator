...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVpcEndpointServicesRequest();
  });
  ...
  describe('DescribeVpcEndpointServicesRequest', function() {
    it('should create an instance of DescribeVpcEndpointServicesRequest', function() {
      // uncomment below and update the code to test DescribeVpcEndpointServicesRequest
      //var instane = new AmazonEc2.DescribeVpcEndpointServicesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVpcEndpointServicesRequest);
    });
