...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.PrincipalIdFormat();
  });
  ...
  describe('PrincipalIdFormat', function() {
    it('should create an instance of PrincipalIdFormat', function() {
      // uncomment below and update the code to test PrincipalIdFormat
      //var instane = new AmazonEc2.PrincipalIdFormat();
      //expect(instance).to.be.a(AmazonEc2.PrincipalIdFormat);
    });
