...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateClientVpnRouteRequest();
  });
  ...
  describe('CreateClientVpnRouteRequest', function() {
    it('should create an instance of CreateClientVpnRouteRequest', function() {
      // uncomment below and update the code to test CreateClientVpnRouteRequest
      //var instane = new AmazonEc2.CreateClientVpnRouteRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateClientVpnRouteRequest);
    });
    ...
    it('should have the property targetVpcSubnetId (base name: "TargetVpcSubnetId")', function() {
      // uncomment below and update the code to test the property targetVpcSubnetId
      //var instane = new AmazonEc2.CreateClientVpnRouteRequest();
      //expect(instance).to.be();
    });
