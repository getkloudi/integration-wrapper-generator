...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.BundleInstanceRequest();
  });
  ...
  describe('BundleInstanceRequest', function() {
    it('should create an instance of BundleInstanceRequest', function() {
      // uncomment below and update the code to test BundleInstanceRequest
      //var instane = new AmazonEc2.BundleInstanceRequest();
      //expect(instance).to.be.a(AmazonEc2.BundleInstanceRequest);
    });
