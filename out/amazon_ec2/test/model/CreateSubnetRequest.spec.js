...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateSubnetRequest();
  });
  ...
  describe('CreateSubnetRequest', function() {
    it('should create an instance of CreateSubnetRequest', function() {
      // uncomment below and update the code to test CreateSubnetRequest
      //var instane = new AmazonEc2.CreateSubnetRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateSubnetRequest);
    });
