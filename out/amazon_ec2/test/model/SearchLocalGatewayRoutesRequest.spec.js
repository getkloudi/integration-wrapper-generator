...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SearchLocalGatewayRoutesRequest();
  });
  ...
  describe('SearchLocalGatewayRoutesRequest', function() {
    it('should create an instance of SearchLocalGatewayRoutesRequest', function() {
      // uncomment below and update the code to test SearchLocalGatewayRoutesRequest
      //var instane = new AmazonEc2.SearchLocalGatewayRoutesRequest();
      //expect(instance).to.be.a(AmazonEc2.SearchLocalGatewayRoutesRequest);
    });
