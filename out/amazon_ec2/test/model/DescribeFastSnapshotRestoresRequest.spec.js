...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeFastSnapshotRestoresRequest();
  });
  ...
  describe('DescribeFastSnapshotRestoresRequest', function() {
    it('should create an instance of DescribeFastSnapshotRestoresRequest', function() {
      // uncomment below and update the code to test DescribeFastSnapshotRestoresRequest
      //var instane = new AmazonEc2.DescribeFastSnapshotRestoresRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeFastSnapshotRestoresRequest);
    });
