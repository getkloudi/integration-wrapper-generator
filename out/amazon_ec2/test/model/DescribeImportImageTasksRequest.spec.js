...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeImportImageTasksRequest();
  });
  ...
  describe('DescribeImportImageTasksRequest', function() {
    it('should create an instance of DescribeImportImageTasksRequest', function() {
      // uncomment below and update the code to test DescribeImportImageTasksRequest
      //var instane = new AmazonEc2.DescribeImportImageTasksRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeImportImageTasksRequest);
    });
