...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribePrefixListsRequest();
  });
  ...
  describe('DescribePrefixListsRequest', function() {
    it('should create an instance of DescribePrefixListsRequest', function() {
      // uncomment below and update the code to test DescribePrefixListsRequest
      //var instane = new AmazonEc2.DescribePrefixListsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribePrefixListsRequest);
    });
