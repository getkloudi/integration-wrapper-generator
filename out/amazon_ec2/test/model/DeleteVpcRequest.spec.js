...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DeleteVpcRequest();
  });
  ...
  describe('DeleteVpcRequest', function() {
    it('should create an instance of DeleteVpcRequest', function() {
      // uncomment below and update the code to test DeleteVpcRequest
      //var instane = new AmazonEc2.DeleteVpcRequest();
      //expect(instance).to.be.a(AmazonEc2.DeleteVpcRequest);
    });
