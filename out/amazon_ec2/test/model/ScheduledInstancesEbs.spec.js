...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ScheduledInstancesEbs();
  });
  ...
  describe('ScheduledInstancesEbs', function() {
    it('should create an instance of ScheduledInstancesEbs', function() {
      // uncomment below and update the code to test ScheduledInstancesEbs
      //var instane = new AmazonEc2.ScheduledInstancesEbs();
      //expect(instance).to.be.a(AmazonEc2.ScheduledInstancesEbs);
    });
