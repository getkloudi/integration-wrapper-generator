...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeInstancesResult();
  });
  ...
  describe('DescribeInstancesResult', function() {
    it('should create an instance of DescribeInstancesResult', function() {
      // uncomment below and update the code to test DescribeInstancesResult
      //var instane = new AmazonEc2.DescribeInstancesResult();
      //expect(instance).to.be.a(AmazonEc2.DescribeInstancesResult);
    });
