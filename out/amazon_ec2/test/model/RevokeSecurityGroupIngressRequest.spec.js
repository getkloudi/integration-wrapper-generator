...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.RevokeSecurityGroupIngressRequest();
  });
  ...
  describe('RevokeSecurityGroupIngressRequest', function() {
    it('should create an instance of RevokeSecurityGroupIngressRequest', function() {
      // uncomment below and update the code to test RevokeSecurityGroupIngressRequest
      //var instane = new AmazonEc2.RevokeSecurityGroupIngressRequest();
      //expect(instance).to.be.a(AmazonEc2.RevokeSecurityGroupIngressRequest);
    });
