...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeExportImageTasksRequest();
  });
  ...
  describe('DescribeExportImageTasksRequest', function() {
    it('should create an instance of DescribeExportImageTasksRequest', function() {
      // uncomment below and update the code to test DescribeExportImageTasksRequest
      //var instane = new AmazonEc2.DescribeExportImageTasksRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeExportImageTasksRequest);
    });
    ...
    it('should have the property exportImageTaskIds (base name: "ExportImageTaskIds")', function() {
      // uncomment below and update the code to test the property exportImageTaskIds
      //var instane = new AmazonEc2.DescribeExportImageTasksRequest();
      //expect(instance).to.be();
    });
