...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.LocalGateway();
  });
  ...
  describe('LocalGateway', function() {
    it('should create an instance of LocalGateway', function() {
      // uncomment below and update the code to test LocalGateway
      //var instane = new AmazonEc2.LocalGateway();
      //expect(instance).to.be.a(AmazonEc2.LocalGateway);
    });
