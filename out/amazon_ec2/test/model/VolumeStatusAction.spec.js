...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.VolumeStatusAction();
  });
  ...
  describe('VolumeStatusAction', function() {
    it('should create an instance of VolumeStatusAction', function() {
      // uncomment below and update the code to test VolumeStatusAction
      //var instane = new AmazonEc2.VolumeStatusAction();
      //expect(instance).to.be.a(AmazonEc2.VolumeStatusAction);
    });
