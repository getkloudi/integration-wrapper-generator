...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifySnapshotAttributeRequest();
  });
  ...
  describe('ModifySnapshotAttributeRequest', function() {
    it('should create an instance of ModifySnapshotAttributeRequest', function() {
      // uncomment below and update the code to test ModifySnapshotAttributeRequest
      //var instane = new AmazonEc2.ModifySnapshotAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifySnapshotAttributeRequest);
    });
    ...
    it('should have the property createVolumePermission (base name: "CreateVolumePermission")', function() {
      // uncomment below and update the code to test the property createVolumePermission
      //var instane = new AmazonEc2.ModifySnapshotAttributeRequest();
      //expect(instance).to.be();
    });
