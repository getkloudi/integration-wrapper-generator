...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeFastSnapshotRestoreSuccessItem();
  });
  ...
  describe('DescribeFastSnapshotRestoreSuccessItem', function() {
    it('should create an instance of DescribeFastSnapshotRestoreSuccessItem', function() {
      // uncomment below and update the code to test DescribeFastSnapshotRestoreSuccessItem
      //var instane = new AmazonEc2.DescribeFastSnapshotRestoreSuccessItem();
      //expect(instance).to.be.a(AmazonEc2.DescribeFastSnapshotRestoreSuccessItem);
    });
