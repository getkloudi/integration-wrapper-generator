...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SpotPlacement();
  });
  ...
  describe('SpotPlacement', function() {
    it('should create an instance of SpotPlacement', function() {
      // uncomment below and update the code to test SpotPlacement
      //var instane = new AmazonEc2.SpotPlacement();
      //expect(instance).to.be.a(AmazonEc2.SpotPlacement);
    });
