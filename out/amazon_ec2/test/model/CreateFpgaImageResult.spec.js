...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateFpgaImageResult();
  });
  ...
  describe('CreateFpgaImageResult', function() {
    it('should create an instance of CreateFpgaImageResult', function() {
      // uncomment below and update the code to test CreateFpgaImageResult
      //var instane = new AmazonEc2.CreateFpgaImageResult();
      //expect(instance).to.be.a(AmazonEc2.CreateFpgaImageResult);
    });
