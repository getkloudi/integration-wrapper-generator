...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ImageAttribute();
  });
  ...
  describe('ImageAttribute', function() {
    it('should create an instance of ImageAttribute', function() {
      ...
      //var instane = new AmazonEc2.ImageAttribute();
      //expect(instance).to.be.a(AmazonEc2.ImageAttribute);
    });
    ...
    it('should have the property launchPermissions (base name: "LaunchPermissions")', function() {
      // uncomment below and update the code to test the property launchPermissions
      //var instane = new AmazonEc2.ImageAttribute();
      //expect(instance).to.be();
    });
