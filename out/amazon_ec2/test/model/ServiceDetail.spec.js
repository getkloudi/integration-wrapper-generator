...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ServiceDetail();
  });
  ...
  describe('ServiceDetail', function() {
    it('should create an instance of ServiceDetail', function() {
      // uncomment below and update the code to test ServiceDetail
      //var instane = new AmazonEc2.ServiceDetail();
      //expect(instance).to.be.a(AmazonEc2.ServiceDetail);
    });
    ...
    it('should have the property vpcEndpointPolicySupported (base name: "VpcEndpointPolicySupported")', function() {
      // uncomment below and update the code to test the property vpcEndpointPolicySupported
      //var instane = new AmazonEc2.ServiceDetail();
      //expect(instance).to.be();
    });
