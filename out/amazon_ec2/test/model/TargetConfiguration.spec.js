...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.TargetConfiguration();
  });
  ...
  describe('TargetConfiguration', function() {
    it('should create an instance of TargetConfiguration', function() {
      // uncomment below and update the code to test TargetConfiguration
      //var instane = new AmazonEc2.TargetConfiguration();
      //expect(instance).to.be.a(AmazonEc2.TargetConfiguration);
    });
