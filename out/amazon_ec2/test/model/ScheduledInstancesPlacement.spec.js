...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ScheduledInstancesPlacement();
  });
  ...
  describe('ScheduledInstancesPlacement', function() {
    it('should create an instance of ScheduledInstancesPlacement', function() {
      // uncomment below and update the code to test ScheduledInstancesPlacement
      //var instane = new AmazonEc2.ScheduledInstancesPlacement();
      //expect(instance).to.be.a(AmazonEc2.ScheduledInstancesPlacement);
    });
