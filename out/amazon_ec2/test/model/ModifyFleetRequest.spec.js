...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifyFleetRequest();
  });
  ...
  describe('ModifyFleetRequest', function() {
    it('should create an instance of ModifyFleetRequest', function() {
      // uncomment below and update the code to test ModifyFleetRequest
      //var instane = new AmazonEc2.ModifyFleetRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifyFleetRequest);
    });
