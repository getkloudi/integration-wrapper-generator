...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeInternetGatewaysRequest();
  });
  ...
  describe('DescribeInternetGatewaysRequest', function() {
    it('should create an instance of DescribeInternetGatewaysRequest', function() {
      // uncomment below and update the code to test DescribeInternetGatewaysRequest
      //var instane = new AmazonEc2.DescribeInternetGatewaysRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeInternetGatewaysRequest);
    });
    ...
    it('should have the property internetGatewayIds (base name: "InternetGatewayIds")', function() {
      // uncomment below and update the code to test the property internetGatewayIds
      //var instane = new AmazonEc2.DescribeInternetGatewaysRequest();
      //expect(instance).to.be();
    });
