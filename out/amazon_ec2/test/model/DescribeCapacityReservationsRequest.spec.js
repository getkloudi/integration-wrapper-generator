...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeCapacityReservationsRequest();
  });
  ...
  describe('DescribeCapacityReservationsRequest', function() {
    it('should create an instance of DescribeCapacityReservationsRequest', function() {
      // uncomment below and update the code to test DescribeCapacityReservationsRequest
      //var instane = new AmazonEc2.DescribeCapacityReservationsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeCapacityReservationsRequest);
    });

    it('should have the property capacityReservationIds (base name: "CapacityReservationIds")', function() {
      // uncomment below and update the code to test the property capacityReservationIds
      //var instane = new AmazonEc2.DescribeCapacityReservationsRequest();
