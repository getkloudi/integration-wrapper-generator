...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SpotMarketOptions();
  });
  ...
  describe('SpotMarketOptions', function() {
    it('should create an instance of SpotMarketOptions', function() {
      // uncomment below and update the code to test SpotMarketOptions
      //var instane = new AmazonEc2.SpotMarketOptions();
      //expect(instance).to.be.a(AmazonEc2.SpotMarketOptions);
    });
