...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AssociateClientVpnTargetNetworkRequest();
  });
  ...
  describe('AssociateClientVpnTargetNetworkRequest', function() {
    it('should create an instance of AssociateClientVpnTargetNetworkRequest', function() {
      // uncomment below and update the code to test AssociateClientVpnTargetNetworkRequest
      //var instane = new AmazonEc2.AssociateClientVpnTargetNetworkRequest();
      //expect(instance).to.be.a(AmazonEc2.AssociateClientVpnTargetNetworkRequest);
    });
