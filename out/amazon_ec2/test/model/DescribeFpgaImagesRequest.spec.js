...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeFpgaImagesRequest();
  });
  ...
  describe('DescribeFpgaImagesRequest', function() {
    it('should create an instance of DescribeFpgaImagesRequest', function() {
      // uncomment below and update the code to test DescribeFpgaImagesRequest
      //var instane = new AmazonEc2.DescribeFpgaImagesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeFpgaImagesRequest);
    });
    ...
    it('should have the property fpgaImageIds (base name: "FpgaImageIds")', function() {
      // uncomment below and update the code to test the property fpgaImageIds
      //var instane = new AmazonEc2.DescribeFpgaImagesRequest();
      //expect(instance).to.be();
    });
