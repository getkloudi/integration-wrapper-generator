...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.EbsBlockDevice();
  });
  ...
  describe('EbsBlockDevice', function() {
    it('should create an instance of EbsBlockDevice', function() {
      // uncomment below and update the code to test EbsBlockDevice
      //var instane = new AmazonEc2.EbsBlockDevice();
      //expect(instance).to.be.a(AmazonEc2.EbsBlockDevice);
    });
