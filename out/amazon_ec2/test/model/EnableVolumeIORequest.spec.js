...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.EnableVolumeIORequest();
  });
  ...
  describe('EnableVolumeIORequest', function() {
    it('should create an instance of EnableVolumeIORequest', function() {
      // uncomment below and update the code to test EnableVolumeIORequest
      //var instane = new AmazonEc2.EnableVolumeIORequest();
      //expect(instance).to.be.a(AmazonEc2.EnableVolumeIORequest);
    });
