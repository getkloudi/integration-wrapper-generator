...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ReplaceRouteTableAssociationRequest();
  });
  ...
  describe('ReplaceRouteTableAssociationRequest', function() {
    it('should create an instance of ReplaceRouteTableAssociationRequest', function() {
      // uncomment below and update the code to test ReplaceRouteTableAssociationRequest
      //var instane = new AmazonEc2.ReplaceRouteTableAssociationRequest();
      //expect(instance).to.be.a(AmazonEc2.ReplaceRouteTableAssociationRequest);
    });
