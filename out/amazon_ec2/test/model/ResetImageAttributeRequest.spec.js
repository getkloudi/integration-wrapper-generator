...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ResetImageAttributeRequest();
  });
  ...
  describe('ResetImageAttributeRequest', function() {
    it('should create an instance of ResetImageAttributeRequest', function() {
      // uncomment below and update the code to test ResetImageAttributeRequest
      //var instane = new AmazonEc2.ResetImageAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.ResetImageAttributeRequest);
    });
