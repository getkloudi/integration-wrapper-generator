...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SpotPrice();
  });
  ...
  describe('SpotPrice', function() {
    it('should create an instance of SpotPrice', function() {
      // uncomment below and update the code to test SpotPrice
      //var instane = new AmazonEc2.SpotPrice();
      //expect(instance).to.be.a(AmazonEc2.SpotPrice);
    });
