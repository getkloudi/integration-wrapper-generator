...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeElasticGpusRequest();
  });
  ...
  describe('DescribeElasticGpusRequest', function() {
    it('should create an instance of DescribeElasticGpusRequest', function() {
      // uncomment below and update the code to test DescribeElasticGpusRequest
      //var instane = new AmazonEc2.DescribeElasticGpusRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeElasticGpusRequest);
    });
    ...
    it('should have the property elasticGpuIds (base name: "ElasticGpuIds")', function() {
      // uncomment below and update the code to test the property elasticGpuIds
      //var instane = new AmazonEc2.DescribeElasticGpusRequest();
      //expect(instance).to.be();
    });
