...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeTrafficMirrorSessionsRequest();
  });
  ...
  describe('DescribeTrafficMirrorSessionsRequest', function() {
    it('should create an instance of DescribeTrafficMirrorSessionsRequest', function() {
      // uncomment below and update the code to test DescribeTrafficMirrorSessionsRequest
      //var instane = new AmazonEc2.DescribeTrafficMirrorSessionsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeTrafficMirrorSessionsRequest);
    });
    ...
    it('should have the property trafficMirrorSessionIds (base name: "TrafficMirrorSessionIds")', function() {
      // uncomment below and update the code to test the property trafficMirrorSessionIds
      //var instane = new AmazonEc2.DescribeTrafficMirrorSessionsRequest();
      //expect(instance).to.be();
    });
