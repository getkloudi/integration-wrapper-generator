...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeCoipPoolsRequest();
  });
  ...
  describe('DescribeCoipPoolsRequest', function() {
    it('should create an instance of DescribeCoipPoolsRequest', function() {
      // uncomment below and update the code to test DescribeCoipPoolsRequest
      //var instane = new AmazonEc2.DescribeCoipPoolsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeCoipPoolsRequest);
    });
