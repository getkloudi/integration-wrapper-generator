...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.PurchaseReservedInstancesOfferingRequest();
  });
  ...
  describe('PurchaseReservedInstancesOfferingRequest', function() {
    it('should create an instance of PurchaseReservedInstancesOfferingRequest', function() {
      // uncomment below and update the code to test PurchaseReservedInstancesOfferingRequest
      //var instane = new AmazonEc2.PurchaseReservedInstancesOfferingRequest();
      //expect(instance).to.be.a(AmazonEc2.PurchaseReservedInstancesOfferingRequest);
    });
