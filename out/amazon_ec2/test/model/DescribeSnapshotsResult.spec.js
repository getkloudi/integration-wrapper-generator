...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeSnapshotsResult();
  });
  ...
  describe('DescribeSnapshotsResult', function() {
    it('should create an instance of DescribeSnapshotsResult', function() {
      // uncomment below and update the code to test DescribeSnapshotsResult
      //var instane = new AmazonEc2.DescribeSnapshotsResult();
      //expect(instance).to.be.a(AmazonEc2.DescribeSnapshotsResult);
    });
