...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.InstanceTypeOffering();
  });
  ...
  describe('InstanceTypeOffering', function() {
    it('should create an instance of InstanceTypeOffering', function() {
      // uncomment below and update the code to test InstanceTypeOffering
      //var instane = new AmazonEc2.InstanceTypeOffering();
      //expect(instance).to.be.a(AmazonEc2.InstanceTypeOffering);
    });
