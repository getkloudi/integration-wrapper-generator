...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeImportSnapshotTasksRequest();
  });
  ...
  describe('DescribeImportSnapshotTasksRequest', function() {
    it('should create an instance of DescribeImportSnapshotTasksRequest', function() {
      // uncomment below and update the code to test DescribeImportSnapshotTasksRequest
      //var instane = new AmazonEc2.DescribeImportSnapshotTasksRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeImportSnapshotTasksRequest);
    });
