...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.HostOffering();
  });
  ...
  describe('HostOffering', function() {
    it('should create an instance of HostOffering', function() {
      // uncomment below and update the code to test HostOffering
      //var instane = new AmazonEc2.HostOffering();
      //expect(instance).to.be.a(AmazonEc2.HostOffering);
    });
