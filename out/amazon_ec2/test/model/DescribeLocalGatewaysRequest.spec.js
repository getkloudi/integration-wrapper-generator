...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeLocalGatewaysRequest();
  });
  ...
  describe('DescribeLocalGatewaysRequest', function() {
    it('should create an instance of DescribeLocalGatewaysRequest', function() {
      // uncomment below and update the code to test DescribeLocalGatewaysRequest
      //var instane = new AmazonEc2.DescribeLocalGatewaysRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeLocalGatewaysRequest);
    });
    ...
    it('should have the property localGatewayIds (base name: "LocalGatewayIds")', function() {
      // uncomment below and update the code to test the property localGatewayIds
      //var instane = new AmazonEc2.DescribeLocalGatewaysRequest();
      //expect(instance).to.be();
    });
