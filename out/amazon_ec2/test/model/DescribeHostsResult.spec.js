...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeHostsResult();
  });
  ...
  describe('DescribeHostsResult', function() {
    it('should create an instance of DescribeHostsResult', function() {
      // uncomment below and update the code to test DescribeHostsResult
      //var instane = new AmazonEc2.DescribeHostsResult();
      //expect(instance).to.be.a(AmazonEc2.DescribeHostsResult);
    });
