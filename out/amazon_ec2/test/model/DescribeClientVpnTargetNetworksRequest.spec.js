...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeClientVpnTargetNetworksRequest();
  });
  ...
  describe('DescribeClientVpnTargetNetworksRequest', function() {
    it('should create an instance of DescribeClientVpnTargetNetworksRequest', function() {
      // uncomment below and update the code to test DescribeClientVpnTargetNetworksRequest
      //var instane = new AmazonEc2.DescribeClientVpnTargetNetworksRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeClientVpnTargetNetworksRequest);
    });
