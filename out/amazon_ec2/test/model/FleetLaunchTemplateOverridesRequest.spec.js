...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.FleetLaunchTemplateOverridesRequest();
  });
  ...
  describe('FleetLaunchTemplateOverridesRequest', function() {
    it('should create an instance of FleetLaunchTemplateOverridesRequest', function() {
      // uncomment below and update the code to test FleetLaunchTemplateOverridesRequest
      //var instane = new AmazonEc2.FleetLaunchTemplateOverridesRequest();
      //expect(instance).to.be.a(AmazonEc2.FleetLaunchTemplateOverridesRequest);
    });
