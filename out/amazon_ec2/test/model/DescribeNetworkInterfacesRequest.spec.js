...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeNetworkInterfacesRequest();
  });
  ...
  describe('DescribeNetworkInterfacesRequest', function() {
    it('should create an instance of DescribeNetworkInterfacesRequest', function() {
      // uncomment below and update the code to test DescribeNetworkInterfacesRequest
      //var instane = new AmazonEc2.DescribeNetworkInterfacesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeNetworkInterfacesRequest);
    });
