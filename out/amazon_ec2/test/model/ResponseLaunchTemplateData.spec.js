...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ResponseLaunchTemplateData();
  });
  ...
  describe('ResponseLaunchTemplateData', function() {
    it('should create an instance of ResponseLaunchTemplateData', function() {
      // uncomment below and update the code to test ResponseLaunchTemplateData
      //var instane = new AmazonEc2.ResponseLaunchTemplateData();
      //expect(instance).to.be.a(AmazonEc2.ResponseLaunchTemplateData);
    });
    ...
    it('should have the property elasticGpuSpecifications (base name: "ElasticGpuSpecifications")', function() {
      // uncomment below and update the code to test the property elasticGpuSpecifications
      //var instane = new AmazonEc2.ResponseLaunchTemplateData();
      //expect(instance).to.be();
    });
