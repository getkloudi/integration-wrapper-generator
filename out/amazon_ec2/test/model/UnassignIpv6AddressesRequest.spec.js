...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.UnassignIpv6AddressesRequest();
  });
  ...
  describe('UnassignIpv6AddressesRequest', function() {
    it('should create an instance of UnassignIpv6AddressesRequest', function() {
      // uncomment below and update the code to test UnassignIpv6AddressesRequest
      //var instane = new AmazonEc2.UnassignIpv6AddressesRequest();
      //expect(instance).to.be.a(AmazonEc2.UnassignIpv6AddressesRequest);
    });
