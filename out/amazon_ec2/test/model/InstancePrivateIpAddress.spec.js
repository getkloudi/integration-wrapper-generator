...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.InstancePrivateIpAddress();
  });
  ...
  describe('InstancePrivateIpAddress', function() {
    it('should create an instance of InstancePrivateIpAddress', function() {
      // uncomment below and update the code to test InstancePrivateIpAddress
      //var instane = new AmazonEc2.InstancePrivateIpAddress();
      //expect(instance).to.be.a(AmazonEc2.InstancePrivateIpAddress);
    });
