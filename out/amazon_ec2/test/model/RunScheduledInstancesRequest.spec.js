...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.RunScheduledInstancesRequest();
  });
  ...
  describe('RunScheduledInstancesRequest', function() {
    it('should create an instance of RunScheduledInstancesRequest', function() {
      // uncomment below and update the code to test RunScheduledInstancesRequest
      //var instane = new AmazonEc2.RunScheduledInstancesRequest();
      //expect(instance).to.be.a(AmazonEc2.RunScheduledInstancesRequest);
    });
