...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DetachClassicLinkVpcRequest();
  });
  ...
  describe('DetachClassicLinkVpcRequest', function() {
    it('should create an instance of DetachClassicLinkVpcRequest', function() {
      // uncomment below and update the code to test DetachClassicLinkVpcRequest
      //var instane = new AmazonEc2.DetachClassicLinkVpcRequest();
      //expect(instance).to.be.a(AmazonEc2.DetachClassicLinkVpcRequest);
    });
