...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CancelImportTaskResult();
  });
  ...
  describe('CancelImportTaskResult', function() {
    it('should create an instance of CancelImportTaskResult', function() {
      // uncomment below and update the code to test CancelImportTaskResult
      //var instane = new AmazonEc2.CancelImportTaskResult();
      //expect(instance).to.be.a(AmazonEc2.CancelImportTaskResult);
    });
