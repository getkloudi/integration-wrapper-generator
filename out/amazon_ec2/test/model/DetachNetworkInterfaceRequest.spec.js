...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DetachNetworkInterfaceRequest();
  });
  ...
  describe('DetachNetworkInterfaceRequest', function() {
    it('should create an instance of DetachNetworkInterfaceRequest', function() {
      // uncomment below and update the code to test DetachNetworkInterfaceRequest
      //var instane = new AmazonEc2.DetachNetworkInterfaceRequest();
      //expect(instance).to.be.a(AmazonEc2.DetachNetworkInterfaceRequest);
    });
