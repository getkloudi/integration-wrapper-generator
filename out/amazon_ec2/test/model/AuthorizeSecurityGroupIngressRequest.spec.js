...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AuthorizeSecurityGroupIngressRequest();
  });
  ...
  describe('AuthorizeSecurityGroupIngressRequest', function() {
    it('should create an instance of AuthorizeSecurityGroupIngressRequest', function() {
      // uncomment below and update the code to test AuthorizeSecurityGroupIngressRequest
      //var instane = new AmazonEc2.AuthorizeSecurityGroupIngressRequest();
      //expect(instance).to.be.a(AmazonEc2.AuthorizeSecurityGroupIngressRequest);
    });
