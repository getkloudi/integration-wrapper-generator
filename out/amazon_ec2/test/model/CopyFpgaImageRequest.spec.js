...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CopyFpgaImageRequest();
  });
  ...
  describe('CopyFpgaImageRequest', function() {
    it('should create an instance of CopyFpgaImageRequest', function() {
      // uncomment below and update the code to test CopyFpgaImageRequest
      //var instane = new AmazonEc2.CopyFpgaImageRequest();
      //expect(instance).to.be.a(AmazonEc2.CopyFpgaImageRequest);
    });
    ...
    it('should have the property sourceFpgaImageId (base name: "SourceFpgaImageId")', function() {
      // uncomment below and update the code to test the property sourceFpgaImageId
      //var instane = new AmazonEc2.CopyFpgaImageRequest();
      //expect(instance).to.be();
    });
