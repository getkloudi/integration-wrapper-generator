...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeFpgaImageAttributeRequest();
  });
  ...
  describe('DescribeFpgaImageAttributeRequest', function() {
    it('should create an instance of DescribeFpgaImageAttributeRequest', function() {
      // uncomment below and update the code to test DescribeFpgaImageAttributeRequest
      //var instane = new AmazonEc2.DescribeFpgaImageAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeFpgaImageAttributeRequest);
    });
