...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AttachVolumeRequest();
  });
  ...
  describe('AttachVolumeRequest', function() {
    it('should create an instance of AttachVolumeRequest', function() {
      // uncomment below and update the code to test AttachVolumeRequest
      //var instane = new AmazonEc2.AttachVolumeRequest();
      //expect(instance).to.be.a(AmazonEc2.AttachVolumeRequest);
    });
