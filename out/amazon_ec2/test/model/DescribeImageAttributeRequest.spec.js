...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeImageAttributeRequest();
  });
  ...
  describe('DescribeImageAttributeRequest', function() {
    it('should create an instance of DescribeImageAttributeRequest', function() {
      // uncomment below and update the code to test DescribeImageAttributeRequest
      //var instane = new AmazonEc2.DescribeImageAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeImageAttributeRequest);
    });
