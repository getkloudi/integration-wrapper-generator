...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeClassicLinkInstancesRequest();
  });
  ...
  describe('DescribeClassicLinkInstancesRequest', function() {
    it('should create an instance of DescribeClassicLinkInstancesRequest', function() {
      // uncomment below and update the code to test DescribeClassicLinkInstancesRequest
      //var instane = new AmazonEc2.DescribeClassicLinkInstancesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeClassicLinkInstancesRequest);
    });
