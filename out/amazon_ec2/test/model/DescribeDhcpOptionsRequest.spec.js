...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeDhcpOptionsRequest();
  });
  ...
  describe('DescribeDhcpOptionsRequest', function() {
    it('should create an instance of DescribeDhcpOptionsRequest', function() {
      // uncomment below and update the code to test DescribeDhcpOptionsRequest
      //var instane = new AmazonEc2.DescribeDhcpOptionsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeDhcpOptionsRequest);
    });

    it('should have the property dhcpOptionsIds (base name: "DhcpOptionsIds")', function() {
      // uncomment below and update the code to test the property dhcpOptionsIds
      //var instane = new AmazonEc2.DescribeDhcpOptionsRequest();
