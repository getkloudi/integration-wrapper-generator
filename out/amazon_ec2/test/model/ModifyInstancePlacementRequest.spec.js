...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifyInstancePlacementRequest();
  });
  ...
  describe('ModifyInstancePlacementRequest', function() {
    it('should create an instance of ModifyInstancePlacementRequest', function() {
      // uncomment below and update the code to test ModifyInstancePlacementRequest
      //var instane = new AmazonEc2.ModifyInstancePlacementRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifyInstancePlacementRequest);
    });
