...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateFleetResult();
  });
  ...
  describe('CreateFleetResult', function() {
    it('should create an instance of CreateFleetResult', function() {
      // uncomment below and update the code to test CreateFleetResult
      //var instane = new AmazonEc2.CreateFleetResult();
      //expect(instance).to.be.a(AmazonEc2.CreateFleetResult);
    });
