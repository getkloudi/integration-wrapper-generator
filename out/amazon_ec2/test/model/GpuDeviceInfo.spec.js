...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.GpuDeviceInfo();
  });
  ...
  describe('GpuDeviceInfo', function() {
    it('should create an instance of GpuDeviceInfo', function() {
      // uncomment below and update the code to test GpuDeviceInfo
      //var instane = new AmazonEc2.GpuDeviceInfo();
      //expect(instance).to.be.a(AmazonEc2.GpuDeviceInfo);
    });
