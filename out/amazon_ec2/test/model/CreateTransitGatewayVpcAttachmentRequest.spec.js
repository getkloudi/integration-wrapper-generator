...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateTransitGatewayVpcAttachmentRequest();
  });
  ...
  describe('CreateTransitGatewayVpcAttachmentRequest', function() {
    it('should create an instance of CreateTransitGatewayVpcAttachmentRequest', function() {
      // uncomment below and update the code to test CreateTransitGatewayVpcAttachmentRequest
      //var instane = new AmazonEc2.CreateTransitGatewayVpcAttachmentRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateTransitGatewayVpcAttachmentRequest);
    });
