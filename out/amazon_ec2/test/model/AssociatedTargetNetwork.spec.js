...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AssociatedTargetNetwork();
  });
  ...
  describe('AssociatedTargetNetwork', function() {
    it('should create an instance of AssociatedTargetNetwork', function() {
      // uncomment below and update the code to test AssociatedTargetNetwork
      //var instane = new AmazonEc2.AssociatedTargetNetwork();
      //expect(instance).to.be.a(AmazonEc2.AssociatedTargetNetwork);
    });
