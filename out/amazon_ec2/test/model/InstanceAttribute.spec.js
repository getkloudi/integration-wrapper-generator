...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.InstanceAttribute();
  });
  ...
  describe('InstanceAttribute', function() {
    it('should create an instance of InstanceAttribute', function() {
      // uncomment below and update the code to test InstanceAttribute
      //var instane = new AmazonEc2.InstanceAttribute();
      //expect(instance).to.be.a(AmazonEc2.InstanceAttribute);
    });
