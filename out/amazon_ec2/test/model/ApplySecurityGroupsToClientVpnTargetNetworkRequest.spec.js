...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ApplySecurityGroupsToClientVpnTargetNetworkRequest();
  });
  ...
  describe('ApplySecurityGroupsToClientVpnTargetNetworkRequest', function() {
    it('should create an instance of ApplySecurityGroupsToClientVpnTargetNetworkRequest', function() {
      // uncomment below and update the code to test ApplySecurityGroupsToClientVpnTargetNetworkRequest
      //var instane = new AmazonEc2.ApplySecurityGroupsToClientVpnTargetNetworkRequest();
      //expect(instance).to.be.a(AmazonEc2.ApplySecurityGroupsToClientVpnTargetNetworkRequest);
    });
