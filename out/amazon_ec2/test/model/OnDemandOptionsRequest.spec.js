...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.OnDemandOptionsRequest();
  });
  ...
  describe('OnDemandOptionsRequest', function() {
    it('should create an instance of OnDemandOptionsRequest', function() {
      // uncomment below and update the code to test OnDemandOptionsRequest
      //var instane = new AmazonEc2.OnDemandOptionsRequest();
      //expect(instance).to.be.a(AmazonEc2.OnDemandOptionsRequest);
    });
