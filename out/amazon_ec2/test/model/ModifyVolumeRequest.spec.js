...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifyVolumeRequest();
  });
  ...
  describe('ModifyVolumeRequest', function() {
    it('should create an instance of ModifyVolumeRequest', function() {
      // uncomment below and update the code to test ModifyVolumeRequest
      //var instane = new AmazonEc2.ModifyVolumeRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifyVolumeRequest);
    });
