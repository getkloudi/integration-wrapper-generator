...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeClientVpnRoutesRequest();
  });
  ...
  describe('DescribeClientVpnRoutesRequest', function() {
    it('should create an instance of DescribeClientVpnRoutesRequest', function() {
      // uncomment below and update the code to test DescribeClientVpnRoutesRequest
      //var instane = new AmazonEc2.DescribeClientVpnRoutesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeClientVpnRoutesRequest);
    });
