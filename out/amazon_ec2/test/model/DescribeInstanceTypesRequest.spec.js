...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeInstanceTypesRequest();
  });
  ...
  describe('DescribeInstanceTypesRequest', function() {
    it('should create an instance of DescribeInstanceTypesRequest', function() {
      // uncomment below and update the code to test DescribeInstanceTypesRequest
      //var instane = new AmazonEc2.DescribeInstanceTypesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeInstanceTypesRequest);
    });
