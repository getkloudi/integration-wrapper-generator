...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVpcEndpointServiceConfigurationsRequest();
  });
  ...
  describe('DescribeVpcEndpointServiceConfigurationsRequest', function() {
    it('should create an instance of DescribeVpcEndpointServiceConfigurationsRequest', function() {
      // uncomment below and update the code to test DescribeVpcEndpointServiceConfigurationsRequest
      //var instane = new AmazonEc2.DescribeVpcEndpointServiceConfigurationsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVpcEndpointServiceConfigurationsRequest);
    });
