...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeMovingAddressesRequest();
  });
  ...
  describe('DescribeMovingAddressesRequest', function() {
    it('should create an instance of DescribeMovingAddressesRequest', function() {
      // uncomment below and update the code to test DescribeMovingAddressesRequest
      //var instane = new AmazonEc2.DescribeMovingAddressesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeMovingAddressesRequest);
    });
