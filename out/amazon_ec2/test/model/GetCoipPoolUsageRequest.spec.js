...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.GetCoipPoolUsageRequest();
  });
  ...
  describe('GetCoipPoolUsageRequest', function() {
    it('should create an instance of GetCoipPoolUsageRequest', function() {
      // uncomment below and update the code to test GetCoipPoolUsageRequest
      //var instane = new AmazonEc2.GetCoipPoolUsageRequest();
      //expect(instance).to.be.a(AmazonEc2.GetCoipPoolUsageRequest);
    });
