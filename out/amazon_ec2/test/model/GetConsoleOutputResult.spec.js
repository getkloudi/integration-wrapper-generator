...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.GetConsoleOutputResult();
  });
  ...
  describe('GetConsoleOutputResult', function() {
    it('should create an instance of GetConsoleOutputResult', function() {
      // uncomment below and update the code to test GetConsoleOutputResult
      //var instane = new AmazonEc2.GetConsoleOutputResult();
      //expect(instance).to.be.a(AmazonEc2.GetConsoleOutputResult);
    });
