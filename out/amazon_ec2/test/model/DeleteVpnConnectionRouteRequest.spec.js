...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DeleteVpnConnectionRouteRequest();
  });
  ...
  describe('DeleteVpnConnectionRouteRequest', function() {
    it('should create an instance of DeleteVpnConnectionRouteRequest', function() {
      // uncomment below and update the code to test DeleteVpnConnectionRouteRequest
      //var instane = new AmazonEc2.DeleteVpnConnectionRouteRequest();
      //expect(instance).to.be.a(AmazonEc2.DeleteVpnConnectionRouteRequest);
    });
