...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeClientVpnAuthorizationRulesRequest();
  });
  ...
  describe('DescribeClientVpnAuthorizationRulesRequest', function() {
    it('should create an instance of DescribeClientVpnAuthorizationRulesRequest', function() {
      // uncomment below and update the code to test DescribeClientVpnAuthorizationRulesRequest
      //var instane = new AmazonEc2.DescribeClientVpnAuthorizationRulesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeClientVpnAuthorizationRulesRequest);
    });
