...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVolumesModificationsRequest();
  });
  ...
  describe('DescribeVolumesModificationsRequest', function() {
    it('should create an instance of DescribeVolumesModificationsRequest', function() {
      // uncomment below and update the code to test DescribeVolumesModificationsRequest
      //var instane = new AmazonEc2.DescribeVolumesModificationsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVolumesModificationsRequest);
    });
