...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeReservedInstancesListingsRequest();
  });
  ...
  describe('DescribeReservedInstancesListingsRequest', function() {
    it('should create an instance of DescribeReservedInstancesListingsRequest', function() {
      // uncomment below and update the code to test DescribeReservedInstancesListingsRequest
      //var instane = new AmazonEc2.DescribeReservedInstancesListingsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeReservedInstancesListingsRequest);
    });
