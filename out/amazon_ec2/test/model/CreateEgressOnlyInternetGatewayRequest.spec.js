...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateEgressOnlyInternetGatewayRequest();
  });
  ...
  describe('CreateEgressOnlyInternetGatewayRequest', function() {
    it('should create an instance of CreateEgressOnlyInternetGatewayRequest', function() {
      // uncomment below and update the code to test CreateEgressOnlyInternetGatewayRequest
      //var instane = new AmazonEc2.CreateEgressOnlyInternetGatewayRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateEgressOnlyInternetGatewayRequest);
    });
