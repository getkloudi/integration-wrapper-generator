...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeNetworkInterfaceAttributeResult();
  });
  ...
  describe('DescribeNetworkInterfaceAttributeResult', function() {
    it('should create an instance of DescribeNetworkInterfaceAttributeResult', function() {
      // uncomment below and update the code to test DescribeNetworkInterfaceAttributeResult
      //var instane = new AmazonEc2.DescribeNetworkInterfaceAttributeResult();
      //expect(instance).to.be.a(AmazonEc2.DescribeNetworkInterfaceAttributeResult);
    });
