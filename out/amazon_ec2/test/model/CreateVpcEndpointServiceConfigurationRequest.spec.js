...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateVpcEndpointServiceConfigurationRequest();
  });
  ...
  describe('CreateVpcEndpointServiceConfigurationRequest', function() {
    it('should create an instance of CreateVpcEndpointServiceConfigurationRequest', function() {
      // uncomment below and update the code to test CreateVpcEndpointServiceConfigurationRequest
      //var instane = new AmazonEc2.CreateVpcEndpointServiceConfigurationRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateVpcEndpointServiceConfigurationRequest);
    });
