...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DisassociateClientVpnTargetNetworkRequest();
  });
  ...
  describe('DisassociateClientVpnTargetNetworkRequest', function() {
    it('should create an instance of DisassociateClientVpnTargetNetworkRequest', function() {
      // uncomment below and update the code to test DisassociateClientVpnTargetNetworkRequest
      //var instane = new AmazonEc2.DisassociateClientVpnTargetNetworkRequest();
      //expect(instance).to.be.a(AmazonEc2.DisassociateClientVpnTargetNetworkRequest);
    });
