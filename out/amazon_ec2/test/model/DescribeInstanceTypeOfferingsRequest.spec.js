...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeInstanceTypeOfferingsRequest();
  });
  ...
  describe('DescribeInstanceTypeOfferingsRequest', function() {
    it('should create an instance of DescribeInstanceTypeOfferingsRequest', function() {
      // uncomment below and update the code to test DescribeInstanceTypeOfferingsRequest
      //var instane = new AmazonEc2.DescribeInstanceTypeOfferingsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeInstanceTypeOfferingsRequest);
    });
