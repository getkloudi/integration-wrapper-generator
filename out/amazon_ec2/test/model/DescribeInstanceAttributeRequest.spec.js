...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeInstanceAttributeRequest();
  });
  ...
  describe('DescribeInstanceAttributeRequest', function() {
    it('should create an instance of DescribeInstanceAttributeRequest', function() {
      // uncomment below and update the code to test DescribeInstanceAttributeRequest
      //var instane = new AmazonEc2.DescribeInstanceAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeInstanceAttributeRequest);
    });
