...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DisassociateAddressRequest();
  });
  ...
  describe('DisassociateAddressRequest', function() {
    it('should create an instance of DisassociateAddressRequest', function() {
      // uncomment below and update the code to test DisassociateAddressRequest
      //var instane = new AmazonEc2.DisassociateAddressRequest();
      //expect(instance).to.be.a(AmazonEc2.DisassociateAddressRequest);
    });
