...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.LaunchTemplateBlockDeviceMapping();
  });
  ...
  describe('LaunchTemplateBlockDeviceMapping', function() {
    it('should create an instance of LaunchTemplateBlockDeviceMapping', function() {
      // uncomment below and update the code to test LaunchTemplateBlockDeviceMapping
      //var instane = new AmazonEc2.LaunchTemplateBlockDeviceMapping();
      //expect(instance).to.be.a(AmazonEc2.LaunchTemplateBlockDeviceMapping);
    });
