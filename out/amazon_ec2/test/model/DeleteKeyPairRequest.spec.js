...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DeleteKeyPairRequest();
  });
  ...
  describe('DeleteKeyPairRequest', function() {
    it('should create an instance of DeleteKeyPairRequest', function() {
      // uncomment below and update the code to test DeleteKeyPairRequest
      //var instane = new AmazonEc2.DeleteKeyPairRequest();
      //expect(instance).to.be.a(AmazonEc2.DeleteKeyPairRequest);
    });
