...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.LaunchTemplatePlacement();
  });
  ...
  describe('LaunchTemplatePlacement', function() {
    it('should create an instance of LaunchTemplatePlacement', function() {
      // uncomment below and update the code to test LaunchTemplatePlacement
      //var instane = new AmazonEc2.LaunchTemplatePlacement();
      //expect(instance).to.be.a(AmazonEc2.LaunchTemplatePlacement);
    });
