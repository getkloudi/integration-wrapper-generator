...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateTransitGatewayMulticastDomainRequest();
  });
  ...
  describe('CreateTransitGatewayMulticastDomainRequest', function() {
    it('should create an instance of CreateTransitGatewayMulticastDomainRequest', function() {
      // uncomment below and update the code to test CreateTransitGatewayMulticastDomainRequest
      //var instane = new AmazonEc2.CreateTransitGatewayMulticastDomainRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateTransitGatewayMulticastDomainRequest);
    });
