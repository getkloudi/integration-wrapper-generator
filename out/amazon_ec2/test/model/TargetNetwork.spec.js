...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.TargetNetwork();
  });
  ...
  describe('TargetNetwork', function() {
    it('should create an instance of TargetNetwork', function() {
      // uncomment below and update the code to test TargetNetwork
      //var instane = new AmazonEc2.TargetNetwork();
      //expect(instance).to.be.a(AmazonEc2.TargetNetwork);
    });
