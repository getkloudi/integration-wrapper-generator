...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeFleetHistoryRequest();
  });
  ...
  describe('DescribeFleetHistoryRequest', function() {
    it('should create an instance of DescribeFleetHistoryRequest', function() {
      // uncomment below and update the code to test DescribeFleetHistoryRequest
      //var instane = new AmazonEc2.DescribeFleetHistoryRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeFleetHistoryRequest);
    });
