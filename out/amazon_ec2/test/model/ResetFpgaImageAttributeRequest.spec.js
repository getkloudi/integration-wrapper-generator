...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ResetFpgaImageAttributeRequest();
  });
  ...
  describe('ResetFpgaImageAttributeRequest', function() {
    it('should create an instance of ResetFpgaImageAttributeRequest', function() {
      // uncomment below and update the code to test ResetFpgaImageAttributeRequest
      //var instane = new AmazonEc2.ResetFpgaImageAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.ResetFpgaImageAttributeRequest);
    });
