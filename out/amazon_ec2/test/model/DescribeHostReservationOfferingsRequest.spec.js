...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeHostReservationOfferingsRequest();
  });
  ...
  describe('DescribeHostReservationOfferingsRequest', function() {
    it('should create an instance of DescribeHostReservationOfferingsRequest', function() {
      // uncomment below and update the code to test DescribeHostReservationOfferingsRequest
      //var instane = new AmazonEc2.DescribeHostReservationOfferingsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeHostReservationOfferingsRequest);
    });
