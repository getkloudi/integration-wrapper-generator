...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVolumesResult();
  });
  ...
  describe('DescribeVolumesResult', function() {
    it('should create an instance of DescribeVolumesResult', function() {
      // uncomment below and update the code to test DescribeVolumesResult
      //var instane = new AmazonEc2.DescribeVolumesResult();
      //expect(instance).to.be.a(AmazonEc2.DescribeVolumesResult);
    });
