...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ImportInstanceTaskDetails();
  });
  ...
  describe('ImportInstanceTaskDetails', function() {
    it('should create an instance of ImportInstanceTaskDetails', function() {
      // uncomment below and update the code to test ImportInstanceTaskDetails
      //var instane = new AmazonEc2.ImportInstanceTaskDetails();
      //expect(instance).to.be.a(AmazonEc2.ImportInstanceTaskDetails);
    });
