...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.NetworkInterfacePrivateIpAddress();
  });
  ...
  describe('NetworkInterfacePrivateIpAddress', function() {
    it('should create an instance of NetworkInterfacePrivateIpAddress', function() {
      // uncomment below and update the code to test NetworkInterfacePrivateIpAddress
      //var instane = new AmazonEc2.NetworkInterfacePrivateIpAddress();
      //expect(instance).to.be.a(AmazonEc2.NetworkInterfacePrivateIpAddress);
    });
