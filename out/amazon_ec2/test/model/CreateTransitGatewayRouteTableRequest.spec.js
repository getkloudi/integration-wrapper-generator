...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateTransitGatewayRouteTableRequest();
  });
  ...
  describe('CreateTransitGatewayRouteTableRequest', function() {
    it('should create an instance of CreateTransitGatewayRouteTableRequest', function() {
      // uncomment below and update the code to test CreateTransitGatewayRouteTableRequest
      //var instane = new AmazonEc2.CreateTransitGatewayRouteTableRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateTransitGatewayRouteTableRequest);
    });
