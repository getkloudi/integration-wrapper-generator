...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateTrafficMirrorSessionRequest();
  });
  ...
  describe('CreateTrafficMirrorSessionRequest', function() {
    it('should create an instance of CreateTrafficMirrorSessionRequest', function() {
      // uncomment below and update the code to test CreateTrafficMirrorSessionRequest
      //var instane = new AmazonEc2.CreateTrafficMirrorSessionRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateTrafficMirrorSessionRequest);
    });
