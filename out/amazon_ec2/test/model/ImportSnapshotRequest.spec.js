...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ImportSnapshotRequest();
  });
  ...
  describe('ImportSnapshotRequest', function() {
    it('should create an instance of ImportSnapshotRequest', function() {
      // uncomment below and update the code to test ImportSnapshotRequest
      //var instane = new AmazonEc2.ImportSnapshotRequest();
      //expect(instance).to.be.a(AmazonEc2.ImportSnapshotRequest);
    });
    ...
    it('should have the property diskContainer (base name: "DiskContainer")', function() {
      // uncomment below and update the code to test the property diskContainer
      //var instane = new AmazonEc2.ImportSnapshotRequest();
      //expect(instance).to.be();
    });
