...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CopyImageRequest();
  });
  ...
  describe('CopyImageRequest', function() {
    it('should create an instance of CopyImageRequest', function() {
      // uncomment below and update the code to test CopyImageRequest
      //var instane = new AmazonEc2.CopyImageRequest();
      //expect(instance).to.be.a(AmazonEc2.CopyImageRequest);
    });
