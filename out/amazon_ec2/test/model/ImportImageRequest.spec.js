...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ImportImageRequest();
  });
  ...
  describe('ImportImageRequest', function() {
    it('should create an instance of ImportImageRequest', function() {
      // uncomment below and update the code to test ImportImageRequest
      //var instane = new AmazonEc2.ImportImageRequest();
      //expect(instance).to.be.a(AmazonEc2.ImportImageRequest);
    });
    ...
    it('should have the property diskContainers (base name: "DiskContainers")', function() {
      // uncomment below and update the code to test the property diskContainers
      //var instane = new AmazonEc2.ImportImageRequest();
      //expect(instance).to.be();
    });
