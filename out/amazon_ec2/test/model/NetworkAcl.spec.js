...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.NetworkAcl();
  });
  ...
  describe('NetworkAcl', function() {
    it('should create an instance of NetworkAcl', function() {
      // uncomment below and update the code to test NetworkAcl
      //var instane = new AmazonEc2.NetworkAcl();
      //expect(instance).to.be.a(AmazonEc2.NetworkAcl);
    });
