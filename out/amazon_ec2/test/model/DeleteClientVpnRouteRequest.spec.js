...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DeleteClientVpnRouteRequest();
  });
  ...
  describe('DeleteClientVpnRouteRequest', function() {
    it('should create an instance of DeleteClientVpnRouteRequest', function() {
      // uncomment below and update the code to test DeleteClientVpnRouteRequest
      //var instane = new AmazonEc2.DeleteClientVpnRouteRequest();
      //expect(instance).to.be.a(AmazonEc2.DeleteClientVpnRouteRequest);
    });
