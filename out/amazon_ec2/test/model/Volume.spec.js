...
(function(root, factory) {
  ...
  describe('Volume', function() {
    it('should create an instance of Volume', function() {
      ...
      //var instane = new AmazonEc2.Volume();
      //expect(instance).to.be.a(AmazonEc2.Volume);
    });
    ...
    it('should have the property fastRestored (base name: "FastRestored")', function() {
      // uncomment below and update the code to test the property fastRestored
      //var instane = new AmazonEc2.Volume();
      //expect(instance).to.be();
    });
