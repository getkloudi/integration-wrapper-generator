...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ReportInstanceStatusRequest();
  });
  ...
  describe('ReportInstanceStatusRequest', function() {
    it('should create an instance of ReportInstanceStatusRequest', function() {
      // uncomment below and update the code to test ReportInstanceStatusRequest
      //var instane = new AmazonEc2.ReportInstanceStatusRequest();
      //expect(instance).to.be.a(AmazonEc2.ReportInstanceStatusRequest);
    });
