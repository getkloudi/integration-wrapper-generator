...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifySpotFleetRequestRequest();
  });
  ...
  describe('ModifySpotFleetRequestRequest', function() {
    it('should create an instance of ModifySpotFleetRequestRequest', function() {
      // uncomment below and update the code to test ModifySpotFleetRequestRequest
      //var instane = new AmazonEc2.ModifySpotFleetRequestRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifySpotFleetRequestRequest);
    });
