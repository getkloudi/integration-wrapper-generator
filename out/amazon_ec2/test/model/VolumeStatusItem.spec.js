...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.VolumeStatusItem();
  });
  ...
  describe('VolumeStatusItem', function() {
    it('should create an instance of VolumeStatusItem', function() {
      // uncomment below and update the code to test VolumeStatusItem
      //var instane = new AmazonEc2.VolumeStatusItem();
      //expect(instance).to.be.a(AmazonEc2.VolumeStatusItem);
    });
