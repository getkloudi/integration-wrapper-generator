...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVpcsRequest();
  });
  ...
  describe('DescribeVpcsRequest', function() {
    it('should create an instance of DescribeVpcsRequest', function() {
      // uncomment below and update the code to test DescribeVpcsRequest
      //var instane = new AmazonEc2.DescribeVpcsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVpcsRequest);
    });
