...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AllocateAddressResult();
  });
  ...
  describe('AllocateAddressResult', function() {
    it('should create an instance of AllocateAddressResult', function() {
      // uncomment below and update the code to test AllocateAddressResult
      //var instane = new AmazonEc2.AllocateAddressResult();
      //expect(instance).to.be.a(AmazonEc2.AllocateAddressResult);
    });
