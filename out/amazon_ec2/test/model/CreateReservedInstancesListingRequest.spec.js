...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateReservedInstancesListingRequest();
  });
  ...
  describe('CreateReservedInstancesListingRequest', function() {
    it('should create an instance of CreateReservedInstancesListingRequest', function() {
      // uncomment below and update the code to test CreateReservedInstancesListingRequest
      //var instane = new AmazonEc2.CreateReservedInstancesListingRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateReservedInstancesListingRequest);
    });
