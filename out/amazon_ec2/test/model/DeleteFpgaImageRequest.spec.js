...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DeleteFpgaImageRequest();
  });
  ...
  describe('DeleteFpgaImageRequest', function() {
    it('should create an instance of DeleteFpgaImageRequest', function() {
      // uncomment below and update the code to test DeleteFpgaImageRequest
      //var instane = new AmazonEc2.DeleteFpgaImageRequest();
      //expect(instance).to.be.a(AmazonEc2.DeleteFpgaImageRequest);
    });
