...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeReservedInstancesRequest();
  });
  ...
  describe('DescribeReservedInstancesRequest', function() {
    it('should create an instance of DescribeReservedInstancesRequest', function() {
      // uncomment below and update the code to test DescribeReservedInstancesRequest
      //var instane = new AmazonEc2.DescribeReservedInstancesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeReservedInstancesRequest);
    });
