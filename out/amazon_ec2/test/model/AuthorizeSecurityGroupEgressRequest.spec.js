...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AuthorizeSecurityGroupEgressRequest();
  });
  ...
  describe('AuthorizeSecurityGroupEgressRequest', function() {
    it('should create an instance of AuthorizeSecurityGroupEgressRequest', function() {
      // uncomment below and update the code to test AuthorizeSecurityGroupEgressRequest
      //var instane = new AmazonEc2.AuthorizeSecurityGroupEgressRequest();
      //expect(instance).to.be.a(AmazonEc2.AuthorizeSecurityGroupEgressRequest);
    });
