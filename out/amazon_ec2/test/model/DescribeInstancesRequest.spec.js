...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeInstancesRequest();
  });
  ...
  describe('DescribeInstancesRequest', function() {
    it('should create an instance of DescribeInstancesRequest', function() {
      // uncomment below and update the code to test DescribeInstancesRequest
      //var instane = new AmazonEc2.DescribeInstancesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeInstancesRequest);
    });
