...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.LaunchTemplateEbsBlockDevice();
  });
  ...
  describe('LaunchTemplateEbsBlockDevice', function() {
    it('should create an instance of LaunchTemplateEbsBlockDevice', function() {
      // uncomment below and update the code to test LaunchTemplateEbsBlockDevice
      //var instane = new AmazonEc2.LaunchTemplateEbsBlockDevice();
      //expect(instance).to.be.a(AmazonEc2.LaunchTemplateEbsBlockDevice);
    });
