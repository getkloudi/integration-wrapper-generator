...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateTrafficMirrorTargetRequest();
  });
  ...
  describe('CreateTrafficMirrorTargetRequest', function() {
    it('should create an instance of CreateTrafficMirrorTargetRequest', function() {
      // uncomment below and update the code to test CreateTrafficMirrorTargetRequest
      //var instane = new AmazonEc2.CreateTrafficMirrorTargetRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateTrafficMirrorTargetRequest);
    });
    ...
    it('should have the property networkLoadBalancerArn (base name: "NetworkLoadBalancerArn")', function() {
      // uncomment below and update the code to test the property networkLoadBalancerArn
      //var instane = new AmazonEc2.CreateTrafficMirrorTargetRequest();
      //expect(instance).to.be();
    });
