...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.IamInstanceProfileAssociation();
  });
  ...
  describe('IamInstanceProfileAssociation', function() {
    it('should create an instance of IamInstanceProfileAssociation', function() {
      // uncomment below and update the code to test IamInstanceProfileAssociation
      //var instane = new AmazonEc2.IamInstanceProfileAssociation();
      //expect(instance).to.be.a(AmazonEc2.IamInstanceProfileAssociation);
    });
