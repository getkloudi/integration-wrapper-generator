...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.TunnelOption();
  });
  ...
  describe('TunnelOption', function() {
    it('should create an instance of TunnelOption', function() {
      // uncomment below and update the code to test TunnelOption
      //var instane = new AmazonEc2.TunnelOption();
      //expect(instance).to.be.a(AmazonEc2.TunnelOption);
    });
