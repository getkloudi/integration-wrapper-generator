...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DeleteRouteTableRequest();
  });
  ...
  describe('DeleteRouteTableRequest', function() {
    it('should create an instance of DeleteRouteTableRequest', function() {
      // uncomment below and update the code to test DeleteRouteTableRequest
      //var instane = new AmazonEc2.DeleteRouteTableRequest();
      //expect(instance).to.be.a(AmazonEc2.DeleteRouteTableRequest);
    });
