...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ImportInstanceRequest();
  });
  ...
  describe('ImportInstanceRequest', function() {
    it('should create an instance of ImportInstanceRequest', function() {
      ...
      //var instane = new AmazonEc2.ImportInstanceRequest();
      //expect(instance).to.be.a(AmazonEc2.ImportInstanceRequest);
    });
    ...
    it('should have the property diskImages (base name: "DiskImages")', function() {
      // uncomment below and update the code to test the property diskImages
      //var instane = new AmazonEc2.ImportInstanceRequest();
      //expect(instance).to.be();
    });
