...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribePlacementGroupsRequest();
  });
  ...
  describe('DescribePlacementGroupsRequest', function() {
    it('should create an instance of DescribePlacementGroupsRequest', function() {
      // uncomment below and update the code to test DescribePlacementGroupsRequest
      //var instane = new AmazonEc2.DescribePlacementGroupsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribePlacementGroupsRequest);
    });
