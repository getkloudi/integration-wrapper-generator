...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeSpotFleetRequestHistoryRequest();
  });
  ...
  describe('DescribeSpotFleetRequestHistoryRequest', function() {
    it('should create an instance of DescribeSpotFleetRequestHistoryRequest', function() {
      // uncomment below and update the code to test DescribeSpotFleetRequestHistoryRequest
      //var instane = new AmazonEc2.DescribeSpotFleetRequestHistoryRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeSpotFleetRequestHistoryRequest);
    });
