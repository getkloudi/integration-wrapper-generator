...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.NatGatewayAddress();
  });
  ...
  describe('NatGatewayAddress', function() {
    it('should create an instance of NatGatewayAddress', function() {
      // uncomment below and update the code to test NatGatewayAddress
      //var instane = new AmazonEc2.NatGatewayAddress();
      //expect(instance).to.be.a(AmazonEc2.NatGatewayAddress);
    });
