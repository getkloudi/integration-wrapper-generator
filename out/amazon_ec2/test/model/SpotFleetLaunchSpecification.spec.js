...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SpotFleetLaunchSpecification();
  });
  ...
  describe('SpotFleetLaunchSpecification', function() {
    it('should create an instance of SpotFleetLaunchSpecification', function() {
      // uncomment below and update the code to test SpotFleetLaunchSpecification
      //var instane = new AmazonEc2.SpotFleetLaunchSpecification();
      //expect(instance).to.be.a(AmazonEc2.SpotFleetLaunchSpecification);
    });
