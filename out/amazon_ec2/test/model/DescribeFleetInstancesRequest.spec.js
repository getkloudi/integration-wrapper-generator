...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeFleetInstancesRequest();
  });
  ...
  describe('DescribeFleetInstancesRequest', function() {
    it('should create an instance of DescribeFleetInstancesRequest', function() {
      // uncomment below and update the code to test DescribeFleetInstancesRequest
      //var instane = new AmazonEc2.DescribeFleetInstancesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeFleetInstancesRequest);
    });
