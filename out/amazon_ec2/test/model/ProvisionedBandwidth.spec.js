...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ProvisionedBandwidth();
  });
  ...
  describe('ProvisionedBandwidth', function() {
    it('should create an instance of ProvisionedBandwidth', function() {
      // uncomment below and update the code to test ProvisionedBandwidth
      //var instane = new AmazonEc2.ProvisionedBandwidth();
      //expect(instance).to.be.a(AmazonEc2.ProvisionedBandwidth);
    });

    it('should have the property provisionTime (base name: "ProvisionTime")', function() {
      // uncomment below and update the code to test the property provisionTime
      //var instane = new AmazonEc2.ProvisionedBandwidth();
