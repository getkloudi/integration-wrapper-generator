...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SnapshotTaskDetail();
  });
  ...
  describe('SnapshotTaskDetail', function() {
    it('should create an instance of SnapshotTaskDetail', function() {
      // uncomment below and update the code to test SnapshotTaskDetail
      //var instane = new AmazonEc2.SnapshotTaskDetail();
      //expect(instance).to.be.a(AmazonEc2.SnapshotTaskDetail);
    });
    ...
    it('should have the property diskImageSize (base name: "DiskImageSize")', function() {
      // uncomment below and update the code to test the property diskImageSize
      //var instane = new AmazonEc2.SnapshotTaskDetail();
      //expect(instance).to.be();
    });
    ...
    it('should have the property userBucket (base name: "UserBucket")', function() {
      // uncomment below and update the code to test the property userBucket
      //var instane = new AmazonEc2.SnapshotTaskDetail();
      //expect(instance).to.be();
    });
