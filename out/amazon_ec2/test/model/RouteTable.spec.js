...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.RouteTable();
  });
  ...
  describe('RouteTable', function() {
    it('should create an instance of RouteTable', function() {
      ...
      //var instane = new AmazonEc2.RouteTable();
      //expect(instance).to.be.a(AmazonEc2.RouteTable);
    });
    ...
    it('should have the property propagatingVgws (base name: "PropagatingVgws")', function() {
      // uncomment below and update the code to test the property propagatingVgws
      //var instane = new AmazonEc2.RouteTable();
      //expect(instance).to.be();
    });
