...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeTrafficMirrorFiltersRequest();
  });
  ...
  describe('DescribeTrafficMirrorFiltersRequest', function() {
    it('should create an instance of DescribeTrafficMirrorFiltersRequest', function() {
      // uncomment below and update the code to test DescribeTrafficMirrorFiltersRequest
      //var instane = new AmazonEc2.DescribeTrafficMirrorFiltersRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeTrafficMirrorFiltersRequest);
    });
    ...
    it('should have the property trafficMirrorFilterIds (base name: "TrafficMirrorFilterIds")', function() {
      // uncomment below and update the code to test the property trafficMirrorFilterIds
      //var instane = new AmazonEc2.DescribeTrafficMirrorFiltersRequest();
      //expect(instance).to.be();
    });
