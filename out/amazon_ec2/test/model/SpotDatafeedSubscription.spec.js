...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SpotDatafeedSubscription();
  });
  ...
  describe('SpotDatafeedSubscription', function() {
    it('should create an instance of SpotDatafeedSubscription', function() {
      // uncomment below and update the code to test SpotDatafeedSubscription
      //var instane = new AmazonEc2.SpotDatafeedSubscription();
      //expect(instance).to.be.a(AmazonEc2.SpotDatafeedSubscription);
    });
