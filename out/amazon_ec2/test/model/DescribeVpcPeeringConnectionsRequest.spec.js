...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVpcPeeringConnectionsRequest();
  });
  ...
  describe('DescribeVpcPeeringConnectionsRequest', function() {
    it('should create an instance of DescribeVpcPeeringConnectionsRequest', function() {
      // uncomment below and update the code to test DescribeVpcPeeringConnectionsRequest
      //var instane = new AmazonEc2.DescribeVpcPeeringConnectionsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVpcPeeringConnectionsRequest);
    });
    ...
    it('should have the property vpcPeeringConnectionIds (base name: "VpcPeeringConnectionIds")', function() {
      // uncomment below and update the code to test the property vpcPeeringConnectionIds
      //var instane = new AmazonEc2.DescribeVpcPeeringConnectionsRequest();
      //expect(instance).to.be();
    });
