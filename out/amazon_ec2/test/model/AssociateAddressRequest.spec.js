...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AssociateAddressRequest();
  });
  ...
  describe('AssociateAddressRequest', function() {
    it('should create an instance of AssociateAddressRequest', function() {
      // uncomment below and update the code to test AssociateAddressRequest
      //var instane = new AmazonEc2.AssociateAddressRequest();
      //expect(instance).to.be.a(AmazonEc2.AssociateAddressRequest);
    });
    ...
    it('should have the property allowReassociation (base name: "AllowReassociation")', function() {
      // uncomment below and update the code to test the property allowReassociation
      //var instane = new AmazonEc2.AssociateAddressRequest();
      //expect(instance).to.be();
    });
