...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.FleetLaunchTemplateOverrides();
  });
  ...
  describe('FleetLaunchTemplateOverrides', function() {
    it('should create an instance of FleetLaunchTemplateOverrides', function() {
      // uncomment below and update the code to test FleetLaunchTemplateOverrides
      //var instane = new AmazonEc2.FleetLaunchTemplateOverrides();
      //expect(instance).to.be.a(AmazonEc2.FleetLaunchTemplateOverrides);
    });
