...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SpotOptions();
  });
  ...
  describe('SpotOptions', function() {
    it('should create an instance of SpotOptions', function() {
      // uncomment below and update the code to test SpotOptions
      //var instane = new AmazonEc2.SpotOptions();
      //expect(instance).to.be.a(AmazonEc2.SpotOptions);
    });
