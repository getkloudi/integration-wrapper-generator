...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.RequestLaunchTemplateData();
  });
  ...
  describe('RequestLaunchTemplateData', function() {
    it('should create an instance of RequestLaunchTemplateData', function() {
      // uncomment below and update the code to test RequestLaunchTemplateData
      //var instane = new AmazonEc2.RequestLaunchTemplateData();
      //expect(instance).to.be.a(AmazonEc2.RequestLaunchTemplateData);
    });
