...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.EnableFastSnapshotRestoreSuccessItem();
  });
  ...
  describe('EnableFastSnapshotRestoreSuccessItem', function() {
    it('should create an instance of EnableFastSnapshotRestoreSuccessItem', function() {
      // uncomment below and update the code to test EnableFastSnapshotRestoreSuccessItem
      //var instane = new AmazonEc2.EnableFastSnapshotRestoreSuccessItem();
      //expect(instance).to.be.a(AmazonEc2.EnableFastSnapshotRestoreSuccessItem);
    });
