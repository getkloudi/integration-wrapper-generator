...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeStaleSecurityGroupsRequest();
  });
  ...
  describe('DescribeStaleSecurityGroupsRequest', function() {
    it('should create an instance of DescribeStaleSecurityGroupsRequest', function() {
      // uncomment below and update the code to test DescribeStaleSecurityGroupsRequest
      //var instane = new AmazonEc2.DescribeStaleSecurityGroupsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeStaleSecurityGroupsRequest);
    });
