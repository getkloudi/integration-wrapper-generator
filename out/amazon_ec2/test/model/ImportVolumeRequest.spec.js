...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ImportVolumeRequest();
  });
  ...
  describe('ImportVolumeRequest', function() {
    it('should create an instance of ImportVolumeRequest', function() {
      // uncomment below and update the code to test ImportVolumeRequest
      //var instane = new AmazonEc2.ImportVolumeRequest();
      //expect(instance).to.be.a(AmazonEc2.ImportVolumeRequest);
    });
