...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifyInstanceCapacityReservationAttributesRequest();
  });
  ...
  describe('ModifyInstanceCapacityReservationAttributesRequest', function() {
    it('should create an instance of ModifyInstanceCapacityReservationAttributesRequest', function() {
      // uncomment below and update the code to test ModifyInstanceCapacityReservationAttributesRequest
      //var instane = new AmazonEc2.ModifyInstanceCapacityReservationAttributesRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifyInstanceCapacityReservationAttributesRequest);
    });
