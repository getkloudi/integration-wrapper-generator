...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.HostInstance();
  });
  ...
  describe('HostInstance', function() {
    it('should create an instance of HostInstance', function() {
      // uncomment below and update the code to test HostInstance
      //var instane = new AmazonEc2.HostInstance();
      //expect(instance).to.be.a(AmazonEc2.HostInstance);
    });
