...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.LaunchTemplatePlacementRequest();
  });
  ...
  describe('LaunchTemplatePlacementRequest', function() {
    it('should create an instance of LaunchTemplatePlacementRequest', function() {
      // uncomment below and update the code to test LaunchTemplatePlacementRequest
      //var instane = new AmazonEc2.LaunchTemplatePlacementRequest();
      //expect(instance).to.be.a(AmazonEc2.LaunchTemplatePlacementRequest);
    });
    ...
    it('should have the property hostResourceGroupArn (base name: "HostResourceGroupArn")', function() {
      // uncomment below and update the code to test the property hostResourceGroupArn
      //var instane = new AmazonEc2.LaunchTemplatePlacementRequest();
      //expect(instance).to.be();
    });

    it('should have the property spreadDomain (base name: "SpreadDomain")', function() {
      // uncomment below and update the code to test the property spreadDomain
      //var instane = new AmazonEc2.LaunchTemplatePlacementRequest();
      //expect(instance).to.be();
    });
