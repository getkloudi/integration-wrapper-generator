...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateNatGatewayRequest();
  });
  ...
  describe('CreateNatGatewayRequest', function() {
    it('should create an instance of CreateNatGatewayRequest', function() {
      // uncomment below and update the code to test CreateNatGatewayRequest
      //var instane = new AmazonEc2.CreateNatGatewayRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateNatGatewayRequest);
    });
