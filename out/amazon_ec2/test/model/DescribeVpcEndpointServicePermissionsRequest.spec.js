...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVpcEndpointServicePermissionsRequest();
  });
  ...
  describe('DescribeVpcEndpointServicePermissionsRequest', function() {
    it('should create an instance of DescribeVpcEndpointServicePermissionsRequest', function() {
      // uncomment below and update the code to test DescribeVpcEndpointServicePermissionsRequest
      //var instane = new AmazonEc2.DescribeVpcEndpointServicePermissionsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVpcEndpointServicePermissionsRequest);
    });
