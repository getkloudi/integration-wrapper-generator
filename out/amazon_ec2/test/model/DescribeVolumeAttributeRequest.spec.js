...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVolumeAttributeRequest();
  });
  ...
  describe('DescribeVolumeAttributeRequest', function() {
    it('should create an instance of DescribeVolumeAttributeRequest', function() {
      // uncomment below and update the code to test DescribeVolumeAttributeRequest
      //var instane = new AmazonEc2.DescribeVolumeAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVolumeAttributeRequest);
    });
