...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DetachVolumeRequest();
  });
  ...
  describe('DetachVolumeRequest', function() {
    it('should create an instance of DetachVolumeRequest', function() {
      // uncomment below and update the code to test DetachVolumeRequest
      //var instane = new AmazonEc2.DetachVolumeRequest();
      //expect(instance).to.be.a(AmazonEc2.DetachVolumeRequest);
    });
