...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeRouteTablesRequest();
  });
  ...
  describe('DescribeRouteTablesRequest', function() {
    it('should create an instance of DescribeRouteTablesRequest', function() {
      // uncomment below and update the code to test DescribeRouteTablesRequest
      //var instane = new AmazonEc2.DescribeRouteTablesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeRouteTablesRequest);
    });
