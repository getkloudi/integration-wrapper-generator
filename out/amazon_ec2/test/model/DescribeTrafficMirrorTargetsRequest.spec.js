...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeTrafficMirrorTargetsRequest();
  });
  ...
  describe('DescribeTrafficMirrorTargetsRequest', function() {
    it('should create an instance of DescribeTrafficMirrorTargetsRequest', function() {
      // uncomment below and update the code to test DescribeTrafficMirrorTargetsRequest
      //var instane = new AmazonEc2.DescribeTrafficMirrorTargetsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeTrafficMirrorTargetsRequest);
    });
    ...
    it('should have the property trafficMirrorTargetIds (base name: "TrafficMirrorTargetIds")', function() {
      // uncomment below and update the code to test the property trafficMirrorTargetIds
      //var instane = new AmazonEc2.DescribeTrafficMirrorTargetsRequest();
      //expect(instance).to.be();
    });
