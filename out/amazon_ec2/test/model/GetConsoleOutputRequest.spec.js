...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.GetConsoleOutputRequest();
  });
  ...
  describe('GetConsoleOutputRequest', function() {
    it('should create an instance of GetConsoleOutputRequest', function() {
      // uncomment below and update the code to test GetConsoleOutputRequest
      //var instane = new AmazonEc2.GetConsoleOutputRequest();
      //expect(instance).to.be.a(AmazonEc2.GetConsoleOutputRequest);
    });
