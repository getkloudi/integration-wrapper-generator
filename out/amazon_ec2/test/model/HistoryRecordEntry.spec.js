...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.HistoryRecordEntry();
  });
  ...
  describe('HistoryRecordEntry', function() {
    it('should create an instance of HistoryRecordEntry', function() {
      // uncomment below and update the code to test HistoryRecordEntry
      //var instane = new AmazonEc2.HistoryRecordEntry();
      //expect(instance).to.be.a(AmazonEc2.HistoryRecordEntry);
    });
