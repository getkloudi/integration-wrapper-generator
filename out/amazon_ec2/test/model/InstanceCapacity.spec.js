...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.InstanceCapacity();
  });
  ...
  describe('InstanceCapacity', function() {
    it('should create an instance of InstanceCapacity', function() {
      // uncomment below and update the code to test InstanceCapacity
      //var instane = new AmazonEc2.InstanceCapacity();
      //expect(instance).to.be.a(AmazonEc2.InstanceCapacity);
    });
