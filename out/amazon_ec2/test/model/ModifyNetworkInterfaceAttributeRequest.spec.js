...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifyNetworkInterfaceAttributeRequest();
  });
  ...
  describe('ModifyNetworkInterfaceAttributeRequest', function() {
    it('should create an instance of ModifyNetworkInterfaceAttributeRequest', function() {
      // uncomment below and update the code to test ModifyNetworkInterfaceAttributeRequest
      //var instane = new AmazonEc2.ModifyNetworkInterfaceAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifyNetworkInterfaceAttributeRequest);
    });
