...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateNetworkInterfacePermissionRequest();
  });
  ...
  describe('CreateNetworkInterfacePermissionRequest', function() {
    it('should create an instance of CreateNetworkInterfacePermissionRequest', function() {
      // uncomment below and update the code to test CreateNetworkInterfacePermissionRequest
      //var instane = new AmazonEc2.CreateNetworkInterfacePermissionRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateNetworkInterfacePermissionRequest);
    });
