...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVolumeStatusRequest();
  });
  ...
  describe('DescribeVolumeStatusRequest', function() {
    it('should create an instance of DescribeVolumeStatusRequest', function() {
      // uncomment below and update the code to test DescribeVolumeStatusRequest
      //var instane = new AmazonEc2.DescribeVolumeStatusRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVolumeStatusRequest);
    });
