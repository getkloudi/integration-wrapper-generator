...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CancelImportTaskRequest();
  });
  ...
  describe('CancelImportTaskRequest', function() {
    it('should create an instance of CancelImportTaskRequest', function() {
      // uncomment below and update the code to test CancelImportTaskRequest
      //var instane = new AmazonEc2.CancelImportTaskRequest();
      //expect(instance).to.be.a(AmazonEc2.CancelImportTaskRequest);
    });
