...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.InstanceStateChange();
  });
  ...
  describe('InstanceStateChange', function() {
    it('should create an instance of InstanceStateChange', function() {
      // uncomment below and update the code to test InstanceStateChange
      //var instane = new AmazonEc2.InstanceStateChange();
      //expect(instance).to.be.a(AmazonEc2.InstanceStateChange);
    });
