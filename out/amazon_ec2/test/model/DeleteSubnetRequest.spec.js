...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DeleteSubnetRequest();
  });
  ...
  describe('DeleteSubnetRequest', function() {
    it('should create an instance of DeleteSubnetRequest', function() {
      // uncomment below and update the code to test DeleteSubnetRequest
      //var instane = new AmazonEc2.DeleteSubnetRequest();
      //expect(instance).to.be.a(AmazonEc2.DeleteSubnetRequest);
    });
