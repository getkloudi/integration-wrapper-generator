...
(function(root, factory) {
  ...
  describe('Route', function() {
    it('should create an instance of Route', function() {
      ...
      //var instane = new AmazonEc2.Route();
      //expect(instance).to.be.a(AmazonEc2.Route);
    });
    ...
    it('should have the property destinationPrefixListId (base name: "DestinationPrefixListId")', function() {
      // uncomment below and update the code to test the property destinationPrefixListId
      //var instane = new AmazonEc2.Route();
      //expect(instance).to.be();
    });
