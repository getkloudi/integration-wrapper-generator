...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateCustomerGatewayRequest();
  });
  ...
  describe('CreateCustomerGatewayRequest', function() {
    it('should create an instance of CreateCustomerGatewayRequest', function() {
      // uncomment below and update the code to test CreateCustomerGatewayRequest
      //var instane = new AmazonEc2.CreateCustomerGatewayRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateCustomerGatewayRequest);
    });
