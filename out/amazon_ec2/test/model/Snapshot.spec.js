...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.Snapshot();
  });
  ...
  describe('Snapshot', function() {
    it('should create an instance of Snapshot', function() {
      ...
      //var instane = new AmazonEc2.Snapshot();
      //expect(instance).to.be.a(AmazonEc2.Snapshot);
    });

    it('should have the property dataEncryptionKeyId (base name: "DataEncryptionKeyId")', function() {
      // uncomment below and update the code to test the property dataEncryptionKeyId
      //var instane = new AmazonEc2.Snapshot();
