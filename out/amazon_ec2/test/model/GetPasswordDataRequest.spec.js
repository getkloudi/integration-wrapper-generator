...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.GetPasswordDataRequest();
  });
  ...
  describe('GetPasswordDataRequest', function() {
    it('should create an instance of GetPasswordDataRequest', function() {
      // uncomment below and update the code to test GetPasswordDataRequest
      //var instane = new AmazonEc2.GetPasswordDataRequest();
      //expect(instance).to.be.a(AmazonEc2.GetPasswordDataRequest);
    });
