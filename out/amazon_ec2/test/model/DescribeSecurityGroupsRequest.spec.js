...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeSecurityGroupsRequest();
  });
  ...
  describe('DescribeSecurityGroupsRequest', function() {
    it('should create an instance of DescribeSecurityGroupsRequest', function() {
      // uncomment below and update the code to test DescribeSecurityGroupsRequest
      //var instane = new AmazonEc2.DescribeSecurityGroupsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeSecurityGroupsRequest);
    });
