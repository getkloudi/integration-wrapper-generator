...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DeleteRouteRequest();
  });
  ...
  describe('DeleteRouteRequest', function() {
    it('should create an instance of DeleteRouteRequest', function() {
      // uncomment below and update the code to test DeleteRouteRequest
      //var instane = new AmazonEc2.DeleteRouteRequest();
      //expect(instance).to.be.a(AmazonEc2.DeleteRouteRequest);
    });
