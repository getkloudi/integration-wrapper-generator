...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.GetCapacityReservationUsageRequest();
  });
  ...
  describe('GetCapacityReservationUsageRequest', function() {
    it('should create an instance of GetCapacityReservationUsageRequest', function() {
      // uncomment below and update the code to test GetCapacityReservationUsageRequest
      //var instane = new AmazonEc2.GetCapacityReservationUsageRequest();
      //expect(instance).to.be.a(AmazonEc2.GetCapacityReservationUsageRequest);
    });
