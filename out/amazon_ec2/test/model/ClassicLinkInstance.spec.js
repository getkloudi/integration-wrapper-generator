...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ClassicLinkInstance();
  });
  ...
  describe('ClassicLinkInstance', function() {
    it('should create an instance of ClassicLinkInstance', function() {
      // uncomment below and update the code to test ClassicLinkInstance
      //var instane = new AmazonEc2.ClassicLinkInstance();
      //expect(instance).to.be.a(AmazonEc2.ClassicLinkInstance);
    });
