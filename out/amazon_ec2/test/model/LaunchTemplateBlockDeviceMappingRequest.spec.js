...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.LaunchTemplateBlockDeviceMappingRequest();
  });
  ...
  describe('LaunchTemplateBlockDeviceMappingRequest', function() {
    it('should create an instance of LaunchTemplateBlockDeviceMappingRequest', function() {
      // uncomment below and update the code to test LaunchTemplateBlockDeviceMappingRequest
      //var instane = new AmazonEc2.LaunchTemplateBlockDeviceMappingRequest();
      //expect(instance).to.be.a(AmazonEc2.LaunchTemplateBlockDeviceMappingRequest);
    });
