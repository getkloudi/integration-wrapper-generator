...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ResetInstanceAttributeRequest();
  });
  ...
  describe('ResetInstanceAttributeRequest', function() {
    it('should create an instance of ResetInstanceAttributeRequest', function() {
      // uncomment below and update the code to test ResetInstanceAttributeRequest
      //var instane = new AmazonEc2.ResetInstanceAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.ResetInstanceAttributeRequest);
    });
