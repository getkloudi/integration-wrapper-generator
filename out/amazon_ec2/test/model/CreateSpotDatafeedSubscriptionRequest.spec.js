...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateSpotDatafeedSubscriptionRequest();
  });
  ...
  describe('CreateSpotDatafeedSubscriptionRequest', function() {
    it('should create an instance of CreateSpotDatafeedSubscriptionRequest', function() {
      // uncomment below and update the code to test CreateSpotDatafeedSubscriptionRequest
      //var instane = new AmazonEc2.CreateSpotDatafeedSubscriptionRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateSpotDatafeedSubscriptionRequest);
    });
