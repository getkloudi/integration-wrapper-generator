...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribePrincipalIdFormatRequest();
  });
  ...
  describe('DescribePrincipalIdFormatRequest', function() {
    it('should create an instance of DescribePrincipalIdFormatRequest', function() {
      // uncomment below and update the code to test DescribePrincipalIdFormatRequest
      //var instane = new AmazonEc2.DescribePrincipalIdFormatRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribePrincipalIdFormatRequest);
    });
