...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.InstanceCount();
  });
  ...
  describe('InstanceCount', function() {
    it('should create an instance of InstanceCount', function() {
      // uncomment below and update the code to test InstanceCount
      //var instane = new AmazonEc2.InstanceCount();
      //expect(instance).to.be.a(AmazonEc2.InstanceCount);
    });
