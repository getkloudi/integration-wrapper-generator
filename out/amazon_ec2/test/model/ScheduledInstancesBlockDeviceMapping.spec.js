...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ScheduledInstancesBlockDeviceMapping();
  });
  ...
  describe('ScheduledInstancesBlockDeviceMapping', function() {
    it('should create an instance of ScheduledInstancesBlockDeviceMapping', function() {
      // uncomment below and update the code to test ScheduledInstancesBlockDeviceMapping
      //var instane = new AmazonEc2.ScheduledInstancesBlockDeviceMapping();
      //expect(instance).to.be.a(AmazonEc2.ScheduledInstancesBlockDeviceMapping);
    });
