...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ExportImageRequest();
  });
  ...
  describe('ExportImageRequest', function() {
    it('should create an instance of ExportImageRequest', function() {
      // uncomment below and update the code to test ExportImageRequest
      //var instane = new AmazonEc2.ExportImageRequest();
      //expect(instance).to.be.a(AmazonEc2.ExportImageRequest);
    });
