...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateTrafficMirrorFilterRequest();
  });
  ...
  describe('CreateTrafficMirrorFilterRequest', function() {
    it('should create an instance of CreateTrafficMirrorFilterRequest', function() {
      // uncomment below and update the code to test CreateTrafficMirrorFilterRequest
      //var instane = new AmazonEc2.CreateTrafficMirrorFilterRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateTrafficMirrorFilterRequest);
    });
