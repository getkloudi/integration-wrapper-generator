...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.TerminateClientVpnConnectionsRequest();
  });
  ...
  describe('TerminateClientVpnConnectionsRequest', function() {
    it('should create an instance of TerminateClientVpnConnectionsRequest', function() {
      // uncomment below and update the code to test TerminateClientVpnConnectionsRequest
      //var instane = new AmazonEc2.TerminateClientVpnConnectionsRequest();
      //expect(instance).to.be.a(AmazonEc2.TerminateClientVpnConnectionsRequest);
    });
