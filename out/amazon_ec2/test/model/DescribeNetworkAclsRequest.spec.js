...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeNetworkAclsRequest();
  });
  ...
  describe('DescribeNetworkAclsRequest', function() {
    it('should create an instance of DescribeNetworkAclsRequest', function() {
      // uncomment below and update the code to test DescribeNetworkAclsRequest
      //var instane = new AmazonEc2.DescribeNetworkAclsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeNetworkAclsRequest);
    });
    ...
    it('should have the property networkAclIds (base name: "NetworkAclIds")', function() {
      // uncomment below and update the code to test the property networkAclIds
      //var instane = new AmazonEc2.DescribeNetworkAclsRequest();
      //expect(instance).to.be();
    });
