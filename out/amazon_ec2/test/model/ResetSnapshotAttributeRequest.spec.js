...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ResetSnapshotAttributeRequest();
  });
  ...
  describe('ResetSnapshotAttributeRequest', function() {
    it('should create an instance of ResetSnapshotAttributeRequest', function() {
      // uncomment below and update the code to test ResetSnapshotAttributeRequest
      //var instane = new AmazonEc2.ResetSnapshotAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.ResetSnapshotAttributeRequest);
    });
