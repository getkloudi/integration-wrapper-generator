...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeHostsRequest();
  });
  ...
  describe('DescribeHostsRequest', function() {
    it('should create an instance of DescribeHostsRequest', function() {
      // uncomment below and update the code to test DescribeHostsRequest
      //var instane = new AmazonEc2.DescribeHostsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeHostsRequest);
    });
    ...
    it('should have the property hostIds (base name: "HostIds")', function() {
