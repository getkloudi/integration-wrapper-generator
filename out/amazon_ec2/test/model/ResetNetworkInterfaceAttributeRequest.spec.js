...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ResetNetworkInterfaceAttributeRequest();
  });
  ...
  describe('ResetNetworkInterfaceAttributeRequest', function() {
    it('should create an instance of ResetNetworkInterfaceAttributeRequest', function() {
      // uncomment below and update the code to test ResetNetworkInterfaceAttributeRequest
      //var instane = new AmazonEc2.ResetNetworkInterfaceAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.ResetNetworkInterfaceAttributeRequest);
    });
