...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifyVpcTenancyRequest();
  });
  ...
  describe('ModifyVpcTenancyRequest', function() {
    it('should create an instance of ModifyVpcTenancyRequest', function() {
      // uncomment below and update the code to test ModifyVpcTenancyRequest
      //var instane = new AmazonEc2.ModifyVpcTenancyRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifyVpcTenancyRequest);
    });
