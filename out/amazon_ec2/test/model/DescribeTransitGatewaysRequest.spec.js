...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeTransitGatewaysRequest();
  });
  ...
  describe('DescribeTransitGatewaysRequest', function() {
    it('should create an instance of DescribeTransitGatewaysRequest', function() {
      // uncomment below and update the code to test DescribeTransitGatewaysRequest
      //var instane = new AmazonEc2.DescribeTransitGatewaysRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeTransitGatewaysRequest);
    });
    ...
    it('should have the property transitGatewayIds (base name: "TransitGatewayIds")', function() {
      // uncomment below and update the code to test the property transitGatewayIds
      //var instane = new AmazonEc2.DescribeTransitGatewaysRequest();
      //expect(instance).to.be();
    });
