...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ExportImageTask();
  });
  ...
  describe('ExportImageTask', function() {
    it('should create an instance of ExportImageTask', function() {
      // uncomment below and update the code to test ExportImageTask
      //var instane = new AmazonEc2.ExportImageTask();
      //expect(instance).to.be.a(AmazonEc2.ExportImageTask);
    });
