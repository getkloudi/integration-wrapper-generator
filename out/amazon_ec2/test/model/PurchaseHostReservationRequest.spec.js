...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.PurchaseHostReservationRequest();
  });
  ...
  describe('PurchaseHostReservationRequest', function() {
    it('should create an instance of PurchaseHostReservationRequest', function() {
      // uncomment below and update the code to test PurchaseHostReservationRequest
      //var instane = new AmazonEc2.PurchaseHostReservationRequest();
      //expect(instance).to.be.a(AmazonEc2.PurchaseHostReservationRequest);
    });
