...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifyClientVpnEndpointRequest();
  });
  ...
  describe('ModifyClientVpnEndpointRequest', function() {
    it('should create an instance of ModifyClientVpnEndpointRequest', function() {
      // uncomment below and update the code to test ModifyClientVpnEndpointRequest
      //var instane = new AmazonEc2.ModifyClientVpnEndpointRequest();
      //expect(instance).to.be.a(AmazonEc2.ModifyClientVpnEndpointRequest);
    });
