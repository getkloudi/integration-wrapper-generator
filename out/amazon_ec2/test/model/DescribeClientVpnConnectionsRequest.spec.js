...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeClientVpnConnectionsRequest();
  });
  ...
  describe('DescribeClientVpnConnectionsRequest', function() {
    it('should create an instance of DescribeClientVpnConnectionsRequest', function() {
      // uncomment below and update the code to test DescribeClientVpnConnectionsRequest
      //var instane = new AmazonEc2.DescribeClientVpnConnectionsRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeClientVpnConnectionsRequest);
    });
