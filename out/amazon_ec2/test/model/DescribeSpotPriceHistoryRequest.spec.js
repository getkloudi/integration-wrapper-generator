...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeSpotPriceHistoryRequest();
  });
  ...
  describe('DescribeSpotPriceHistoryRequest', function() {
    it('should create an instance of DescribeSpotPriceHistoryRequest', function() {
      // uncomment below and update the code to test DescribeSpotPriceHistoryRequest
      //var instane = new AmazonEc2.DescribeSpotPriceHistoryRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeSpotPriceHistoryRequest);
    });
    ...
    it('should have the property productDescriptions (base name: "ProductDescriptions")', function() {
      // uncomment below and update the code to test the property productDescriptions
      //var instane = new AmazonEc2.DescribeSpotPriceHistoryRequest();
      //expect(instance).to.be();
    });
