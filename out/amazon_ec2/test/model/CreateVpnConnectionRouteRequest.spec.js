...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateVpnConnectionRouteRequest();
  });
  ...
  describe('CreateVpnConnectionRouteRequest', function() {
    it('should create an instance of CreateVpnConnectionRouteRequest', function() {
      // uncomment below and update the code to test CreateVpnConnectionRouteRequest
      //var instane = new AmazonEc2.CreateVpnConnectionRouteRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateVpnConnectionRouteRequest);
    });
