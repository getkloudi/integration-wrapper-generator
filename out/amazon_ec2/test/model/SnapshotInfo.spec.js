...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SnapshotInfo();
  });
  ...
  describe('SnapshotInfo', function() {
    it('should create an instance of SnapshotInfo', function() {
      // uncomment below and update the code to test SnapshotInfo
      //var instane = new AmazonEc2.SnapshotInfo();
      //expect(instance).to.be.a(AmazonEc2.SnapshotInfo);
    });
