...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ActiveInstance();
  });
  ...
  describe('ActiveInstance', function() {
    it('should create an instance of ActiveInstance', function() {
      // uncomment below and update the code to test ActiveInstance
      //var instane = new AmazonEc2.ActiveInstance();
      //expect(instance).to.be.a(AmazonEc2.ActiveInstance);
    });

    it('should have the property instanceHealth (base name: "InstanceHealth")', function() {
      // uncomment below and update the code to test the property instanceHealth
      //var instane = new AmazonEc2.ActiveInstance();
