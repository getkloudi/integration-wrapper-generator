...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ModifyVpnTunnelOptionsSpecification();
  });
  ...
  describe('ModifyVpnTunnelOptionsSpecification', function() {
    it('should create an instance of ModifyVpnTunnelOptionsSpecification', function() {
      // uncomment below and update the code to test ModifyVpnTunnelOptionsSpecification
      //var instane = new AmazonEc2.ModifyVpnTunnelOptionsSpecification();
      //expect(instance).to.be.a(AmazonEc2.ModifyVpnTunnelOptionsSpecification);
    });
