...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AllowedPrincipal();
  });
  ...
  describe('AllowedPrincipal', function() {
    it('should create an instance of AllowedPrincipal', function() {
      // uncomment below and update the code to test AllowedPrincipal
      //var instane = new AmazonEc2.AllowedPrincipal();
      //expect(instance).to.be.a(AmazonEc2.AllowedPrincipal);
    });
