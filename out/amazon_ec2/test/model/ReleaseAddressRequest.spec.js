...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.ReleaseAddressRequest();
  });
  ...
  describe('ReleaseAddressRequest', function() {
    it('should create an instance of ReleaseAddressRequest', function() {
      // uncomment below and update the code to test ReleaseAddressRequest
      //var instane = new AmazonEc2.ReleaseAddressRequest();
      //expect(instance).to.be.a(AmazonEc2.ReleaseAddressRequest);
    });
