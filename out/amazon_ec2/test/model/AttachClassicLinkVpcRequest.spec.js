...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.AttachClassicLinkVpcRequest();
  });
  ...
  describe('AttachClassicLinkVpcRequest', function() {
    it('should create an instance of AttachClassicLinkVpcRequest', function() {
      // uncomment below and update the code to test AttachClassicLinkVpcRequest
      //var instane = new AmazonEc2.AttachClassicLinkVpcRequest();
      //expect(instance).to.be.a(AmazonEc2.AttachClassicLinkVpcRequest);
    });
