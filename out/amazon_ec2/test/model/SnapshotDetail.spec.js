...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.SnapshotDetail();
  });
  ...
  describe('SnapshotDetail', function() {
    it('should create an instance of SnapshotDetail', function() {
      // uncomment below and update the code to test SnapshotDetail
      //var instane = new AmazonEc2.SnapshotDetail();
      //expect(instance).to.be.a(AmazonEc2.SnapshotDetail);
    });
