...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeNetworkInterfaceAttributeRequest();
  });
  ...
  describe('DescribeNetworkInterfaceAttributeRequest', function() {
    it('should create an instance of DescribeNetworkInterfaceAttributeRequest', function() {
      // uncomment below and update the code to test DescribeNetworkInterfaceAttributeRequest
      //var instane = new AmazonEc2.DescribeNetworkInterfaceAttributeRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeNetworkInterfaceAttributeRequest);
    });
