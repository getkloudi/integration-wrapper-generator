...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.CreateCapacityReservationRequest();
  });
  ...
  describe('CreateCapacityReservationRequest', function() {
    it('should create an instance of CreateCapacityReservationRequest', function() {
      // uncomment below and update the code to test CreateCapacityReservationRequest
      //var instane = new AmazonEc2.CreateCapacityReservationRequest();
      //expect(instance).to.be.a(AmazonEc2.CreateCapacityReservationRequest);
    });
