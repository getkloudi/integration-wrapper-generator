...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2.DescribeVolumesRequest();
  });
  ...
  describe('DescribeVolumesRequest', function() {
    it('should create an instance of DescribeVolumesRequest', function() {
      // uncomment below and update the code to test DescribeVolumesRequest
      //var instane = new AmazonEc2.DescribeVolumesRequest();
      //expect(instance).to.be.a(AmazonEc2.DescribeVolumesRequest);
    });
