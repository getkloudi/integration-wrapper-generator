...
import VpcTenancy from './VpcTenancy';
...
class ModifyVpcTenancyRequest {
     ...
     * @param vpcId {String} 
     */
    constructor(instanceTenancy, vpcId) { 
     ...
     */
    static initialize(obj, instanceTenancy, vpcId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('InstanceTenancy')) {
                obj['InstanceTenancy'] = VpcTenancy.constructFromObject(data['InstanceTenancy']);
            }
...
export default ModifyVpcTenancyRequest;
