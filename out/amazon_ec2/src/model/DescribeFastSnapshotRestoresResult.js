    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('FastSnapshotRestores')) {
                obj['FastSnapshotRestores'] = ApiClient.convertToType(data['FastSnapshotRestores'], [DescribeFastSnapshotRestoreSuccessItem]);
            }
...
export default DescribeFastSnapshotRestoresResult;
