...
class SlotDateTimeRangeRequest {
     ...
     */
    constructor(earliestTime, latestTime) { 
     ...
     */
    static initialize(obj, earliestTime, latestTime) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('EarliestTime')) {
                obj['EarliestTime'] = ApiClient.convertToType(data['EarliestTime'], 'Date');
            }
            if (data.hasOwnProperty('LatestTime')) {
                obj['LatestTime'] = ApiClient.convertToType(data['LatestTime'], 'Date');
            }
        }
        return obj;
    }
...
export default SlotDateTimeRangeRequest;
