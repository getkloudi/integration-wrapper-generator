...
import SubnetCidrBlockStateCode from './SubnetCidrBlockStateCode';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('State')) {
                obj['State'] = SubnetCidrBlockStateCode.constructFromObject(data['State']);
            }
...
export default SubnetCidrBlockState;
