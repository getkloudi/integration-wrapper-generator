    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AccepterPeeringConnectionOptions')) {
                obj['AccepterPeeringConnectionOptions'] = PeeringConnectionOptions.constructFromObject(data['AccepterPeeringConnectionOptions']);
            }
            if (data.hasOwnProperty('RequesterPeeringConnectionOptions')) {
                obj['RequesterPeeringConnectionOptions'] = PeeringConnectionOptions.constructFromObject(data['RequesterPeeringConnectionOptions']);
            }
        }
        return obj;
    }
...
export default ModifyVpcPeeringConnectionOptionsResult;
