    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LaunchTemplateIds')) {
                obj['LaunchTemplateIds'] = ApiClient.convertToType(data['LaunchTemplateIds'], ['String']);
            }
            if (data.hasOwnProperty('LaunchTemplateNames')) {
                obj['LaunchTemplateNames'] = ApiClient.convertToType(data['LaunchTemplateNames'], ['String']);
            }
...
export default DescribeLaunchTemplatesRequest;
