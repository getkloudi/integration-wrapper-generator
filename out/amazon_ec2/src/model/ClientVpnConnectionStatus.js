...
import ClientVpnConnectionStatusCode from './ClientVpnConnectionStatusCode';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Code')) {
                obj['Code'] = ClientVpnConnectionStatusCode.constructFromObject(data['Code']);
            }
...
export default ClientVpnConnectionStatus;
