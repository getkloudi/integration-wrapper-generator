    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Ebs')) {
                obj['Ebs'] = LaunchTemplateEbsBlockDeviceRequest.constructFromObject(data['Ebs']);
            }
            if (data.hasOwnProperty('NoDevice')) {
                obj['NoDevice'] = ApiClient.convertToType(data['NoDevice'], 'String');
            }
...
export default LaunchTemplateBlockDeviceMappingRequest;
