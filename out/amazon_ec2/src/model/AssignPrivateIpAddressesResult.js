    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AssignedPrivateIpAddresses')) {
                obj['AssignedPrivateIpAddresses'] = ApiClient.convertToType(data['AssignedPrivateIpAddresses'], [AssignedPrivateIpAddress]);
            }
...
export default AssignPrivateIpAddressesResult;
