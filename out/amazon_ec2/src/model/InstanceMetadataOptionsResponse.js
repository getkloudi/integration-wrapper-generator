...
import InstanceMetadataOptionsState from './InstanceMetadataOptionsState';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('State')) {
                obj['State'] = InstanceMetadataOptionsState.constructFromObject(data['State']);
            }
        }
        return obj;
    }
...
export default InstanceMetadataOptionsResponse;
