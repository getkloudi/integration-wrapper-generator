...
import NewDhcpConfiguration from './NewDhcpConfiguration';
...
class CreateDhcpOptionsRequest {
     ...
     */
    constructor(dhcpConfigurations) { 
     ...
     */
    static initialize(obj, dhcpConfigurations) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('DhcpConfigurations')) {
                obj['DhcpConfigurations'] = ApiClient.convertToType(data['DhcpConfigurations'], [NewDhcpConfiguration]);
            }
...
export default CreateDhcpOptionsRequest;
