...
import VpcAttributeName from './VpcAttributeName';
...
class DescribeVpcAttributeRequest {
     ...
     */
    static initialize(obj, attribute, vpcId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Attribute')) {
                obj['Attribute'] = VpcAttributeName.constructFromObject(data['Attribute']);
            }
...
export default DescribeVpcAttributeRequest;
