...
import ImageAttributeName from './ImageAttributeName';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Attribute')) {
                obj['Attribute'] = ImageAttributeName.constructFromObject(data['Attribute']);
            }
...
export default DescribeImageAttributeRequest;
