...
import UnsuccessfulInstanceCreditSpecificationErrorCode from './UnsuccessfulInstanceCreditSpecificationErrorCode';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Code')) {
                obj['Code'] = UnsuccessfulInstanceCreditSpecificationErrorCode.constructFromObject(data['Code']);
            }
...
export default UnsuccessfulInstanceCreditSpecificationItemError;
