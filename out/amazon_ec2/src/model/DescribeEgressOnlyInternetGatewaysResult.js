    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('EgressOnlyInternetGateways')) {
                obj['EgressOnlyInternetGateways'] = ApiClient.convertToType(data['EgressOnlyInternetGateways'], [EgressOnlyInternetGateway]);
            }
...
export default DescribeEgressOnlyInternetGatewaysResult;
