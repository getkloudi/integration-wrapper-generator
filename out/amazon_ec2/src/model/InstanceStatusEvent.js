    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Code')) {
                obj['Code'] = EventCode.constructFromObject(data['Code']);
            }
            ...
            if (data.hasOwnProperty('NotBeforeDeadline')) {
                obj['NotBeforeDeadline'] = ApiClient.convertToType(data['NotBeforeDeadline'], 'Date');
            }
        }
        return obj;
    }
...
export default InstanceStatusEvent;
