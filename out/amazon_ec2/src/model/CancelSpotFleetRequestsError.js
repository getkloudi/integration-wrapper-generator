...
import CancelBatchErrorCode from './CancelBatchErrorCode';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Code')) {
                obj['Code'] = CancelBatchErrorCode.constructFromObject(data['Code']);
            }
...
export default CancelSpotFleetRequestsError;
