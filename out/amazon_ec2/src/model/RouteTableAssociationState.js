...
import RouteTableAssociationStateCode from './RouteTableAssociationStateCode';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('State')) {
                obj['State'] = RouteTableAssociationStateCode.constructFromObject(data['State']);
            }
...
export default RouteTableAssociationState;
