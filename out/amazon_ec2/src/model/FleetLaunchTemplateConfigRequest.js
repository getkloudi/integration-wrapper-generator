...
import FleetLaunchTemplateOverridesRequest from './FleetLaunchTemplateOverridesRequest';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LaunchTemplateSpecification')) {
                obj['LaunchTemplateSpecification'] = FleetLaunchTemplateSpecificationRequest.constructFromObject(data['LaunchTemplateSpecification']);
            }
            if (data.hasOwnProperty('Overrides')) {
                obj['Overrides'] = ApiClient.convertToType(data['Overrides'], [FleetLaunchTemplateOverridesRequest]);
            }
        }
        return obj;
    }
...
export default FleetLaunchTemplateConfigRequest;
