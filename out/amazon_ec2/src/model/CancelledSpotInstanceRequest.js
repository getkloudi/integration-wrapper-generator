...
import CancelSpotInstanceRequestState from './CancelSpotInstanceRequestState';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('State')) {
                obj['State'] = CancelSpotInstanceRequestState.constructFromObject(data['State']);
            }
        }
        return obj;
    }
...
export default CancelledSpotInstanceRequest;
