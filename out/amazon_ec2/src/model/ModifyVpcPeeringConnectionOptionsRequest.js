    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AccepterPeeringConnectionOptions')) {
                obj['AccepterPeeringConnectionOptions'] = PeeringConnectionOptionsRequest.constructFromObject(data['AccepterPeeringConnectionOptions']);
            }
            if (data.hasOwnProperty('DryRun')) {
                obj['DryRun'] = ApiClient.convertToType(data['DryRun'], 'Boolean');
            }
            if (data.hasOwnProperty('RequesterPeeringConnectionOptions')) {
                obj['RequesterPeeringConnectionOptions'] = PeeringConnectionOptionsRequest.constructFromObject(data['RequesterPeeringConnectionOptions']);
            }
...
export default ModifyVpcPeeringConnectionOptionsRequest;
