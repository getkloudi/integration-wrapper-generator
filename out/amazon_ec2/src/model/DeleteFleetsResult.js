    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SuccessfulFleetDeletions')) {
                obj['SuccessfulFleetDeletions'] = ApiClient.convertToType(data['SuccessfulFleetDeletions'], [DeleteFleetSuccessItem]);
            }
            if (data.hasOwnProperty('UnsuccessfulFleetDeletions')) {
                obj['UnsuccessfulFleetDeletions'] = ApiClient.convertToType(data['UnsuccessfulFleetDeletions'], [DeleteFleetErrorItem]);
            }
        }
        return obj;
    }
...
export default DeleteFleetsResult;
