...
class ModifyInstanceEventStartTimeRequest {
     ...
     */
    constructor(instanceEventId, instanceId, notBefore) { 
     ...
     */
    static initialize(obj, instanceEventId, instanceId, notBefore) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('InstanceEventId')) {
                obj['InstanceEventId'] = ApiClient.convertToType(data['InstanceEventId'], 'String');
            }
...
export default ModifyInstanceEventStartTimeRequest;
