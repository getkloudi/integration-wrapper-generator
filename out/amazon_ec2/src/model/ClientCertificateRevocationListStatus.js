...
import ClientCertificateRevocationListStatusCode from './ClientCertificateRevocationListStatusCode';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Code')) {
                obj['Code'] = ClientCertificateRevocationListStatusCode.constructFromObject(data['Code']);
            }
...
export default ClientCertificateRevocationListStatus;
