...
import ProductCodeValues from './ProductCodeValues';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ProductCodeId')) {
                obj['ProductCodeId'] = ApiClient.convertToType(data['ProductCodeId'], 'String');
            }
            if (data.hasOwnProperty('ProductCodeType')) {
                obj['ProductCodeType'] = ProductCodeValues.constructFromObject(data['ProductCodeType']);
            }
        }
        return obj;
    }
