    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Attachments')) {
                obj['Attachments'] = ApiClient.convertToType(data['Attachments'], [VolumeAttachment]);
            }
            ...
            if (data.hasOwnProperty('FastRestored')) {
                obj['FastRestored'] = ApiClient.convertToType(data['FastRestored'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('State')) {
                obj['State'] = VolumeState.constructFromObject(data['State']);
            }
