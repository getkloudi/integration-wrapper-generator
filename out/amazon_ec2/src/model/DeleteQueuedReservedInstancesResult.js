    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('FailedQueuedPurchaseDeletions')) {
                obj['FailedQueuedPurchaseDeletions'] = ApiClient.convertToType(data['FailedQueuedPurchaseDeletions'], [FailedQueuedPurchaseDeletion]);
            }
            if (data.hasOwnProperty('SuccessfulQueuedPurchaseDeletions')) {
                obj['SuccessfulQueuedPurchaseDeletions'] = ApiClient.convertToType(data['SuccessfulQueuedPurchaseDeletions'], [SuccessfulQueuedPurchaseDeletion]);
            }
        }
        return obj;
    }
...
export default DeleteQueuedReservedInstancesResult;
