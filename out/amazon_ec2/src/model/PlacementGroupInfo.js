...
import PlacementGroupStrategy from './PlacementGroupStrategy';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SupportedStrategies')) {
                obj['SupportedStrategies'] = ApiClient.convertToType(data['SupportedStrategies'], [PlacementGroupStrategy]);
            }
        }
        return obj;
    }
...
export default PlacementGroupInfo;
