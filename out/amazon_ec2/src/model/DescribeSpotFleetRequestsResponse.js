    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SpotFleetRequestConfigs')) {
                obj['SpotFleetRequestConfigs'] = ApiClient.convertToType(data['SpotFleetRequestConfigs'], [SpotFleetRequestConfig]);
            }
        }
        return obj;
    }
...
export default DescribeSpotFleetRequestsResponse;
