...
import FpgaImageAttributeName from './FpgaImageAttributeName';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Attribute')) {
                obj['Attribute'] = FpgaImageAttributeName.constructFromObject(data['Attribute']);
            }
            ...
            if (data.hasOwnProperty('LoadPermission')) {
                obj['LoadPermission'] = LoadPermissionModifications.constructFromObject(data['LoadPermission']);
            }
...
export default ModifyFpgaImageAttributeRequest;
