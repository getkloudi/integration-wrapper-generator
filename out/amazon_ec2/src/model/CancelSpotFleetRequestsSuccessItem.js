    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('CurrentSpotFleetRequestState')) {
                obj['CurrentSpotFleetRequestState'] = BatchState.constructFromObject(data['CurrentSpotFleetRequestState']);
            }
            if (data.hasOwnProperty('PreviousSpotFleetRequestState')) {
                obj['PreviousSpotFleetRequestState'] = BatchState.constructFromObject(data['PreviousSpotFleetRequestState']);
            }
...
export default CancelSpotFleetRequestsSuccessItem;
