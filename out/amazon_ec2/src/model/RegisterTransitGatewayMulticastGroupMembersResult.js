    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('RegisteredMulticastGroupMembers')) {
                obj['RegisteredMulticastGroupMembers'] = TransitGatewayMulticastRegisteredGroupMembers.constructFromObject(data['RegisteredMulticastGroupMembers']);
            }
        }
        return obj;
    }
...
export default RegisterTransitGatewayMulticastGroupMembersResult;
