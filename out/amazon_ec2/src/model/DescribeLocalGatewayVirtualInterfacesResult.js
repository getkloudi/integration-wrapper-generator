    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LocalGatewayVirtualInterfaces')) {
                obj['LocalGatewayVirtualInterfaces'] = ApiClient.convertToType(data['LocalGatewayVirtualInterfaces'], [LocalGatewayVirtualInterface]);
            }
...
export default DescribeLocalGatewayVirtualInterfacesResult;
