...
class ModifyTrafficMirrorFilterNetworkServicesRequest {
     ...
     */
    constructor(trafficMirrorFilterId) { 
     ...
     */
    static initialize(obj, trafficMirrorFilterId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AddNetworkServices')) {
                obj['AddNetworkServices'] = ApiClient.convertToType(data['AddNetworkServices'], [TrafficMirrorNetworkService]);
            }
            if (data.hasOwnProperty('DryRun')) {
                obj['DryRun'] = ApiClient.convertToType(data['DryRun'], 'Boolean');
            }
            if (data.hasOwnProperty('RemoveNetworkServices')) {
                obj['RemoveNetworkServices'] = ApiClient.convertToType(data['RemoveNetworkServices'], [TrafficMirrorNetworkService]);
            }
...
export default ModifyTrafficMirrorFilterNetworkServicesRequest;
