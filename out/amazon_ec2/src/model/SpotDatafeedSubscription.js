...
import DatafeedSubscriptionState from './DatafeedSubscriptionState';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('State')) {
                obj['State'] = DatafeedSubscriptionState.constructFromObject(data['State']);
            }
        }
        return obj;
    }
...
export default SpotDatafeedSubscription;
