    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SupportedArchitectures')) {
                obj['SupportedArchitectures'] = ApiClient.convertToType(data['SupportedArchitectures'], [ArchitectureType]);
            }
            if (data.hasOwnProperty('SustainedClockSpeedInGhz')) {
                obj['SustainedClockSpeedInGhz'] = ApiClient.convertToType(data['SustainedClockSpeedInGhz'], 'Number');
            }
        }
        return obj;
    }
