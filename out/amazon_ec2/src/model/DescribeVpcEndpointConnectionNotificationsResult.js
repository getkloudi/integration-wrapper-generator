    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ConnectionNotificationSet')) {
                obj['ConnectionNotificationSet'] = ApiClient.convertToType(data['ConnectionNotificationSet'], [ConnectionNotification]);
            }
...
export default DescribeVpcEndpointConnectionNotificationsResult;
