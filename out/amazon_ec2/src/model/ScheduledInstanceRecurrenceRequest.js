    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('OccurrenceDays')) {
                obj['OccurrenceDays'] = ApiClient.convertToType(data['OccurrenceDays'], ['Number']);
            }
            if (data.hasOwnProperty('OccurrenceRelativeToEnd')) {
                obj['OccurrenceRelativeToEnd'] = ApiClient.convertToType(data['OccurrenceRelativeToEnd'], 'Boolean');
            }
            if (data.hasOwnProperty('OccurrenceUnit')) {
                obj['OccurrenceUnit'] = ApiClient.convertToType(data['OccurrenceUnit'], 'String');
            }
        }
        return obj;
    }
...
export default ScheduledInstanceRecurrenceRequest;
