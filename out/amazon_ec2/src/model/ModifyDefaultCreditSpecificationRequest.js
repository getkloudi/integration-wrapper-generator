...
import UnlimitedSupportedInstanceFamily from './UnlimitedSupportedInstanceFamily';
...
class ModifyDefaultCreditSpecificationRequest {
     ...
     */
    constructor(cpuCredits, instanceFamily) { 
     ...
     */
    static initialize(obj, cpuCredits, instanceFamily) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('InstanceFamily')) {
                obj['InstanceFamily'] = UnlimitedSupportedInstanceFamily.constructFromObject(data['InstanceFamily']);
            }
        }
        return obj;
    }
...
export default ModifyDefaultCreditSpecificationRequest;
