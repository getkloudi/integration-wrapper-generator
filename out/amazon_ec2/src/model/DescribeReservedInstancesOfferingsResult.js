    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ReservedInstancesOfferings')) {
                obj['ReservedInstancesOfferings'] = ApiClient.convertToType(data['ReservedInstancesOfferings'], [ReservedInstancesOffering]);
            }
        }
        return obj;
    }
...
export default DescribeReservedInstancesOfferingsResult;
