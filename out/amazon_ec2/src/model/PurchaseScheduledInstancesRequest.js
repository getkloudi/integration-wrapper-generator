...
class PurchaseScheduledInstancesRequest {
     ...
     */
    static initialize(obj, purchaseRequests) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('PurchaseRequests')) {
                obj['PurchaseRequests'] = ApiClient.convertToType(data['PurchaseRequests'], [PurchaseRequest]);
            }
        }
        return obj;
    }
...
export default PurchaseScheduledInstancesRequest;
