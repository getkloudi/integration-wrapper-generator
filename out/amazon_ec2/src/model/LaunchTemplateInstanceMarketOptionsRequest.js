    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('MarketType')) {
                obj['MarketType'] = MarketType.constructFromObject(data['MarketType']);
            }
            if (data.hasOwnProperty('SpotOptions')) {
                obj['SpotOptions'] = LaunchTemplateSpotMarketOptionsRequest.constructFromObject(data['SpotOptions']);
            }
        }
        return obj;
    }
...
export default LaunchTemplateInstanceMarketOptionsRequest;
