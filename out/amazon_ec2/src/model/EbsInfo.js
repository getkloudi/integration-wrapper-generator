...
import EbsEncryptionSupport from './EbsEncryptionSupport';
import EbsOptimizedSupport from './EbsOptimizedSupport';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('EbsOptimizedSupport')) {
                obj['EbsOptimizedSupport'] = EbsOptimizedSupport.constructFromObject(data['EbsOptimizedSupport']);
            }
            if (data.hasOwnProperty('EncryptionSupport')) {
                obj['EncryptionSupport'] = EbsEncryptionSupport.constructFromObject(data['EncryptionSupport']);
            }
        }
        return obj;
    }
