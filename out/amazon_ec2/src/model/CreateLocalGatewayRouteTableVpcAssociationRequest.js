...
class CreateLocalGatewayRouteTableVpcAssociationRequest {
     ...
     * @param vpcId {String} 
     */
    constructor(localGatewayRouteTableId, vpcId) { 
     ...
     */
    static initialize(obj, localGatewayRouteTableId, vpcId) { 
...
export default CreateLocalGatewayRouteTableVpcAssociationRequest;
