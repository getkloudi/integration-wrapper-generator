    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('EgressOnlyInternetGatewayIds')) {
                obj['EgressOnlyInternetGatewayIds'] = ApiClient.convertToType(data['EgressOnlyInternetGatewayIds'], ['String']);
            }
...
export default DescribeEgressOnlyInternetGatewaysRequest;
