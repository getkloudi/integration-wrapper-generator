    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AdditionalRoutesAvailable')) {
                obj['AdditionalRoutesAvailable'] = ApiClient.convertToType(data['AdditionalRoutesAvailable'], 'Boolean');
            }
            if (data.hasOwnProperty('Routes')) {
                obj['Routes'] = ApiClient.convertToType(data['Routes'], [TransitGatewayRoute]);
            }
        }
        return obj;
    }
...
export default SearchTransitGatewayRoutesResult;
