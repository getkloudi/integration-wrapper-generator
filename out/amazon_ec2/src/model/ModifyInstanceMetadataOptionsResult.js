    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('InstanceMetadataOptions')) {
                obj['InstanceMetadataOptions'] = InstanceMetadataOptionsResponse.constructFromObject(data['InstanceMetadataOptions']);
            }
        }
        return obj;
    }
...
export default ModifyInstanceMetadataOptionsResult;
