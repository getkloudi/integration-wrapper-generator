...
* @readonly
*/
export default class DeleteQueuedReservedInstancesErrorCode {
    
        /**
         * value: "reserved-instances-id-invalid"
         * @const
         */
        "reserved-instances-id-invalid" = "reserved-instances-id-invalid";
         ...
         * @const
         */
        "reserved-instances-not-in-queued-state" = "reserved-instances-not-in-queued-state";
