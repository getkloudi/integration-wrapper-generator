    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('RegisteredNetworkInterfaceIds')) {
                obj['RegisteredNetworkInterfaceIds'] = ApiClient.convertToType(data['RegisteredNetworkInterfaceIds'], ['String']);
            }
...
export default TransitGatewayMulticastRegisteredGroupMembers;
