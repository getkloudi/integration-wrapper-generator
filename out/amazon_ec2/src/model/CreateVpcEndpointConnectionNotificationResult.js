    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ConnectionNotification')) {
                obj['ConnectionNotification'] = ConnectionNotification.constructFromObject(data['ConnectionNotification']);
            }
        }
        return obj;
    }
...
export default CreateVpcEndpointConnectionNotificationResult;
