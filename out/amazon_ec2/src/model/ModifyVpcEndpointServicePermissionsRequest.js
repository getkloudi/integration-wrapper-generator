    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AddAllowedPrincipals')) {
                obj['AddAllowedPrincipals'] = ApiClient.convertToType(data['AddAllowedPrincipals'], ['String']);
            }
            if (data.hasOwnProperty('DryRun')) {
                obj['DryRun'] = ApiClient.convertToType(data['DryRun'], 'Boolean');
            }
            if (data.hasOwnProperty('RemoveAllowedPrincipals')) {
                obj['RemoveAllowedPrincipals'] = ApiClient.convertToType(data['RemoveAllowedPrincipals'], ['String']);
            }
...
export default ModifyVpcEndpointServicePermissionsRequest;
