    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ReservedInstancesListings')) {
                obj['ReservedInstancesListings'] = ApiClient.convertToType(data['ReservedInstancesListings'], [ReservedInstancesListing]);
            }
        }
        return obj;
    }
...
export default DescribeReservedInstancesListingsResult;
