    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LocalGatewayRouteTableVpcAssociationIds')) {
                obj['LocalGatewayRouteTableVpcAssociationIds'] = ApiClient.convertToType(data['LocalGatewayRouteTableVpcAssociationIds'], ['String']);
            }
...
export default DescribeLocalGatewayRouteTableVpcAssociationsRequest;
