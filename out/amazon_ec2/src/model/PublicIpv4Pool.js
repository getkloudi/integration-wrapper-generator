    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('PoolAddressRanges')) {
                obj['PoolAddressRanges'] = ApiClient.convertToType(data['PoolAddressRanges'], [PublicIpv4PoolRange]);
            }
            ...
            if (data.hasOwnProperty('TotalAddressCount')) {
                obj['TotalAddressCount'] = ApiClient.convertToType(data['TotalAddressCount'], 'Number');
            }
            if (data.hasOwnProperty('TotalAvailableAddressCount')) {
                obj['TotalAvailableAddressCount'] = ApiClient.convertToType(data['TotalAvailableAddressCount'], 'Number');
            }
        }
        return obj;
    }
