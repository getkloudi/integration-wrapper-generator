    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('KeyNames')) {
                obj['KeyNames'] = ApiClient.convertToType(data['KeyNames'], ['String']);
            }
            if (data.hasOwnProperty('KeyPairIds')) {
                obj['KeyPairIds'] = ApiClient.convertToType(data['KeyPairIds'], ['String']);
            }
        }
        return obj;
    }
...
export default DescribeKeyPairsRequest;
