    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('TransitGatewayMulticastDomain')) {
                obj['TransitGatewayMulticastDomain'] = TransitGatewayMulticastDomain.constructFromObject(data['TransitGatewayMulticastDomain']);
            }
        }
        return obj;
    }
...
export default CreateTransitGatewayMulticastDomainResult;
