    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Associations')) {
                obj['Associations'] = ApiClient.convertToType(data['Associations'], [TransitGatewayRouteTableAssociation]);
            }
...
export default GetTransitGatewayRouteTableAssociationsResult;
