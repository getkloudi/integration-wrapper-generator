    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SubsystemId')) {
                obj['SubsystemId'] = ApiClient.convertToType(data['SubsystemId'], 'String');
            }
            if (data.hasOwnProperty('SubsystemVendorId')) {
                obj['SubsystemVendorId'] = ApiClient.convertToType(data['SubsystemVendorId'], 'String');
            }
