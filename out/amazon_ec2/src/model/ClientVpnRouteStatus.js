...
import ClientVpnRouteStatusCode from './ClientVpnRouteStatusCode';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Code')) {
                obj['Code'] = ClientVpnRouteStatusCode.constructFromObject(data['Code']);
            }
...
export default ClientVpnRouteStatus;
