    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AllRegions')) {
                obj['AllRegions'] = ApiClient.convertToType(data['AllRegions'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('RegionNames')) {
                obj['RegionNames'] = ApiClient.convertToType(data['RegionNames'], ['String']);
            }
        }
        return obj;
    }
...
export default DescribeRegionsRequest;
