    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LocalGatewayVirtualInterfaceGroupIds')) {
                obj['LocalGatewayVirtualInterfaceGroupIds'] = ApiClient.convertToType(data['LocalGatewayVirtualInterfaceGroupIds'], ['String']);
            }
...
export default DescribeLocalGatewayVirtualInterfaceGroupsRequest;
