    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Actions')) {
                obj['Actions'] = ApiClient.convertToType(data['Actions'], [VolumeStatusAction]);
            }
            if (data.hasOwnProperty('AvailabilityZone')) {
                obj['AvailabilityZone'] = ApiClient.convertToType(data['AvailabilityZone'], 'String');
            }
            if (data.hasOwnProperty('Events')) {
                obj['Events'] = ApiClient.convertToType(data['Events'], [VolumeStatusEvent]);
            }
            ...
            if (data.hasOwnProperty('VolumeStatus')) {
                obj['VolumeStatus'] = VolumeStatusInfo.constructFromObject(data['VolumeStatus']);
            }
        }
        return obj;
    }
