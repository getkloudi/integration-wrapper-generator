    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('TransitGatewayRouteTables')) {
                obj['TransitGatewayRouteTables'] = ApiClient.convertToType(data['TransitGatewayRouteTables'], [TransitGatewayRouteTable]);
            }
        }
        return obj;
    }
...
export default DescribeTransitGatewayRouteTablesResult;
