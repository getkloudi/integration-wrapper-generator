    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('DeregisteredMulticastGroupMembers')) {
                obj['DeregisteredMulticastGroupMembers'] = TransitGatewayMulticastDeregisteredGroupMembers.constructFromObject(data['DeregisteredMulticastGroupMembers']);
            }
        }
        return obj;
    }
...
export default DeregisterTransitGatewayMulticastGroupMembersResult;
