...
class UnassignPrivateIpAddressesRequest {
     ...
     */
    constructor(networkInterfaceId, privateIpAddresses) { 
     ...
     */
    static initialize(obj, networkInterfaceId, privateIpAddresses) { 
...
export default UnassignPrivateIpAddressesRequest;
