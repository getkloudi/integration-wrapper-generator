    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('DestinationPrefixListId')) {
                obj['DestinationPrefixListId'] = ApiClient.convertToType(data['DestinationPrefixListId'], 'String');
            }
            ...
            if (data.hasOwnProperty('Origin')) {
                obj['Origin'] = RouteOrigin.constructFromObject(data['Origin']);
            }
            if (data.hasOwnProperty('State')) {
                obj['State'] = RouteState.constructFromObject(data['State']);
            }
