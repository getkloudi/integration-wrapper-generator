    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Add')) {
                obj['Add'] = ApiClient.convertToType(data['Add'], [CreateVolumePermission]);
            }
            if (data.hasOwnProperty('Remove')) {
                obj['Remove'] = ApiClient.convertToType(data['Remove'], [CreateVolumePermission]);
            }
        }
        return obj;
    }
...
export default CreateVolumePermissionModifications;
