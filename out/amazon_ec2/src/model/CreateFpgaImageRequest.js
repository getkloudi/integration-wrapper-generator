...
class CreateFpgaImageRequest {
     ...
     */
    constructor(inputStorageLocation) { 
     ...
     */
    static initialize(obj, inputStorageLocation) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LogsStorageLocation')) {
                obj['LogsStorageLocation'] = StorageLocation.constructFromObject(data['LogsStorageLocation']);
            }
...
export default CreateFpgaImageRequest;
