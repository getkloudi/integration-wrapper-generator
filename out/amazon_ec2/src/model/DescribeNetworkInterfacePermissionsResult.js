    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('NetworkInterfacePermissions')) {
                obj['NetworkInterfacePermissions'] = ApiClient.convertToType(data['NetworkInterfacePermissions'], [NetworkInterfacePermission]);
            }
...
export default DescribeNetworkInterfacePermissionsResult;
