...
import DeleteQueuedReservedInstancesErrorCode from './DeleteQueuedReservedInstancesErrorCode';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Code')) {
                obj['Code'] = DeleteQueuedReservedInstancesErrorCode.constructFromObject(data['Code']);
            }
...
export default DeleteQueuedReservedInstancesError;
