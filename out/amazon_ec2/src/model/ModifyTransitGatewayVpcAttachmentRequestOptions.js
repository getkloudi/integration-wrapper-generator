...
import Ipv6SupportValue from './Ipv6SupportValue';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Ipv6Support')) {
                obj['Ipv6Support'] = Ipv6SupportValue.constructFromObject(data['Ipv6Support']);
            }
        }
        return obj;
    }
...
export default ModifyTransitGatewayVpcAttachmentRequestOptions;
