...
class DeleteVpcEndpointConnectionNotificationsRequest {
     ...
     */
    constructor(connectionNotificationIds) { 
     ...
     */
    static initialize(obj, connectionNotificationIds) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ConnectionNotificationIds')) {
                obj['ConnectionNotificationIds'] = ApiClient.convertToType(data['ConnectionNotificationIds'], ['String']);
            }
...
export default DeleteVpcEndpointConnectionNotificationsRequest;
