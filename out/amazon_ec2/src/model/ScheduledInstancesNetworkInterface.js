...
import ScheduledInstancesIpv6Address from './ScheduledInstancesIpv6Address';
import ScheduledInstancesPrivateIpAddressConfig from './ScheduledInstancesPrivateIpAddressConfig';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Ipv6Addresses')) {
                obj['Ipv6Addresses'] = ApiClient.convertToType(data['Ipv6Addresses'], [ScheduledInstancesIpv6Address]);
            }
            ...
            if (data.hasOwnProperty('PrivateIpAddressConfigs')) {
                obj['PrivateIpAddressConfigs'] = ApiClient.convertToType(data['PrivateIpAddressConfigs'], [ScheduledInstancesPrivateIpAddressConfig]);
            }
...
export default ScheduledInstancesNetworkInterface;
