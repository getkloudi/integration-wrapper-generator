    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('EgressOnlyInternetGateway')) {
                obj['EgressOnlyInternetGateway'] = EgressOnlyInternetGateway.constructFromObject(data['EgressOnlyInternetGateway']);
            }
        }
        return obj;
    }
...
export default CreateEgressOnlyInternetGatewayResult;
