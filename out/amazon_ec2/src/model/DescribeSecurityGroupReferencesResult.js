    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SecurityGroupReferenceSet')) {
                obj['SecurityGroupReferenceSet'] = ApiClient.convertToType(data['SecurityGroupReferenceSet'], [SecurityGroupReference]);
            }
        }
        return obj;
    }
...
export default DescribeSecurityGroupReferencesResult;
