    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('FastSnapshotRestoreStateErrors')) {
                obj['FastSnapshotRestoreStateErrors'] = ApiClient.convertToType(data['FastSnapshotRestoreStateErrors'], [EnableFastSnapshotRestoreStateErrorItem]);
            }
...
export default EnableFastSnapshotRestoreErrorItem;
