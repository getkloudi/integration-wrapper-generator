    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('CidrBlockAssociation')) {
                obj['CidrBlockAssociation'] = VpcCidrBlockAssociation.constructFromObject(data['CidrBlockAssociation']);
            }
            if (data.hasOwnProperty('Ipv6CidrBlockAssociation')) {
                obj['Ipv6CidrBlockAssociation'] = VpcIpv6CidrBlockAssociation.constructFromObject(data['Ipv6CidrBlockAssociation']);
            }
...
export default DisassociateVpcCidrBlockResult;
