...
import NetworkInterfaceAttribute from './NetworkInterfaceAttribute';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Attribute')) {
                obj['Attribute'] = NetworkInterfaceAttribute.constructFromObject(data['Attribute']);
            }
...
export default DescribeNetworkInterfaceAttributeRequest;
