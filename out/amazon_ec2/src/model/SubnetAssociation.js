...
import TransitGatewayMulitcastDomainAssociationState from './TransitGatewayMulitcastDomainAssociationState';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('State')) {
                obj['State'] = TransitGatewayMulitcastDomainAssociationState.constructFromObject(data['State']);
            }
