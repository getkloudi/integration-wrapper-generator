    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AssignIpv6AddressOnCreation')) {
                obj['AssignIpv6AddressOnCreation'] = AttributeBooleanValue.constructFromObject(data['AssignIpv6AddressOnCreation']);
            }
            if (data.hasOwnProperty('MapPublicIpOnLaunch')) {
                obj['MapPublicIpOnLaunch'] = AttributeBooleanValue.constructFromObject(data['MapPublicIpOnLaunch']);
            }
...
export default ModifySubnetAttributeRequest;
