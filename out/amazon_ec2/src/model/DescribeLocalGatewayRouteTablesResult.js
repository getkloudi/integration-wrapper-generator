    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LocalGatewayRouteTables')) {
                obj['LocalGatewayRouteTables'] = ApiClient.convertToType(data['LocalGatewayRouteTables'], [LocalGatewayRouteTable]);
            }
...
export default DescribeLocalGatewayRouteTablesResult;
