...
class DeleteFleetsRequest {
     ...
     */
    constructor(fleetIds, terminateInstances) { 
     ...
     */
    static initialize(obj, fleetIds, terminateInstances) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('FleetIds')) {
                obj['FleetIds'] = ApiClient.convertToType(data['FleetIds'], ['String']);
            }
...
export default DeleteFleetsRequest;
