...
import VolumeStatusInfoStatus from './VolumeStatusInfoStatus';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Details')) {
                obj['Details'] = ApiClient.convertToType(data['Details'], [VolumeStatusDetails]);
            }
            if (data.hasOwnProperty('Status')) {
                obj['Status'] = VolumeStatusInfoStatus.constructFromObject(data['Status']);
            }
        }
        return obj;
    }
...
export default VolumeStatusInfo;
