    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SuccessfulInstanceCreditSpecifications')) {
                obj['SuccessfulInstanceCreditSpecifications'] = ApiClient.convertToType(data['SuccessfulInstanceCreditSpecifications'], [SuccessfulInstanceCreditSpecificationItem]);
            }
            if (data.hasOwnProperty('UnsuccessfulInstanceCreditSpecifications')) {
                obj['UnsuccessfulInstanceCreditSpecifications'] = ApiClient.convertToType(data['UnsuccessfulInstanceCreditSpecifications'], [UnsuccessfulInstanceCreditSpecificationItem]);
            }
        }
        return obj;
    }
...
export default ModifyInstanceCreditSpecificationResult;
