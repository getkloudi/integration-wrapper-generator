    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ScheduledInstanceAvailabilitySet')) {
                obj['ScheduledInstanceAvailabilitySet'] = ApiClient.convertToType(data['ScheduledInstanceAvailabilitySet'], [ScheduledInstanceAvailability]);
            }
        }
        return obj;
    }
...
export default DescribeScheduledInstanceAvailabilityResult;
