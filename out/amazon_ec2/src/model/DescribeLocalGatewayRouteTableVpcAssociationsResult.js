    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LocalGatewayRouteTableVpcAssociations')) {
                obj['LocalGatewayRouteTableVpcAssociations'] = ApiClient.convertToType(data['LocalGatewayRouteTableVpcAssociations'], [LocalGatewayRouteTableVpcAssociation]);
            }
...
export default DescribeLocalGatewayRouteTableVpcAssociationsResult;
