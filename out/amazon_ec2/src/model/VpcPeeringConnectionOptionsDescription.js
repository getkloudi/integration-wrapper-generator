    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AllowDnsResolutionFromRemoteVpc')) {
                obj['AllowDnsResolutionFromRemoteVpc'] = ApiClient.convertToType(data['AllowDnsResolutionFromRemoteVpc'], 'Boolean');
            }
            if (data.hasOwnProperty('AllowEgressFromLocalClassicLinkToRemoteVpc')) {
                obj['AllowEgressFromLocalClassicLinkToRemoteVpc'] = ApiClient.convertToType(data['AllowEgressFromLocalClassicLinkToRemoteVpc'], 'Boolean');
            }
            if (data.hasOwnProperty('AllowEgressFromLocalVpcToRemoteClassicLink')) {
                obj['AllowEgressFromLocalVpcToRemoteClassicLink'] = ApiClient.convertToType(data['AllowEgressFromLocalVpcToRemoteClassicLink'], 'Boolean');
            }
        }
        return obj;
    }
...
export default VpcPeeringConnectionOptionsDescription;
