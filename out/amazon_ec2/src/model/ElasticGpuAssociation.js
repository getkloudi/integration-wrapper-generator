    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ElasticGpuAssociationId')) {
                obj['ElasticGpuAssociationId'] = ApiClient.convertToType(data['ElasticGpuAssociationId'], 'String');
            }
            if (data.hasOwnProperty('ElasticGpuAssociationState')) {
                obj['ElasticGpuAssociationState'] = ApiClient.convertToType(data['ElasticGpuAssociationState'], 'String');
            }
            if (data.hasOwnProperty('ElasticGpuAssociationTime')) {
                obj['ElasticGpuAssociationTime'] = ApiClient.convertToType(data['ElasticGpuAssociationTime'], 'String');
            }
...
export default ElasticGpuAssociation;
