    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('InstanceTypes')) {
                obj['InstanceTypes'] = ApiClient.convertToType(data['InstanceTypes'], [InstanceType]);
            }
            ...
            if (data.hasOwnProperty('ProductDescriptions')) {
                obj['ProductDescriptions'] = ApiClient.convertToType(data['ProductDescriptions'], ['String']);
            }
...
export default DescribeSpotPriceHistoryRequest;
