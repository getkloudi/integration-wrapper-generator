    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('CancelledSpotInstanceRequests')) {
                obj['CancelledSpotInstanceRequests'] = ApiClient.convertToType(data['CancelledSpotInstanceRequests'], [CancelledSpotInstanceRequest]);
            }
        }
        return obj;
    }
...
export default CancelSpotInstanceRequestsResult;
