    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ScheduledInstanceIds')) {
                obj['ScheduledInstanceIds'] = ApiClient.convertToType(data['ScheduledInstanceIds'], ['String']);
            }
            if (data.hasOwnProperty('SlotStartTimeRange')) {
                obj['SlotStartTimeRange'] = SlotStartTimeRangeRequest.constructFromObject(data['SlotStartTimeRange']);
            }
        }
        return obj;
    }
...
export default DescribeScheduledInstancesRequest;
