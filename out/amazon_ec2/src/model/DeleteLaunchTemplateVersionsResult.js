    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SuccessfullyDeletedLaunchTemplateVersions')) {
                obj['SuccessfullyDeletedLaunchTemplateVersions'] = ApiClient.convertToType(data['SuccessfullyDeletedLaunchTemplateVersions'], [DeleteLaunchTemplateVersionsResponseSuccessItem]);
            }
            if (data.hasOwnProperty('UnsuccessfullyDeletedLaunchTemplateVersions')) {
                obj['UnsuccessfullyDeletedLaunchTemplateVersions'] = ApiClient.convertToType(data['UnsuccessfullyDeletedLaunchTemplateVersions'], [DeleteLaunchTemplateVersionsResponseErrorItem]);
            }
        }
        return obj;
    }
...
export default DeleteLaunchTemplateVersionsResult;
