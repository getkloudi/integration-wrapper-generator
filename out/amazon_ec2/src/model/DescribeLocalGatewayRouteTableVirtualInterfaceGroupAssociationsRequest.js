    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LocalGatewayRouteTableVirtualInterfaceGroupAssociationIds')) {
                obj['LocalGatewayRouteTableVirtualInterfaceGroupAssociationIds'] = ApiClient.convertToType(data['LocalGatewayRouteTableVirtualInterfaceGroupAssociationIds'], ['String']);
            }
...
export default DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest;
