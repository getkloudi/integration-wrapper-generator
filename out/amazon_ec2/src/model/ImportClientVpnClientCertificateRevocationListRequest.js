...
class ImportClientVpnClientCertificateRevocationListRequest {
     ...
     */
    constructor(certificateRevocationList, clientVpnEndpointId) { 
     ...
     */
    static initialize(obj, certificateRevocationList, clientVpnEndpointId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('CertificateRevocationList')) {
                obj['CertificateRevocationList'] = ApiClient.convertToType(data['CertificateRevocationList'], 'String');
            }
...
export default ImportClientVpnClientCertificateRevocationListRequest;
