    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('DeregisteredNetworkInterfaceIds')) {
                obj['DeregisteredNetworkInterfaceIds'] = ApiClient.convertToType(data['DeregisteredNetworkInterfaceIds'], ['String']);
            }
...
export default TransitGatewayMulticastDeregisteredGroupMembers;
