    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AllAvailabilityZones')) {
                obj['AllAvailabilityZones'] = ApiClient.convertToType(data['AllAvailabilityZones'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('ZoneNames')) {
                obj['ZoneNames'] = ApiClient.convertToType(data['ZoneNames'], ['String']);
            }
        }
        return obj;
    }
...
export default DescribeAvailabilityZonesRequest;
