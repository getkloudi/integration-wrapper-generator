    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Successful')) {
                obj['Successful'] = ApiClient.convertToType(data['Successful'], [EnableFastSnapshotRestoreSuccessItem]);
            }
            if (data.hasOwnProperty('Unsuccessful')) {
                obj['Unsuccessful'] = ApiClient.convertToType(data['Unsuccessful'], [EnableFastSnapshotRestoreErrorItem]);
            }
        }
        return obj;
    }
...
export default EnableFastSnapshotRestoresResult;
