...
var _TransitGatewayMulticastGroup = _interopRequireDefault(require("./TransitGatewayMulticastGroup"));
...
function () {
  ...
  function SearchTransitGatewayMulticastGroupsResult() {
    _classCallCheck(this, SearchTransitGatewayMulticastGroupsResult);
  ...
  _createClass(SearchTransitGatewayMulticastGroupsResult, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('MulticastGroups')) {
          obj['MulticastGroups'] = _ApiClient["default"].convertToType(data['MulticastGroups'], [_TransitGatewayMulticastGroup["default"]]);
        }
...
var _default = SearchTransitGatewayMulticastGroupsResult;
