...
var _VpcPeeringConnectionStateReasonCode = _interopRequireDefault(require("./VpcPeeringConnectionStateReasonCode"));
...
function () {
  ...
  function VpcPeeringConnectionStateReason() {
    _classCallCheck(this, VpcPeeringConnectionStateReason);
  ...
  _createClass(VpcPeeringConnectionStateReason, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('Code')) {
          obj['Code'] = _VpcPeeringConnectionStateReasonCode["default"].constructFromObject(data['Code']);
        }
...
var _default = VpcPeeringConnectionStateReason;
