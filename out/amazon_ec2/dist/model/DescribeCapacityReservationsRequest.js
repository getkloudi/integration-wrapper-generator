...
function () {
  ...
  function DescribeCapacityReservationsRequest() {
    _classCallCheck(this, DescribeCapacityReservationsRequest);
  ...
  _createClass(DescribeCapacityReservationsRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('CapacityReservationIds')) {
          obj['CapacityReservationIds'] = _ApiClient["default"].convertToType(data['CapacityReservationIds'], ['String']);
        }
...
var _default = DescribeCapacityReservationsRequest;
