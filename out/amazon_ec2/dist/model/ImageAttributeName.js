...
function () {
  function ImageAttributeName() {
    _classCallCheck(this, ImageAttributeName);
  ...
  _createClass(ImageAttributeName, null, [{
    key: "constructFromObject",

    /**
    * Returns a <code>ImageAttributeName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ImageAttributeName} The enum <code>ImageAttributeName</code> value.
    */
...
exports["default"] = ImageAttributeName;