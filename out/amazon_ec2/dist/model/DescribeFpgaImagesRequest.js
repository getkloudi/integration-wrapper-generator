...
function () {
  ...
  function DescribeFpgaImagesRequest() {
    _classCallCheck(this, DescribeFpgaImagesRequest);
  ...
  _createClass(DescribeFpgaImagesRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('FpgaImageIds')) {
          obj['FpgaImageIds'] = _ApiClient["default"].convertToType(data['FpgaImageIds'], ['String']);
        }
...
var _default = DescribeFpgaImagesRequest;
