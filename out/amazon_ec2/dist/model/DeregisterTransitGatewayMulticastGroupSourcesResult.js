...
var _TransitGatewayMulticastDeregisteredGroupSources = _interopRequireDefault(require("./TransitGatewayMulticastDeregisteredGroupSources"));
...
function () {
  ...
  function DeregisterTransitGatewayMulticastGroupSourcesResult() {
    _classCallCheck(this, DeregisterTransitGatewayMulticastGroupSourcesResult);
  ...
  _createClass(DeregisterTransitGatewayMulticastGroupSourcesResult, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('DeregisteredMulticastGroupSources')) {
          obj['DeregisteredMulticastGroupSources'] = _TransitGatewayMulticastDeregisteredGroupSources["default"].constructFromObject(data['DeregisteredMulticastGroupSources']);
        }
      }
...
var _default = DeregisterTransitGatewayMulticastGroupSourcesResult;
