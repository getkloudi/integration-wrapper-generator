...
function () {
  ...
  function ReservationValue() {
    _classCallCheck(this, ReservationValue);
  ...
  _createClass(ReservationValue, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('RemainingTotalValue')) {
          obj['RemainingTotalValue'] = _ApiClient["default"].convertToType(data['RemainingTotalValue'], 'String');
        }

        if (data.hasOwnProperty('RemainingUpfrontValue')) {
          obj['RemainingUpfrontValue'] = _ApiClient["default"].convertToType(data['RemainingUpfrontValue'], 'String');
        }
      }
