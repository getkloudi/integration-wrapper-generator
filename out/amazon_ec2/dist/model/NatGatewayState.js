...
function () {
  function NatGatewayState() {
    _classCallCheck(this, NatGatewayState);
  ...
  _createClass(NatGatewayState, null, [{
    key: "constructFromObject",

    /**
    * Returns a <code>NatGatewayState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NatGatewayState} The enum <code>NatGatewayState</code> value.
    */
...
exports["default"] = NatGatewayState;