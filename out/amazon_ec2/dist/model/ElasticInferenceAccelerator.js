...
function () {
   ...
   * @param type {String} 
   */
  function ElasticInferenceAccelerator(type) {
    _classCallCheck(this, ElasticInferenceAccelerator);

    ElasticInferenceAccelerator.initialize(this, type);
  }
  /**
  ...
  _createClass(ElasticInferenceAccelerator, null, [{
    key: "initialize",
...
ElasticInferenceAccelerator.prototype['Count'] = undefined;
/**
 * @member {String} Type
 */

ElasticInferenceAccelerator.prototype['Type'] = undefined;
var _default = ElasticInferenceAccelerator;
