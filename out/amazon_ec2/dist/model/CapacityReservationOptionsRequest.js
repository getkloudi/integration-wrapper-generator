...
function () {
  /**
   * Constructs a new <code>CapacityReservationOptionsRequest</code>.
   ...
   * @alias module:model/CapacityReservationOptionsRequest
   */
  function CapacityReservationOptionsRequest() {
    _classCallCheck(this, CapacityReservationOptionsRequest);

    CapacityReservationOptionsRequest.initialize(this);
  }
  /**
  ...
  _createClass(CapacityReservationOptionsRequest, null, [{
    key: "initialize",
    value: function initialize(obj) {}
    /**
     * Constructs a <code>CapacityReservationOptionsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CapacityReservationOptionsRequest} obj Optional instance to populate.
     * @return {module:model/CapacityReservationOptionsRequest} The populated <code>CapacityReservationOptionsRequest</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CapacityReservationOptionsRequest();
...
CapacityReservationOptionsRequest.prototype['UsageStrategy'] = undefined;
var _default = CapacityReservationOptionsRequest;
