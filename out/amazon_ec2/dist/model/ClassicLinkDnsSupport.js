...
function () {
  ...
  function ClassicLinkDnsSupport() {
    _classCallCheck(this, ClassicLinkDnsSupport);
  ...
  _createClass(ClassicLinkDnsSupport, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ClassicLinkDnsSupported')) {
          obj['ClassicLinkDnsSupported'] = _ApiClient["default"].convertToType(data['ClassicLinkDnsSupported'], 'Boolean');
        }
...
var _default = ClassicLinkDnsSupport;
