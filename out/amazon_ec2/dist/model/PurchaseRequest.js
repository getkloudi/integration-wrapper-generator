...
function () {
   ...
   */
  function PurchaseRequest(instanceCount, purchaseToken) {
  ...
  _createClass(PurchaseRequest, null, [{
    key: "initialize",
    value: function initialize(obj, instanceCount, purchaseToken) {
