...
var _CreateFleetError = _interopRequireDefault(require("./CreateFleetError"));

var _CreateFleetInstance = _interopRequireDefault(require("./CreateFleetInstance"));
...
function () {
  ...
  function CreateFleetResult() {
    _classCallCheck(this, CreateFleetResult);
  ...
  _createClass(CreateFleetResult, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('Errors')) {
          obj['Errors'] = _ApiClient["default"].convertToType(data['Errors'], [_CreateFleetError["default"]]);
        }
        ...
        if (data.hasOwnProperty('Instances')) {
          obj['Instances'] = _ApiClient["default"].convertToType(data['Instances'], [_CreateFleetInstance["default"]]);
        }
      }
...
var _default = CreateFleetResult;
