...
function () {
  function RouteTableAssociationStateCode() {
    _classCallCheck(this, RouteTableAssociationStateCode);
  ...
  _createClass(RouteTableAssociationStateCode, null, [{
    key: "constructFromObject",

    /**
    * Returns a <code>RouteTableAssociationStateCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RouteTableAssociationStateCode} The enum <code>RouteTableAssociationStateCode</code> value.
    */
...
exports["default"] = RouteTableAssociationStateCode;