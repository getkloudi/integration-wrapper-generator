...
function () {
  function TransitGatewayState() {
    _classCallCheck(this, TransitGatewayState);
  ...
  _createClass(TransitGatewayState, null, [{
    key: "constructFromObject",

    /**
    * Returns a <code>TransitGatewayState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TransitGatewayState} The enum <code>TransitGatewayState</code> value.
    */
...
exports["default"] = TransitGatewayState;