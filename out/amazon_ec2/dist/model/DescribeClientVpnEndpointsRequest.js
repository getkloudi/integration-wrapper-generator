...
function () {
  ...
  function DescribeClientVpnEndpointsRequest() {
    _classCallCheck(this, DescribeClientVpnEndpointsRequest);
  ...
  _createClass(DescribeClientVpnEndpointsRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ClientVpnEndpointIds')) {
          obj['ClientVpnEndpointIds'] = _ApiClient["default"].convertToType(data['ClientVpnEndpointIds'], ['String']);
        }
...
var _default = DescribeClientVpnEndpointsRequest;
