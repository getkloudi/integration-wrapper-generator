...
function () {
  function SubnetCidrBlockStateCode() {
    _classCallCheck(this, SubnetCidrBlockStateCode);
  ...
  _createClass(SubnetCidrBlockStateCode, null, [{
    key: "constructFromObject",

    /**
    * Returns a <code>SubnetCidrBlockStateCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SubnetCidrBlockStateCode} The enum <code>SubnetCidrBlockStateCode</code> value.
    */
...
exports["default"] = SubnetCidrBlockStateCode;