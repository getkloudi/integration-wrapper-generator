...
var _NetworkInterfacePermissionStateCode = _interopRequireDefault(require("./NetworkInterfacePermissionStateCode"));
...
function () {
  ...
  function NetworkInterfacePermissionState() {
    _classCallCheck(this, NetworkInterfacePermissionState);
  ...
  _createClass(NetworkInterfacePermissionState, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('State')) {
          obj['State'] = _NetworkInterfacePermissionStateCode["default"].constructFromObject(data['State']);
        }
...
var _default = NetworkInterfacePermissionState;
