...
function () {
  function CapacityReservationState() {
    _classCallCheck(this, CapacityReservationState);
  ...
  _createClass(CapacityReservationState, null, [{
    key: "constructFromObject",

    /**
    * Returns a <code>CapacityReservationState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CapacityReservationState} The enum <code>CapacityReservationState</code> value.
    */
...
exports["default"] = CapacityReservationState;