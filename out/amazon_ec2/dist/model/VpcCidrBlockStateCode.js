...
function () {
  function VpcCidrBlockStateCode() {
    _classCallCheck(this, VpcCidrBlockStateCode);
  ...
  _createClass(VpcCidrBlockStateCode, null, [{
    key: "constructFromObject",

    /**
    * Returns a <code>VpcCidrBlockStateCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VpcCidrBlockStateCode} The enum <code>VpcCidrBlockStateCode</code> value.
    */
...
exports["default"] = VpcCidrBlockStateCode;