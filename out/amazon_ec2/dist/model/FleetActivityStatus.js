...
function () {
  function FleetActivityStatus() {
    _classCallCheck(this, FleetActivityStatus);

    _defineProperty(this, "error", "error");

    _defineProperty(this, "pending_fulfillment", "pending_fulfillment");

    _defineProperty(this, "pending_termination", "pending_termination");

    _defineProperty(this, "fulfilled", "fulfilled");
  }

  _createClass(FleetActivityStatus, null, [{
...
exports["default"] = FleetActivityStatus;